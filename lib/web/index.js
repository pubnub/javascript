...
var default_1 = /** @class */ (function (_super) {
    ...
    function default_1(setup) {
        ...
        if (setup.cipherKey) {
            setup.cryptoModule = new webCryptoModule_1.CryptoModule({
                default: new webCryptoModule_1.LegacyCryptor({ cipherKey: setup.cipherKey, useRandomIVs: setup.useRandomIVs }),
                cryptors: [new webCryptoModule_1.AesCbcCryptor({ cipherKey: setup.cipherKey })],
            });
        }
