...
var _web = _interopRequireDefault(require("../crypto/modules/web"));

var _web2 = _interopRequireDefault(require("../file/modules/web"));
...
var _default = function (_PubNubCore) {
  ...
  function _default(setup) {
    ...
    setup.PubNubFile = _web2["default"];
    setup.cryptography = new _web["default"]();
