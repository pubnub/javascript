...
exports.reconnectingFailure = (0, core_1.createEvent)('RECEIVE_RECONNECT_FAILURE', function (error) { return error; });
exports.reconnectingGiveup = (0, core_1.createEvent)('RECEIVING_RECONNECTING_GIVEUP', function () { return ({}); });
exports.reconnectingRetry = (0, core_1.createEvent)('RECONNECT', function () { return ({}); });
exports.unsubscribeAll = (0, core_1.createEvent)('UNSUBSCRIBE_ALL', function () { });
