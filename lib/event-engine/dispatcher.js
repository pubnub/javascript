...
var EventEngineDispatcher = /** @class */ (function (_super) {
    ...
    function EventEngineDispatcher(engine, dependencies) {
        ...
        _this.on(effects.handshake.type, (0, core_1.asyncHandler)(function (payload_1, abortSignal_1, _a) { return __awaiter(_this, [payload_1, abortSignal_1, _a], void 0, function (payload, abortSignal, _b) {
            var result, e_1;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        if (e_1 instanceof PubNubError_1.PubNubError) {
        ...
        _this.on(effects.receiveMessages.type, (0, core_1.asyncHandler)(function (payload_1, abortSignal_1, _a) { return __awaiter(_this, [payload_1, abortSignal_1, _a], void 0, function (payload, abortSignal, _b) {
            var result, error_1;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        if (error_1 instanceof PubNubError_1.PubNubError && !abortSignal.aborted) {
        ...
        _this.on(effects.emitMessages.type, (0, core_1.asyncHandler)(function (payload_1, _1, _a) { return __awaiter(_this, [payload_1, _1, _a], void 0, function (payload, _, _b) {
        ...
        _this.on(effects.emitStatus.type, (0, core_1.asyncHandler)(function (payload_1, _1, _a) { return __awaiter(_this, [payload_1, _1, _a], void 0, function (payload, _, _b) {
        ...
        _this.on(effects.receiveReconnect.type, (0, core_1.asyncHandler)(function (payload_1, abortSignal_1, _a) { return __awaiter(_this, [payload_1, abortSignal_1, _a], void 0, function (payload, abortSignal, _b) {
            var result, error_2;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        result = _c.sent();
                        return [2 /*return*/, engine.transition(events.receiveReconnectSuccess(result.cursor, result.messages))];
                    case 4:
                        error_2 = _c.sent();
                        if (error_2 instanceof Error && error_2.message === 'Aborted') {
                            return [2 /*return*/];
                        }
                        if (error_2 instanceof PubNubError_1.PubNubError) {
                            return [2 /*return*/, engine.transition(events.receiveReconnectFailure(error_2))];
                        }
                        return [3 /*break*/, 5];
                    case 5: return [3 /*break*/, 7];
                    case 6: return [2 /*return*/, engine.transition(events.receiveReconnectGiveup(new PubNubError_1.PubNubError(config.retryConfiguration
        ...
        _this.on(effects.handshakeReconnect.type, (0, core_1.asyncHandler)(function (payload_1, abortSignal_1, _a) { return __awaiter(_this, [payload_1, abortSignal_1, _a], void 0, function (payload, abortSignal, _b) {
            var result, error_3;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        if (error_3 instanceof PubNubError_1.PubNubError) {
                            return [2 /*return*/, engine.transition(events.handshakeReconnectFailure(error_3))];
                        }
                        return [3 /*break*/, 5];
                    case 5: return [3 /*break*/, 7];
                    case 6: return [2 /*return*/, engine.transition(events.handshakeReconnectGiveup(new PubNubError_1.PubNubError(config.retryConfiguration
                            ? config.retryConfiguration.getGiveupReason(payload.reason, payload.attempts)
