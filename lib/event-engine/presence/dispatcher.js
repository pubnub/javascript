...
class PresenceEventEngineDispatcher extends core_1.Dispatcher {
    constructor(engine, dependencies) {
        ...
        this.on(effects.heartbeat.type, (0, core_1.asyncHandler)((payload_1, abortSignal_1, _a) => __awaiter(this, [payload_1, abortSignal_1, _a], void 0, function* (payload, abortSignal, { heartbeat, presenceState, config }) {
        ...
        this.on(effects.emitStatus.type, (0, core_1.asyncHandler)((payload_1, _1, _a) => __awaiter(this, [payload_1, _1, _a], void 0, function* (payload, _, { emitStatus, config }) {
            if (config.announceFailedHeartbeats && (payload === null || payload === void 0 ? void 0 : payload.error) === true) {
                emitStatus(Object.assign(Object.assign({}, payload), { operation: operations_1.default.PNHeartbeatOperation }));
            }
            else if (config.announceSuccessfulHeartbeats && payload.statusCode === 200) {
                emitStatus(Object.assign(Object.assign({}, payload), { error: false, operation: operations_1.default.PNHeartbeatOperation, category: categories_1.default.PNAcknowledgmentCategory }));
            }
        })));
    }
}
