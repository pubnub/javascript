...
exports.HeartbeatCooldownState = new state_1.State('HEARTBEATCOOLDOWN');
exports.HeartbeatCooldownState.onEnter(function () { return (0, effects_1.wait)(); });
exports.HeartbeatCooldownState.onExit(function () { return effects_1.wait.cancel; });
exports.HeartbeatCooldownState.on(events_1.timesUp.type, function (context, _) {
    return heartbeating_1.HeartbeatingState.with({
        channels: context.channels,
        groups: context.groups,
    });
});
exports.HeartbeatCooldownState.on(events_1.joined.type, function (context, event) {
    return heartbeating_1.HeartbeatingState.with({
...
exports.HeartbeatCooldownState.on(events_1.left.type, function (context, event) {
    return heartbeating_1.HeartbeatingState.with({
...
exports.HeartbeatCooldownState.on(events_1.disconnect.type, function (context) {
    return heartbeat_stopped_1.HeartbeatStoppedState.with({
        channels: context.channels,
        groups: context.groups,
    }, [(0, effects_1.leave)(context.channels, context.groups)]);
});
exports.HeartbeatCooldownState.on(events_1.leftAll.type, function (context, _) {
