...
import { disconnect, heartbeatFailure, heartbeatGiveup, heartbeatSuccess, joined, left, leftAll, } from '../events';
import { delayedHeartbeat, leave } from '../effects';
...
export const HearbeatReconnectingState = new State('HEARBEAT_RECONNECTING');
