...
exports.HeartbeatingState.on(events_1.heartbeatSuccess.type, function (context, event) {
    return heartbeat_cooldown_1.HeartbeatCooldownState.with({
        channels: context.channels,
        groups: context.groups,
    }, [(0, effects_1.emitStatus)(event.payload)]);
});
...
exports.HeartbeatingState.on(events_1.heartbeatFailure.type, function (context, event) {
    return heartbeat_reconnecting_1.HearbeatReconnectingState.with(__assign(__assign({}, context), { attempts: 0, reason: event.payload }), [(0, effects_1.emitStatus)(event.payload)]);
});
