...
exports.HeartbeatFailedState.on(events_1.joined.type, function (context, event) {
...
exports.HeartbeatFailedState.on(events_1.left.type, function (context, event) {
    return heartbeating_1.HeartbeatingState.with({
...
exports.HeartbeatFailedState.on(events_1.reconnect.type, function (context, _) {
    return heartbeating_1.HeartbeatingState.with({
        channels: context.channels,
        groups: context.groups,
    });
});
exports.HeartbeatFailedState.on(events_1.disconnect.type, function (context, _) {
    return heartbeat_stopped_1.HeartbeatStoppedState.with({
        channels: context.channels,
        groups: context.groups,
    }, [(0, effects_1.leave)(context.channels, context.groups)]);
});
exports.HeartbeatFailedState.on(events_1.leftAll.type, function (context, _) {
