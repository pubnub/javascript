 ...
 * @internal
 */
instances_1.HandshakingState.onEnter((context) => { var _a; return (0, effects_1.handshake)(context.channels, context.groups, (_a = context.onDemand) !== null && _a !== void 0 ? _a : false); });
instances_1.HandshakingState.onExit(() => effects_1.handshake.cancel);
instances_1.HandshakingState.on(events_1.subscriptionChange.type, (context, { payload }) => {
...
instances_1.HandshakingState.on(events_1.handshakeSuccess.type, (context, { payload }) => {
    var _a, _b, _c, _d, _e;
...
instances_1.HandshakingState.on(events_1.handshakeFailure.type, (context, event) => {
    var _a;
    return instances_1.HandshakeFailedState.with(Object.assign(Object.assign({}, context), { reason: event.payload }), [
...
instances_1.HandshakingState.on(events_1.disconnect.type, (context, event) => {
    var _a;
    if (!event.payload.isOffline)
        return instances_1.HandshakeStoppedState.with(Object.assign({}, context));
    else {
        ...
        return instances_1.HandshakeFailedState.with(Object.assign(Object.assign({}, context), { reason: errorReason }), [
            (0, effects_1.emitStatus)({
...
instances_1.HandshakingState.on(events_1.restore.type, (context, { payload }) => {
    var _a;
    if (payload.channels.length === 0 && payload.groups.length === 0)
        return instances_1.UnsubscribedState.with(undefined);
    return instances_1.HandshakingState.with({
...
instances_1.HandshakingState.on(events_1.unsubscribeAll.type, (_) => instances_1.UnsubscribedState.with());
