...
exports.HandshakeReconnectingState.on(events_1.handshakingReconnectingSuccess.type, function (context, event) {
...
exports.HandshakeReconnectingState.on(events_1.handshakingReconnectingFailure.type, function (context, event) {
...
exports.HandshakeReconnectingState.on(events_1.handshakingReconnectingGiveup.type, function (context) {
    return handshake_failure_1.HandshakeFailureState.with({
        groups: context.groups,
        channels: context.channels,
        reason: context.reason,
    }, [(0, effects_1.emitStatus)({ category: categories_1.default.PNConnectionErrorCategory })]);
});
...
exports.HandshakeReconnectingState.on(events_1.unsubscribeAll.type, function (_) {
