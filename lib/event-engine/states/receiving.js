...
exports.ReceivingState.onEnter(function (_) { return (0, effects_1.emitStatus)({ category: 'PNConnectedCategory' }); });
...
exports.ReceivingState.on(events_1.disconnect.type, function (context) {
    ...
    }, [(0, effects_1.emitStatus)({ category: 'PNDisconnectedCategory' })]);
});
