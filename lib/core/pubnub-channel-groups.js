...
var remove_channels_1 = require("./endpoints/channel_groups/remove_channels");
var add_channels_1 = require("./endpoints/channel_groups/add_channels");
var list_channels_1 = require("./endpoints/channel_groups/list_channels");
var delete_group_1 = require("./endpoints/channel_groups/delete_group");
var list_groups_1 = require("./endpoints/channel_groups/list_groups");
var PubnubChannelGroups = /** @class */ (function () {
    ...
    PubnubChannelGroups.prototype.listChannels = function (parameters, callback) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                request = new list_channels_1.ListChannelGroupChannels(__assign(__assign({}, parameters), { keySet: this.keySet }));
                if (callback)
    ...
    PubnubChannelGroups.prototype.listGroups = function (callback) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                request = new list_groups_1.ListChannelGroupsRequest({ keySet: this.keySet });
                if (callback)
                    return [2 /*return*/, this.sendRequest(request, callback)];
                return [2 /*return*/, this.sendRequest(request)];
            });
    ...
    PubnubChannelGroups.prototype.addChannels = function (parameters, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                request = new add_channels_1.AddChannelGroupChannelsRequest(__assign(__assign({}, parameters), { keySet: this.keySet }));
                if (callback)
                    return [2 /*return*/, this.sendRequest(request, callback)];
                return [2 /*return*/, this.sendRequest(request)];
            });
    ...
    PubnubChannelGroups.prototype.removeChannels = function (parameters, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                request = new remove_channels_1.RemoveChannelGroupChannelsRequest(__assign(__assign({}, parameters), { keySet: this.keySet }));
                if (callback)
                    return [2 /*return*/, this.sendRequest(request, callback)];
                return [2 /*return*/, this.sendRequest(request)];
            });
    ...
    PubnubChannelGroups.prototype.deleteGroup = function (parameters, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                request = new delete_group_1.DeleteChannelGroupRequest(__assign(__assign({}, parameters), { keySet: this.keySet }));
                if (callback)
                    return [2 /*return*/, this.sendRequest(request, callback)];
                return [2 /*return*/, this.sendRequest(request)];
            });
