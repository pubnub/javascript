    ...
    value: function _processSubscribeResponse(status, payload) {
      ...
      messages.forEach(function (message) {
        ...
        if (_utils["default"].endsWith(message.channel, '-pnpres')) {
          ...
          _announce2.actualChannel = subscriptionMatch != null ? channel : null;
          _announce2.subscribedChannel = subscriptionMatch != null ? subscriptionMatch : channel;
          ...
          if (_this7._config.cipherKey) {
            _announce2.message = _this7._crypto.decrypt(message.payload);
          } else {
            _announce2.message = message.payload;
          }

          _this7._listenerManager.announceMessage(_announce2);
        }
      });
