...
var endpoint = {
    getOperation: function () { return operations_1.default.PNUpsertUserOperation; },
    validateParams: function (_, params) {
        if (!(params === null || params === void 0 ? void 0 : params.data)) {
            return 'Data cannot be empty';
        }
    },
    usePut: function () { return true; },
    putURL: function (_a, params) {
        var _b;
        var config = _a.config;
        return "/v3/objects/".concat(config.subscribeKey, "/users/").concat(utils_1.default.encodeString((_b = params.userId) !== null && _b !== void 0 ? _b : config.getUserId()));
    },
    putPayload: function (_, params) { return params.data; },
