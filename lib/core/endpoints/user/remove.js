...
var endpoint = {
    getOperation: function () { return operations_1.default.PNRemoveUserOperation; },
    ...
    getURL: function (_a, params) {
        ...
        return "/v3/objects/".concat(config.subscribeKey, "/uuids/").concat(utils_1.default.encodeString((_b = params === null || params === void 0 ? void 0 : params.userId) !== null && _b !== void 0 ? _b : config.getUserId()));
    },
