 ...
 */
var SetUUIDMetadataRequest = /** @class */ (function (_super) {
    __extends(SetUUIDMetadataRequest, _super);
    function SetUUIDMetadataRequest(parameters) {
        var _a, _b;
        var _c;
    ...
    SetUUIDMetadataRequest.prototype.operation = function () {
        return operations_1.default.PNSetUUIDMetadataOperation;
    };
    SetUUIDMetadataRequest.prototype.validate = function () {
        if (!this.parameters.uuid)
            return "'uuid' cannot be empty";
        if (!this.parameters.data)
            return 'Data cannot be empty';
    };
    SetUUIDMetadataRequest.prototype.parse = function (response) {
    ...
    Object.defineProperty(SetUUIDMetadataRequest.prototype, "path", {
        get: function () {
            var _a = this.parameters, subscribeKey = _a.keySet.subscribeKey, uuid = _a.uuid;
            return "/v2/objects/".concat(subscribeKey, "/uuids/").concat((0, utils_1.encodeString)(uuid));
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SetUUIDMetadataRequest.prototype, "queryParameters", {
        get: function () {
            return {
    ...
    Object.defineProperty(SetUUIDMetadataRequest.prototype, "body", {
        get: function () {
