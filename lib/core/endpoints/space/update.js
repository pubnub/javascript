...
var endpoint = {
    getOperation: function () { return operations_1.default.PNUpdateSpaceOperation; },
    ...
    patchURL: function (_a, params) {
        ...
        return "/v3/objects/".concat(config.subscribeKey, "/spaces/").concat(utils_1.default.encodeString(params.spaceId));
    },
