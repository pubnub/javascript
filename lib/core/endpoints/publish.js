...
var PublishRequest = /** @class */ (function (_super) {
    ...
    function PublishRequest(parameters) {
        var _a, _b, _c;
        var _d, _e, _f;
        var _this = _super.call(this, { method: parameters.sendByPost ? transport_request_1.TransportMethod.POST : transport_request_1.TransportMethod.GET }) || this;
        _this.parameters = parameters;
        // Apply default request parameters.
        (_a = (_d = _this.parameters).storeInHistory) !== null && _a !== void 0 ? _a : (_d.storeInHistory = STORE_IN_HISTORY);
    ...
    Object.defineProperty(PublishRequest.prototype, "path", {
        get: function () {
            ...
            return "/publish/".concat(keySet.publishKey, "/").concat(keySet.subscribeKey, "/0/").concat((0, utils_1.encodeString)(channel), "/0").concat(!this.parameters.sendByPost ? "/".concat((0, utils_1.encodeString)(stringifiedPayload)) : '');
        },
        enumerable: false,
        configurable: true
    });
