...
var AddChannelGroupChannelsRequest = /** @class */ (function (_super) {
    ...
    Object.defineProperty(AddChannelGroupChannelsRequest.prototype, "path", {
        get: function () {
            ...
            return "/v1/channel-registration/sub-key/".concat(subscribeKey, "/channel-group/").concat((0, utils_1.encodeString)(channelGroup));
        },
        enumerable: false,
        configurable: true
    });
...
exports.AddChannelGroupChannelsRequest = AddChannelGroupChannelsRequest;
