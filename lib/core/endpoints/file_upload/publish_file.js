...
var PublishFileMessageRequest = /** @class */ (function (_super) {
    ...
    Object.defineProperty(PublishFileMessageRequest.prototype, "path", {
        get: function () {
            ...
            return "/v1/files/publish-file/".concat(publishKey, "/").concat(subscribeKey, "/0/").concat((0, utils_1.encodeString)(channel), "/0/").concat((0, utils_1.encodeString)(this.prepareMessagePayload(fileMessage)));
        },
        enumerable: false,
        configurable: true
    });
