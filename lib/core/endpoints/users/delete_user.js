...
function getOperation() {
    return operations_1.default.PNDeleteUserOperation;
}
exports.getOperation = getOperation;
function validateParams(_a, userId) {
...
function getURL(modules, userId) {
    ...
    return "/v1/objects/".concat(config.subscribeKey, "/users/").concat(utils_1.default.encodeString(userId));
}
