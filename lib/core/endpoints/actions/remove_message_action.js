...
var RemoveMessageAction = /** @class */ (function (_super) {
    ...
    function RemoveMessageAction(parameters) {
        var _this = _super.call(this, { method: transport_request_1.TransportMethod.DELETE }) || this;
    ...
    Object.defineProperty(RemoveMessageAction.prototype, "path", {
        get: function () {
            ...
            return "/v1/message-actions/".concat(subscribeKey, "/channel/").concat((0, utils_1.encodeString)(channel), "/message/").concat(messageTimetoken, "/action/").concat(actionTimetoken);
        },
        enumerable: false,
        configurable: true
    });
