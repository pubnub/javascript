...
exports.SetEntityRequest = void 0;
 ...
 * @internal
 */
class SetEntityRequest extends request_1.AbstractRequest {
    constructor(parameters) {
        super({ method: transport_request_1.TransportMethod.PUT });
        this.parameters = parameters;
    }
    operation() {
        return operations_1.default.PNSetDataSyncEntityOperation;
    }
    parse(response) {
    ...
    get path() {
        ...
        return `/v1/datasync/subkeys/${subscribeKey}/entities/${(0, utils_1.encodeString)(id)}`;
    }
    get body() {
...
exports.SetEntityRequest = SetEntityRequest;
