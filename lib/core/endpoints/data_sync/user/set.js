 ...
 * @internal
 */
class SetUserRequest extends request_1.AbstractRequest {
    constructor(parameters) {
        super({ method: transport_request_1.TransportMethod.PUT });
        this.parameters = parameters;
    }
    operation() {
        return operations_1.default.PNSetDataSyncUserOperation;
    }
    parse(response) {
...
exports.SetUserRequest = SetUserRequest;
