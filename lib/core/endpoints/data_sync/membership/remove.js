...
exports.RemoveMembershipRequest = void 0;
 ...
 * @internal
 */
class RemoveMembershipRequest extends request_1.AbstractRequest {
    constructor(parameters) {
        super({ method: transport_request_1.TransportMethod.DELETE });
        this.parameters = parameters;
    }
    operation() {
        return operations_1.default.PNRemoveDataSyncMembershipOperation;
    }
    validate() {
...
exports.RemoveMembershipRequest = RemoveMembershipRequest;
