...
exports.SetMembershipRequest = void 0;
 ...
 * @internal
 */
class SetMembershipRequest extends request_1.AbstractRequest {
    constructor(parameters) {
        super({ method: transport_request_1.TransportMethod.PUT });
        this.parameters = parameters;
    }
    operation() {
        return operations_1.default.PNSetDataSyncMembershipOperation;
    }
    parse(response) {
...
exports.SetMembershipRequest = SetMembershipRequest;
