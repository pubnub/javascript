...
exports.GetMembershipsRequest = void 0;
 ...
 * @internal
 */
class GetMembershipsRequest extends request_1.AbstractRequest {
    ...
    operation() {
        return operations_1.default.PNGetDataSyncMembershipsOperation;
    }
    parse(response) {
...
exports.GetMembershipsRequest = GetMembershipsRequest;
