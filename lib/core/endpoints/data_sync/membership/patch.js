...
exports.PatchMembershipRequest = void 0;
 ...
 * @internal
 */
class PatchMembershipRequest extends request_1.AbstractRequest {
    constructor(parameters) {
        super({ method: transport_request_1.TransportMethod.PATCH });
        this.parameters = parameters;
    }
    operation() {
        return operations_1.default.PNPatchMembershipOperation;
    }
    parse(response) {
...
exports.PatchMembershipRequest = PatchMembershipRequest;
