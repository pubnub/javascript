...
exports.RemoveChannelRequest = void 0;
 ...
 * @internal
 */
class RemoveChannelRequest extends request_1.AbstractRequest {
    constructor(parameters) {
        super({ method: transport_request_1.TransportMethod.DELETE });
        this.parameters = parameters;
    }
    operation() {
        return operations_1.default.PNRemoveDataSyncChannelOperation;
    }
    validate() {
...
exports.RemoveChannelRequest = RemoveChannelRequest;
