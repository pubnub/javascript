...
exports.GetAllChannelsRequest = void 0;
 ...
 * @internal
 */
class GetAllChannelsRequest extends request_1.AbstractRequest {
    ...
    operation() {
        return operations_1.default.PNGetAllChannelsOperation;
    }
    parse(response) {
...
exports.GetAllChannelsRequest = GetAllChannelsRequest;
