...
exports.SetRelationshipRequest = void 0;
 ...
 * @internal
 */
class SetRelationshipRequest extends request_1.AbstractRequest {
    constructor(parameters) {
        super({ method: transport_request_1.TransportMethod.PUT });
        this.parameters = parameters;
    }
    operation() {
        return operations_1.default.PNSetDataSyncRelationshipOperation;
    }
    parse(response) {
    ...
    get path() {
        ...
        return `/v1/datasync/subkeys/${subscribeKey}/relationships/${(0, utils_1.encodeString)(id)}`;
    }
    get body() {
...
exports.SetRelationshipRequest = SetRelationshipRequest;
