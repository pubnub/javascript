...
var default_1 = /** @class */ (function () {
    ...
    function default_1(setup) {
        ...
        var subscriptionManager = new subscription_manager_1.default({
        ...
        this.objects = {
            ...
            setChannelMembers: function (parameters) {
                ...
                return endpoint_1.default.call.apply(endpoint_1.default, __spreadArray([_this,
                    modules,
                    set_3.default, __assign({ type: 'set' }, parameters)], rest, false));
            },
            removeChannelMembers: function (parameters) {
                ...
                return endpoint_1.default.call.apply(endpoint_1.default, __spreadArray([_this,
                    modules,
                    set_3.default, __assign({ type: 'delete' }, parameters)], rest, false));
            },
            ...
            setMemberships: function (parameters) {
                ...
                return endpoint_1.default.call.apply(endpoint_1.default, __spreadArray([_this,
                    modules,
                    set_4.default, __assign({ type: 'set' }, parameters)], rest, false));
            },
            removeMemberships: function (parameters) {
                ...
                return endpoint_1.default.call.apply(endpoint_1.default, __spreadArray([_this,
                    modules,
                    set_4.default, __assign({ type: 'delete' }, parameters)], rest, false));
            },
        };
        // Objects API
