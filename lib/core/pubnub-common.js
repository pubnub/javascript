...
const data_sync_relationship_1 = require("../entities/data-sync-relationship");
const data_sync_membership_1 = require("../entities/data-sync-membership");
const data_sync_channel_1 = require("../entities/data-sync-channel");
const data_sync_entity_1 = require("../entities/data-sync-entity");
const channel_metadata_1 = require("../entities/channel-metadata");
const subscription_set_1 = require("../entities/subscription-set");
const data_sync_user_1 = require("../entities/data-sync-user");
...
// endregion
// region DataSync
const pubnub_data_sync_1 = __importDefault(require("./pubnub-data-sync"));
// endregion
// region Time
...
class PubNubCore {
    ...
    constructor(configuration) {
        ...
        this.logger.debug('PubNub', () => ({
            ...
            ignoredKeys(key, obj) {
                return typeof obj[key] === 'function' || key.startsWith('_') || key === 'keySet' || (0, utils_1.isSensitiveLogKey)(key);
            },
        }));
        ...
        if (process.env.DATA_SYNC_MODULE !== 'disabled')
            this._dataSync = new pubnub_data_sync_1.default(this._configuration, this.sendRequest.bind(this));
    ...
    dataSyncUser(id) {
        ...
        if (!entity)
            entity = this.entities[`${id}_dsu`] = new data_sync_user_1.DataSyncUser(id, this);
        return entity;
    }
    /**
    ...
    dataSyncChannel(id) {
        ...
        if (!entity)
            entity = this.entities[`${id}_dsc`] = new data_sync_channel_1.DataSyncChannel(id, this);
        return entity;
    }
    /**
    ...
    dataSyncMembership(id) {
        ...
        if (!entity)
            entity = this.entities[`${id}_dsm`] = new data_sync_membership_1.DataSyncMembership(id, this);
        return entity;
    }
    /**
    ...
    dataSyncEntity(id) {
        ...
        if (!entity)
            entity = this.entities[`${id}_dse`] = new data_sync_entity_1.DataSyncEntity(id, this);
        return entity;
    }
    /**
    ...
    dataSyncRelationship(id) {
        ...
        if (!entity)
            entity = this.entities[`${id}_dsr`] = new data_sync_relationship_1.DataSyncRelationship(id, this);
        return entity;
    }
    /**
