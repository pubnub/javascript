...
// Space endpoint
var create_1 = __importDefault(require("./endpoints/space/create"));
var fetch_1 = __importDefault(require("./endpoints/space/fetch"));
var remove_3 = __importDefault(require("./endpoints/space/remove"));
var update_1 = __importDefault(require("./endpoints/space/update"));
// User endpoint
var create_2 = __importDefault(require("./endpoints/user/create"));
var fetch_2 = __importDefault(require("./endpoints/user/fetch"));
var remove_4 = __importDefault(require("./endpoints/user/remove"));
var update_2 = __importDefault(require("./endpoints/user/update"));
...
var default_1 = /** @class */ (function () {
    ...
    function default_1(setup) {
        ...
        // User Apis
        this.createUser = endpoint_1.default.bind(this, modules, create_2.default);
        this.updateUser = endpoint_1.default.bind(this, modules, update_2.default);
        this.removeUser = endpoint_1.default.bind(this, modules, remove_4.default);
        this.fetchUser = endpoint_1.default.bind(this, modules, fetch_2.default);
        this.fetchUsers = this.objects.getAllUUIDMetadata;
        // Space apis
        this.createSpace = endpoint_1.default.bind(this, modules, create_1.default);
        this.updateSpace = endpoint_1.default.bind(this, modules, update_1.default);
        this.removeSpace = endpoint_1.default.bind(this, modules, remove_3.default);
        this.fetchSpace = endpoint_1.default.bind(this, modules, fetch_1.default);
