...
declare namespace PubNub {
  ...
  export class PubNubDataSync {
     ...
     */
    createEntityClass(
      parameters: DataSync.CreateEntityClassParameters,
      callback: ResultCallback<DataSync.CreateEntityClassResponse>,
    ): void;
    /**
     * Create a new Entity Class.
     *
     * @param parameters - Request configuration parameters.
     *
     * @returns Asynchronous create entity class response.
     */
    createEntityClass(parameters: DataSync.CreateEntityClassParameters): Promise<DataSync.CreateEntityClassResponse>;
    /**
     ...
     */
    getEntityClass(
      parameters: DataSync.GetEntityClassParameters,
      callback: ResultCallback<DataSync.GetEntityClassResponse>,
    ): void;
    /**
     * Fetch a specific Entity Class.
     *
     * @param parameters - Request configuration parameters.
     *
     * @returns Asynchronous get entity class response.
     */
    getEntityClass(parameters: DataSync.GetEntityClassParameters): Promise<DataSync.GetEntityClassResponse>;
    /**
     * Fetch a paginated list of Entity Classes.
     *
     * @param callback - Request completion handler callback.
     */
    getAllEntityClasses(callback: ResultCallback<DataSync.GetAllEntityClassesResponse>): void;
    /**
     * Fetch a paginated list of Entity Classes.
     *
     * @param parameters - Request configuration parameters.
     ...
     */
    getAllEntityClasses(
      parameters: DataSync.GetAllEntityClassesParameters,
      callback: ResultCallback<DataSync.GetAllEntityClassesResponse>,
    ): void;
    /**
     * Fetch a paginated list of Entity Classes.
     *
     * @param [parameters] - Request configuration parameters.
     *
     * @returns Asynchronous get all entity classes response.
     */
    getAllEntityClasses(
      parameters?: DataSync.GetAllEntityClassesParameters,
    ): Promise<DataSync.GetAllEntityClassesResponse>;
    /**
     ...
     */
    updateEntityClass(
      parameters: DataSync.UpdateEntityClassParameters,
      callback: ResultCallback<DataSync.UpdateEntityClassResponse>,
    ): void;
    /**
     * Update an Entity Class (full replacement via PUT).
     *
     * @param parameters - Request configuration parameters.
     *
     * @returns Asynchronous update entity class response.
     */
    updateEntityClass(parameters: DataSync.UpdateEntityClassParameters): Promise<DataSync.UpdateEntityClassResponse>;
    /**
     ...
     */
    patchEntityClass(
      parameters: DataSync.PatchEntityClassParameters,
      callback: ResultCallback<DataSync.PatchEntityClassResponse>,
    ): void;
    /**
     * Patch an Entity Class (partial update via JSON Patch RFC 6902).
     *
     ...
     * @param parameters - Request configuration parameters.
     *
     * @returns Asynchronous patch entity class response.
     */
    patchEntityClass(parameters: DataSync.PatchEntityClassParameters): Promise<DataSync.PatchEntityClassResponse>;
    /**
     ...
     */
    removeEntityClass(
      parameters: DataSync.RemoveEntityClassParameters,
      callback: ResultCallback<DataSync.RemoveEntityClassResponse>,
    ): void;
    /**
     * Remove an Entity Class.
     *
     * @param parameters - Request configuration parameters.
     *
     * @returns Asynchronous remove entity class response.
     */
    removeEntityClass(parameters: DataSync.RemoveEntityClassParameters): Promise<DataSync.RemoveEntityClassResponse>;
    /**
     * Create a new Entity.
     *
     * @param parameters - Request configuration parameters.
  ...
  export namespace DataSync {
    ...
    export type EntityClassConfig = {
      /**
       * Time-to-live in seconds for entities of this class.
       * -1 means entities never expire.
    ...
    /**
     * Entity class properties (used in create/update requests).
     */
    export type EntityClassProperties = {
      /** Human-readable description. */
      description?: string;
      /** JSON Schema (draft 2020-12) for validating entity payloads. */
      schema?: Record<string, unknown>;
      /** Entity class configuration. */
      config: EntityClassConfig;
      /** Optional list of filterable fields for indexed/queryable properties. */
      filterableFields?: FilterableField[];
    };

    /**
     * Entity class resource as returned from the server.
     */
    export type EntityClassObject = EntityClassProperties & {
      /** Unique semantic identifier for the entity class. */
      name: string;
      /** Version of the entity class. */
      version: number;
      /** Date and time the entity class was created (ISO 8601). */
      createdAt: string;
      /** Date and time the entity class was last updated (ISO 8601). */
      updatedAt: string;
    ...
    /**
     * Create Entity Class request parameters.
     */
    export type CreateEntityClassParameters = {
      /** Name of the entity class. */
      name: string;
      /** Version of the entity class. */
      version: number;
      /** Entity class properties to set. */
      data: EntityClassProperties;
      /**
    ...
    /**
     * Get Entity Class request parameters.
     */
    export type GetEntityClassParameters = {
      /** Name of the entity class. */
      name: string;
      /** Version of the entity class. */
      version: number;
    ...
    /**
     * Get All Entity Classes request parameters.
     */
    export type GetAllEntityClassesParameters = PagedRequestParameters;

    /**
     * Update Entity Class request parameters (full replacement via PUT).
     */
    export type UpdateEntityClassParameters = {
      /** Name of the entity class. */
      name: string;
      /** Version of the entity class. */
      version: number;
      /** Complete entity class properties for replacement. */
      data: EntityClassProperties;
      /**
    ...
    /**
     * Patch Entity Class request parameters (partial update via JSON Patch RFC 6902).
     *
     * Uses `set` and `remove` with dot-notation field paths.
     ...
     */
    export type PatchEntityClassParameters = {
      /** Name of the entity class. */
      name: string;
      /** Version of the entity class. */
      version: number;
       ...
       *   'config.ttlSec': 3600,
       *   'filterableFields.0.enabledAdvancedFiltering': true,
       * }
       * ```
       */
       ...
       * @example
       * ```typescript
       * remove: ['schema', 'filterableFields.2']
       * ```
       */
      remove?: string[];
      /**
    ...
    /**
     * Remove Entity Class request parameters.
     */
    export type RemoveEntityClassParameters = {
      /** Name of the entity class. */
      name: string;
      /** Version of the entity class. */
      version: number;
    ...
    /** Response for creating an entity class. */
    export type CreateEntityClassResponse = DataSyncEntityResponse<EntityClassObject>;

    /** Response for getting a single entity class. */
    export type GetEntityClassResponse = DataSyncEntityResponse<EntityClassObject>;

    /** Response for listing all entity classes. */
    export type GetAllEntityClassesResponse = DataSyncPagedResponse<EntityClassObject>;

    /** Response for updating an entity class (PUT). */
    export type UpdateEntityClassResponse = DataSyncEntityResponse<EntityClassObject>;

    /** Response for patching an entity class (PATCH). */
    export type PatchEntityClassResponse = DataSyncEntityResponse<EntityClassObject>;

    /** Response for removing an entity class. */
    export type RemoveEntityClassResponse = {
      /** HTTP status code. */
      status: number;
    };
