...
module.exports = /** @class */ (function (_super) {
    ...
    function class_1(setup) {
        ...
        if (setup.cipherKey) {
            setup.cryptoModule = new nodeCryptoModule_1.CryptoModule({
                default: new nodeCryptoModule_1.LegacyCryptor({ cipherKey: setup.cipherKey, useRandomIVs: setup.useRandomIVs }),
                cryptors: [new nodeCryptoModule_1.AesCbcCryptor({ cipherKey: setup.cipherKey })],
            });
        }
        if (!('ssl' in setup)) {
            setup.ssl = true;
