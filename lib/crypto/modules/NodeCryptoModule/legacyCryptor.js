...
var LegacyCryptor = /** @class */ (function () {
    function LegacyCryptor(config) {
        this.config = config;
        this.cryptor = new index_1.default(__assign({}, config));
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this.config.cipherKey)
                    throw new PubNubError_1.PubNubError('File encryption error: cipher key not set.');
    ...
    LegacyCryptor.prototype.decryptFile = function (file, File) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!this.config.cipherKey)
                    throw new PubNubError_1.PubNubError('File decryption error: cipher key not set.');
