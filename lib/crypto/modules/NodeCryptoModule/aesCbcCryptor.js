...
var AesCbcCryptor = /** @class */ (function () {
    ...
    AesCbcCryptor.prototype.encrypt = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var iv, key, bPlain, aes;
            return __generator(this, function (_a) {
                iv = this.getIv();
                key = this.getKey();
                bPlain = Buffer.from(data);
                aes = (0, crypto_1.createCipheriv)(this.algo, key, iv);
                return [2 /*return*/, {
                        metadata: iv,
    ...
    AesCbcCryptor.prototype.decrypt = function (encryptedData) {
        return __awaiter(this, void 0, void 0, function () {
            var aes;
            return __generator(this, function (_a) {
                aes = (0, crypto_1.createDecipheriv)(this.algo, this.getKey(), encryptedData.metadata);
                return [2 /*return*/, Buffer.concat([aes.update(encryptedData.data), aes.final()])];
            });
        });
    };
