 ...
 */
export class CryptoModule extends AbstractCryptoModule {
    // --------------------------------------------------------
    ...
    encrypt(data) {
        ...
        const encryptedData = typeof encrypted.data === 'string' ? CryptoModule.encoder.encode(encrypted.data) : encrypted.data.buffer;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (file.data instanceof Buffer) {
                ...
                return File.create({
                    ...
                    data: Buffer.from(typeof encryptedData === 'string' ? CryptoModule.encoder.encode(encryptedData) : encryptedData),
                });
            }
    ...
    decryptFile(file, File) {
        return __awaiter(this, void 0, void 0, function* () {
            if (file.data && file.data instanceof Buffer) {
                ...
                return File.create({
                    name: file.name,
                    data: Buffer.from(this.decrypt(file.data)),
                });
            }
