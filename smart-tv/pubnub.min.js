...
window.JSON&&window.JSON.stringify||function(){function b(){try{return this.valueOf()}catch(c){return da}}function l(b){c.lastIndex=0;return c.test(b)?'"'+b.replace(c,function(c){var b=x[c];return"string"===typeof b?b:"\\u"+("0000"+c.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+b+'"'}function t(c,x){var z,E,F,G,B,H=s,u=x[c];u&&"object"===typeof u&&(u=b.call(u));"function"===typeof J&&(u=J.call(x,c,u));switch(typeof u){case "string":return l(u);case "number":return isFinite(u)?String(u):"null";
case "boolean":case "null":return String(u);case "object":if(!u)return"null";s+=I;B=[];if("[object Array]"===Object.prototype.toString.apply(u)){G=u.length;for(z=0;z<G;z+=1)B[z]=t(z,u)||"null";F=0===B.length?"[]":s?"[\n"+s+B.join(",\n"+s)+"\n"+H+"]":"["+B.join(",")+"]";s=H;return F}if(J&&"object"===typeof J){G=J.length;for(z=0;z<G;z+=1)E=J[z],"string"===typeof E&&(F=t(E,u))&&B.push(l(E)+(s?": ":":")+F)}else for(E in u)Object.hasOwnProperty.call(u,E)&&(F=t(E,u))&&B.push(l(E)+(s?": ":":")+F);F=0===
...
JSON.stringify(a));pa=setTimeout(s,P*O)}}))}function I(){!m&&s()}function x(a){if(h){if(!W.length)return}else{a&&(W.i=0);if(W.i||!W.length)return;W.i=1}n(W.shift())}function J(a){var d=0;Z(Ia(p),function(e){if(e=p[e])d++,(a||N())(e)});return d}function q(a,d,e){if("object"==typeof a){if(a.error&&a.message&&a.payload){e({message:a.message,payload:a.payload});return}if(a.payload){d(a.payload);return}}d(a)}function D(a,d){"object"==typeof a&&a.error?d({message:a.message,payload:a.payload}):d(a)}function z(){r()||
F(1,{error:"Offline. Please check your network settings. "});setTimeout(z,O)}function E(){V.time(function(a){G(N(),a);a||F(1,{error:"Heartbeat failed to connect to Pubnub Servers.Please check your network settings."});setTimeout(E,u)})}function F(a,d){e&&e(a,d);e=da}function G(d,e){function c(e){e&&(a=U()-(e/1E4+(U()-g)/2),d&&d(a))}var g=U();e&&c(e)||V.time(c)}var B=+b.windowing||na,H=(+b.timeout||qa)*O,u=(+b.keepalive||ta)*O,v=b.noleave||0,f=b.publish_key||"demo",k=b.subscribe_key||"demo",L=b.auth_key||
"",R=b.secret_key||"",S=b.PNSDK||"",ea=b.hmac_SHA256,aa=b.ssl?"s":"",X="http"+aa+"://"+(b.origin||"pubsub.pubnub.com"),M=Ba(X),fa=Ba(X),W=[],a=0,y=0,d=0,e=0,w=0,A=0,sa=K,p={},ba={},pa=da,ga=t(b.heartbeat||b.pnexpires||0,b.error),P=ga-3,m=K,h=b.no_wait_for_pending,n=b.xdr,g=b.error||N(),r=b._is_online||function(){return 1},T=b.jsonp_cb||function(){return 0},ha=b.db||{get:N(),set:N()},Y=b.cipher_key,Q=b.uuid||ha&&ha.get(k+"uuid")||"",ia=b.crypto_obj||{encrypt:function(a){return a},decrypt:function(a){return a}},
V={LEAVE:function(a,d,e,c){var g={uuid:Q,auth:L},y=Ba(X);e=e||N();var w=c||N();c=T();if(0<a.indexOf(ma))return C;if(v||!aa&&"0"==c)return K;"0"!=c&&(g.callback=c);n({l:d||aa,timeout:2E3,a:c,data:g,c:function(a){q(a,e,w)},b:function(a){D(a,w)},url:[y,"v2","presence","sub_key",k,"channel",encodeURIComponent(a),"leave"]});return C},set_resumed:function(a){sa=a},get_cipher_key:function(){return Y},set_cipher_key:function(a){Y=a},raw_encrypt:function(a,d){return ia.encrypt(a,d||Y)||a},raw_decrypt:function(a,
d){return c(a,d)},get_heartbeat:function(){return ga},set_heartbeat:function(a){ga=t(a,P,g);P=1<=ga-3?ga-3:1;l();s()},get_heartbeat_interval:function(){return P},set_heartbeat_interval:function(a){P=a;s()},history:function(a,d){d=a.callback||d;var e=a.count||a.limit||100,y=a.reverse||"false",w=a.error||N(),b=a.auth_key||L,p=a.cipher_key,m=a.channel,A=a.start,h=a.end,f={},r=T();if(!m)return g("Missing Channel");if(!d)return g("Missing Callback");if(!k)return g("Missing Subscribe Key");f.stringtoken=
"true";f.count=e;f.reverse=y;f.auth=b;r&&(f.callback=r);A&&(f.start=A);h&&(f.end=h);n({a:r,data:f,c:function(a){if("object"==typeof a&&a.error)w({message:a.message,payload:a.payload});else{for(var e=a[0],g=[],ra=0;ra<e.length;ra++){var y=c(e[ra],p);try{g.push(JSON.parse(y))}catch(b){g.push(y)}}d([g,a[1],a[2]])}},b:function(a){D(a,w)},url:[M,"v2","history","sub-key",k,"channel",encodeURIComponent(m)]})},replay:function(a){var d=d||a.callback||N(),e=a.auth_key||L,c=a.source,y=a.destination,w=a.stop,
b=a.start,p=a.end,m=a.reverse;a=a.limit;var A=T(),h={};if(!c)return g("Missing Source Channel");if(!y)return g("Missing Destination Channel");if(!f)return g("Missing Publish Key");if(!k)return g("Missing Subscribe Key");"0"!=A&&(h.callback=A);w&&(h.stop="all");m&&(h.reverse="true");b&&(h.start=b);p&&(h.end=p);a&&(h.count=a);h.auth=e;n({a:A,c:function(a){q(a,d,err)},b:function(){d([0,"Disconnected"])},url:[M,"v1","replay",f,k,c,y],data:h})},auth:function(a){L=a;l()},time:function(a){var d=T();n({a:d,
data:{uuid:Q,auth:L},timeout:5*O,url:[M,"time",d],c:function(d){a(d[0])},b:function(){a(0)}})},publish:function(a,d){d=d||a.callback||N();var e=a.message,c=a.channel,y=a.auth_key||L,w=a.cipher_key,b=a.error||N(),h=T(),n="push";a.prepend&&(n="unshift");if(!e)return g("Missing Message");if(!c)return g("Missing Channel");if(!f)return g("Missing Publish Key");if(!k)return g("Missing Subscribe Key");e=JSON.stringify(ia.encrypt(e,w||Y)||e);W[n]({a:h,timeout:5*O,url:[M,"publish",f,k,0,encodeURIComponent(c),
h,encodeURIComponent(e)],data:{uuid:Q,auth:y},b:function(a){D(a,b);x(1)},c:function(a){q(a,d,b);x(1)}});x()},unsubscribe:function(a,d){var e=a.channel;d=d||a.callback||N();var c=a.error||N();A=0;w=1;e=Ga((e.join?e.join(","):""+e).split(","),function(a){if(p[a])return a+","+a+ma}).join(",");Z(e.split(","),function(a){var e=C;a&&(ka&&(e=V.LEAVE(a,0,d,c)),e||d({action:"leave"}),p[a]=0,a in ba&&delete ba[a])});l()},subscribe:function(b,h){function m(a){a?setTimeout(l,O):(M=Ba(X,1),fa=Ba(X,1),setTimeout(function(){V.time(m)},
O));J(function(d){if(a&&d.d)return d.d=0,d.n(d.name);!a&&!d.d&&(d.d=1,d.disconnect(d.name))})}function f(){var b=T(),g=Ia(p).join(",");if(g){F();var h={uuid:Q,auth:v};2<JSON.stringify(ba).length&&(h.metadata=JSON.stringify(ba));ga&&(h.pnexpires=ga);I();e=n({timeout:E,a:b,b:function(a){D(a,t);V.time(m)},data:h,url:[fa,"subscribe",k,encodeURIComponent(g),b,A],c:function(e){if(!e||"object"==typeof e&&"error"in e&&e.error)return t(e.error),setTimeout(l,O);u(e[1]);A=!A&&w&&ha.get(k)||e[1];J(function(a){a.e||
(a.e=1,a.m(a.name))});if(sa&&!w)A=0,sa=K,ha.set(k,0);else{Y&&(A=1E4,Y=0);ha.set(k,e[1]);var b=function(){var a=(2<e.length?e[2]:Ga(Ia(p),function(a){return Ga(Array(e[0].length).join(",").split(","),function(){return a})}).join(",")).split(",");return function(){var e=a.shift()||d;return[(p[e]||{}).a||y,e.split(ma)[0]]}}(),g=U()-a-+e[1]/1E4;Z(e[0],function(a){var d=b();a=c(a,p[d[1]].cipher_key);try{d[0](JSON.parse(a),e,d[1],g)}catch(y){d[0](a,e,d[1],g)}})}setTimeout(f,R)}})}}var r=b.channel;h=(h=
h||b.callback)||b.message;var v=b.auth_key||L,s=b.connect||N(),x=b.reconnect||N(),q=b.disconnect||N(),t=b.error||N(),u=b.idle||N(),P=b.presence||0,z=b.noheresync||0,Y=b.backfill||0,ia=b.timetoken||0,E=b.timeout||H,R=b.windowing||B,S=b.state,G=b.heartbeat||b.pnexpires;w=b.restore;A=ia;if(!r)return g("Missing Channel");if(!h)return g("Missing Callback");if(!k)return g("Missing Subscribe Key");(G||0===G)&&set_heartbeat(G);Z((r.join?r.join(","):""+r).split(","),function(a){var e=p[a]||{};p[d=a]={name:a,
e:e.e,d:e.d,f:1,a:y=h,cipher_key:b.cipher_key,m:s,disconnect:q,n:x};S&&(ba[a]=a in S?S[a]:S);P&&(V.subscribe({channel:a+ma,callback:P}),!e.f&&!z&&V.here_now({channel:a,callback:function(d){Z("uuids"in d?d.uuids:[],function(e){P({action:"join",uuid:e,timestamp:U(),occupancy:d.occupancy||1},d,a)})}}))});l=function(){F();setTimeout(f,R)};if(!ka)return la.push(l);l()},here_now:function(a,d){d=a.callback||d;var e=a.error||N(),c=a.auth_key||L,b=a.channel,y=T(),c={uuid:Q,auth:c};a.state&&(c.metadata=1);
if(!d)return g("Missing Callback");if(!k)return g("Missing Subscribe Key");var w=[M,"v2","presence","sub_key",k];b&&w.push("channel")&&w.push(encodeURIComponent(b));"0"!=y&&(c.callback=y);n({a:y,data:c,c:function(a){q(a,d,e)},b:function(a){D(a,e)},url:w})},where_now:function(a,d){d=a.callback||d;var e=a.error||N(),c=a.auth_key||L,b=T(),y=a.uuid||Q,c={auth:c};if(!d)return g("Missing Callback");if(!k)return g("Missing Subscribe Key");"0"!=b&&(c.callback=b);n({a:b,data:c,c:function(a){q(a,d,e)},b:function(a){D(a,
e)},url:[M,"v2","presence","sub_key",k,"uuid",encodeURIComponent(y)]})},state:function(a,d){d=a.callback||d||N();var e=a.error||N(),c=a.auth_key||L,b=T(),y=a.state,w=a.uuid||Q,h=a.channel,c={auth:c};if(!k)return g("Missing Subscribe Key");if(!w)return g("Missing UUID");if(!h)return g("Missing Channel");"0"!=b&&(c.callback=b);p[h]&&p[h].f&&(ba[h]=y);c.metadata=JSON.stringify(y);n({a:b,data:c,c:function(a){q(a,d,e)},b:function(a){D(a,e)},url:y?[M,"v2","presence","sub-key",k,"channel",encodeURIComponent(h),
"uuid",w,"data"]:[M,"v2","presence","sub-key",k,"channel",encodeURIComponent(h),"uuid",encodeURIComponent(w)]})},grant:function(a,d){d=a.callback||d;var e=a.error||N(),c=a.channel,b=T(),y=a.ttl||-1,w=a.read?"1":"0",h=a.write?"1":"0",m={},p=a.auth_key;if(!c)return g("Missing Channel");if(!d)return g("Missing Callback");if(!k)return g("Missing Subscribe Key");if(!f)return g("Missing Publish Key");if(!R)return g("Missing Secret Key");"0"!=b&&(m.callback=b);var m=Math.floor((new Date).getTime()/1E3),
A=ea(k+"\n"+f+"\ngrant\n"+(p&&0<encodeURIComponent(p).length?"auth="+encodeURIComponent(p)+"&":"")+"channel="+encodeURIComponent(c)+"&pnsdk="+encodeURIComponent(S)+"&r="+w+"&timestamp="+encodeURIComponent(m)+(-1<y?"&ttl="+y:"")+"&w="+h,R),A=A.replace(/\+/g,"-"),A=A.replace(/\//g,"_"),m={w:h,r:w,signature:A,channel:c,timestamp:m};-1<y&&(m.ttl=y);p&&(m.auth=p);n({a:b,data:m,c:function(a){q(a,d,e)},b:function(a){D(a,e)},url:[M,"v1","auth","grant","sub-key",k]})},audit:function(a,d){d=a.callback||d;var e=
a.error||N(),c=a.channel,b=a.auth_key,y=T();if(!d)return g("Missing Callback");if(!k)return g("Missing Subscribe Key");if(!f)return g("Missing Publish Key");if(!R)return g("Missing Secret Key");"0"!=y&&(w.callback=y);var w=Math.floor((new Date).getTime()/1E3),h=k+"\n"+f+"\naudit\n";b&&(h+="auth="+encodeURIComponent(b)+"&");c&&(h+="channel="+encodeURIComponent(c)+"&");var h=h+("pnsdk="+encodeURIComponent(S)+"&timestamp="+w),h=ea(h,R),h=h.replace(/\+/g,"-"),h=h.replace(/\//g,"_"),w={signature:h,timestamp:w};
c&&(w.channel=c);b&&(w.auth=b);n({a:y,data:w,c:function(a){q(a,d,e)},b:function(a){D(a,e)},url:[M,"v1","auth","audit","sub-key",k]})},revoke:function(a,d){a.read=K;a.write=K;V.grant(a,d)},set_uuid:function(a){Q=a;l()},get_uuid:function(){return Q},presence_heartbeat:function(a){var d=a.callback||N(),e=a.error||N();a=T();var c={uuid:Q,auth:L};2<JSON.stringify(ba).length&&(c.metadata=JSON.stringify(ba));n({a:a,data:c,timeout:5*O,url:[M,"v2","presence","sub-key",k,"channel",Ha(Ia(p).join(",")),"heartbeat"],
c:function(a){q(a,d,e)},b:function(a){D(a,e)}})},xdr:n,ready:Ja,db:ha,uuid:Aa,map:Ga,each:Z,"each-channel":J,grep:Ea,offline:function(){F(1)},supplant:Fa,now:U,unique:za,updater:Da};Q||(Q=V.uuid());ha.set(k+"uuid",Q);setTimeout(z,O);setTimeout(E,u);pa=setTimeout(I,(P-3)*O);G();return V}
var $=function(){function b(a){for(var c=[],d=0;256>d;d++){for(var e=a,b=d,A=ca,f=ca,A=f=0;8>A;A++)f=1==(b&1)?f^e:f,e=127<e?283^e<<1:e<<1,b>>>=1;c[d]=f}return c}function l(a,c){var d=[];for(i=0;i<a.length;i+=c)d[i/c]=parseInt(a.substr(i,c),16);return d}function t(a){for(var c=0;4>c;c++)a[c]=k[a[c]];return a}function c(a){var c=[],d=[],e,b,A=[];for(e=0;e<v;e++)b=[a[4*e],a[4*e+1],a[4*e+2],a[4*e+3]],c[e]=b;for(e=v;e<4*(u+1);e++){c[e]=[];for(a=0;4>a;a++)d[a]=c[e-1][a];if(0===e%v){a=d[0];b=ca;for(b=0;4>
b;b++)d[b]=d[b+1];d[3]=a;d=t(d);d[0]^=R[e/v-1]}else 6<v&&4==e%v&&(d=t(d));for(a=0;4>a;a++)c[e][a]=c[e-v][a]^d[a]}for(e=0;e<u+1;e++){A[e]=[];for(d=0;4>d;d++)A[e].push(c[4*e+d][0],c[4*e+d][1],c[4*e+d][2],c[4*e+d][3])}return A}function s(a,c){var d=[],e;for(e=0;16>e;e++)d[e]=a[e]^c[e];return d}function I(a,c,d){var e=[],b;for(b=0;16>b;b++)e[b]=a[b]^c[d][b];return e}function x(a){var c=[],d;if(f)for(d=0;4>d;d++)c[4*d]=fa[a[4*d]]^X[a[1+4*d]]^M[a[2+4*d]]^aa[a[3+4*d]],c[1+4*d]=aa[a[4*d]]^fa[a[1+4*d]]^X[a[2+
...
function q(a){var c=f?L:k,d=[],e;for(e=0;16>e;e++)d[e]=c[a[e]];return d}function D(a,c){f=C;var d=I(a,c,u),e;for(e=u-1;-1<e;e--)d=J(d),d=q(d),d=I(d,c,e),0<e&&(d=x(d));return d}function z(a,c){f=K;var d=I(a,c,0),e;for(e=1;e<u+1;e++)d=q(d),d=J(d),e<u&&(d=x(d)),d=I(d,c,e);return d}function E(a,b,d,e){b=c(b);var w=a.length/16,A=[],f,p=[],k="";for(f=0;f<w;f++)A.push(a.slice(16*f,16*(f+1)));for(f=A.length-1;0<=f;f--)p[f]=D(A[f],b),p[f]=0===f?s(p[f],d):s(p[f],A[f-1]);for(f=0;f<w-1;f++)k+=H(p[f]);var k=k+
H(p[f],C),v;if(e)v=k;else try{v=decodeURIComponent(escape(k))}catch(l){throw"Bad Key";}return v}function F(a,b,d){b=c(b);var e=Math.ceil(a.length/16),w=[],f,k=[];for(f=0;f<e;f++){var p=w,v=f,l=a.slice(16*f,16*f+16),x=[],q=ca,q=ca;16>l.length&&(q=16-l.length,x=[q,q,q,q,q,q,q,q,q,q,q,q,q,q,q,q]);for(q=0;q<l.length;q++)x[q]=l[q];p[v]=x}0===a.length%16&&w.push([16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16]);for(f=0;f<w.length;f++)w[f]=0===f?s(w[f],d):s(w[f],k[f-1]),k[f]=z(w[f],b);return k}function G(a,
...
return c=c.slice(0,c.length-c.length%16)}}}();return{size:function(a){switch(a){case 128:u=10;v=4;break;case 192:u=12;v=6;break;case 256:u=14;v=8;break;default:throw"Invalid Key Size Specified:"+a;}},h2a:function(a){var c=[];a.replace(/(..)/g,function(a){c.push(parseInt(a,16))});return c},expandKey:c,encryptBlock:z,decryptBlock:D,Decrypt:f,s2a:B,rawEncrypt:F,rawDecrypt:E,dec:function(a,c,d){a=W.p(a);var b=a.slice(8,16),b=G(B(c,d),b);c=b.key;b=b.g;a=a.slice(16,a.length);return a=E(a,c,b,d)},openSSLKey:G,
...
2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,3516065817,3600352804,4094571909,275423344,430227734,506948616,659060556,883997877,958139571,1322822218,1537002063,1747873779,1955562222,2024104815,2227730452,2361852424,2428436474,2756734187,3204031479,3329325298],q=[1779033703,3144134277,1013904242,2773480762,1359893119,2600822924,528734635,1541459225],D=Array(64),z,E,F,G,B,H,u,v,f,k,L,R;b[t>>5]|=128<<24-t%32;b[(t+64>>9<<4)+15]=t;for(f=0;f<b.length;f+=16){z=q[0];E=q[1];F=q[2];G=q[3];
B=q[4];H=q[5];u=q[6];v=q[7];for(k=0;64>k;k++)D[k]=16>k?b[k+f]:c(c(c(l(D[k-2],17)^l(D[k-2],19)^D[k-2]>>>10,D[k-7]),l(D[k-15],7)^l(D[k-15],18)^D[k-15]>>>3),D[k-16]),L=c(c(c(c(v,l(B,6)^l(B,11)^l(B,25)),B&H^~B&u),J[k]),D[k]),R=c(l(z,2)^l(z,13)^l(z,22),z&E^z&F^E&F),v=u,u=H,H=B,B=c(G,L),G=F,F=E,E=z,z=c(L,R);q[0]=c(z,q[0]);q[1]=c(E,q[1]);q[2]=c(F,q[2]);q[3]=c(G,q[3]);q[4]=c(B,q[4]);q[5]=c(H,q[5]);q[6]=c(u,q[6]);q[7]=c(v,q[7])}return q}(function(b){for(var c=[],l=0;l<8*b.length;l+=8)c[l>>5]|=(b.charCodeAt(l/
