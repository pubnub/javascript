...
declare type ExpectChain<T> = {
    ...
    // chai-nock
    requested: ExpectChain<T>,
    requestedWith: (body: mixed) => ExpectChain<T>,
    requestedWithHeaders: (headers: mixed) => ExpectChain<T>,
    requestedWithHeadersMatch: (partialHeaders: mixed) => ExpectChain<T>,
