...
function Aa(a,d){var b=[];N(a||[],function(a,e){b.push(d(a,e))});return b}function Ba(a,d){var b=[];N(a,function(a,e){d?0>a.search("-pnpres")&&e.e&&b.push(a):e.e&&b.push(a)});return b.sort()}function Ca(a,d){var b=[];N(a,function(a,e){d?0>a.search("-pnpres")&&e.e&&b.push(a):e.e&&b.push(a)});return b.sort()}function Da(){setTimeout(function(){ia||(ia=1,N(ja,function(a){a()}))},E)}var V,W=14,Z=8,Ea=z;
...
function Ha(a,d){var b=12<=W?3:2,c=[],e=[],c=[],e=[],p=a.concat(d),q;c[0]=GibberishAES.p.q(p);e=c[0];for(q=1;q<b;q++)c[q]=GibberishAES.p.q(c[q-1].concat(p)),e=e.concat(c[q]);c=e.slice(0,4*Z);e=e.slice(4*Z,4*Z+16);return{key:c,l:e}}
function Ia(a,d,b){var d=Ja(d),c=Math.ceil(a.length/16),e=[],p,q=[];for(p=0;p<c;p++){var j=e,s=p,D=a.slice(16*p,16*p+16),u=[],r=da,r=da;16>D.length&&(r=16-D.length,u=[r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r]);for(r=0;r<D.length;r++)u[r]=D[r];j[s]=u}0===a.length%16&&e.push([16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16]);for(p=0;p<e.length;p++)e[p]=0===p?Ka(e[p],b):Ka(e[p],q[p-1]),q[p]=La(e[p],d);return q}
function Ma(a,d,b,c){var d=Ja(d),e=a.length/16,p=[],q,j=[],s="";for(q=0;q<e;q++)p.push(a.slice(16*q,16*(q+1)));for(q=p.length-1;0<=q;q--)j[q]=Na(p[q],d),j[q]=0===q?Ka(j[q],b):Ka(j[q],p[q-1]);for(q=0;q<e-1;q++)s+=Fa(j[q]);var s=s+Fa(j[q],v),D;if(c)D=s;else try{D=decodeURIComponent(escape(s))}catch(u){throw"Bad Key";}return D}function La(a,d){Ea=z;var b=Oa(a,d,0),c;for(c=1;c<W+1;c++)b=Pa(b),b=Va(b),c<W&&(b=Wa(b)),b=Oa(b,d,c);return b}
function Na(a,d){Ea=v;var b=Oa(a,d,W),c;for(c=W-1;-1<c;c--)b=Va(b),b=Pa(b),b=Oa(b,d,c),0<c&&(b=Wa(b));return b}function Pa(a){var d=Ea?Xa:Ya,b=[],c;for(c=0;16>c;c++)b[c]=d[a[c]];return b}function Va(a){var d=[],b=Ea?[0,13,10,7,4,1,14,11,8,5,2,15,12,9,6,3]:[0,5,10,15,4,9,14,3,8,13,2,7,12,1,6,11],c;for(c=0;16>c;c++)d[c]=a[b[c]];return d}
function Wa(a){var d=[],b;if(Ea)for(b=0;4>b;b++)d[4*b]=Za[a[4*b]]^$a[a[1+4*b]]^ab[a[2+4*b]]^cb[a[3+4*b]],d[1+4*b]=cb[a[4*b]]^Za[a[1+4*b]]^$a[a[2+4*b]]^ab[a[3+4*b]],d[2+4*b]=ab[a[4*b]]^cb[a[1+4*b]]^Za[a[2+4*b]]^$a[a[3+4*b]],d[3+4*b]=$a[a[4*b]]^ab[a[1+4*b]]^cb[a[2+4*b]]^Za[a[3+4*b]];else for(b=0;4>b;b++)d[4*b]=db[a[4*b]]^jb[a[1+4*b]]^a[2+4*b]^a[3+4*b],d[1+4*b]=a[4*b]^db[a[1+4*b]]^jb[a[2+4*b]]^a[3+4*b],d[2+4*b]=a[4*b]^a[1+4*b]^db[a[2+4*b]]^jb[a[3+4*b]],d[3+4*b]=jb[a[4*b]]^a[1+4*b]^a[2+4*b]^db[a[3+4*
...
V={size:function(a){switch(a){case 128:W=10;Z=4;break;case 192:W=12;Z=6;break;case 256:W=14;Z=8;break;default:throw"Invalid Key Size Specified:"+a;}},h2a:function(a){var d=[];a.replace(/(..)/g,function(a){d.push(parseInt(a,16))});return d},expandKey:Ja,encryptBlock:La,decryptBlock:Na,Decrypt:Ea,s2a:Ga,rawEncrypt:Ia,rawDecrypt:Ma,dec:function(a,d,b){var a=qb.s(a),c=a.slice(8,16),c=Ha(Ga(d,b),c),d=c.key,c=c.l,a=a.slice(16,a.length);return a=Ma(a,d,c,b)},openSSLKey:Ha,a2h:function(a){var d="",b;for(b=
0;b<a.length;b++)d+=(16>a[b]?"0":"")+a[b].toString(16);return d},enc:function(a,d,b){var c;c=[];var e;for(e=0;8>e;e++)c=c.concat(Math.floor(256*Math.random()));e=Ha(Ga(d,b),c);d=e.key;e=e.l;c=[[83,97,108,116,101,100,95,95].concat(c)];a=Ga(a,b);a=Ia(a,d,e);a=c.concat(a);return qb.t(a)},Hash:{MD5:function(a){function d(a,b){var c,d,e,f,j;e=a&2147483648;f=b&2147483648;c=a&1073741824;d=b&1073741824;j=(a&1073741823)+(b&1073741823);return c&d?j^2147483648^e^f:c|d?j&1073741824?j^3221225472^e^f:j^1073741824^
...
c:function(a){s(a,b,e)},b:function(a){j(a,e)},url:a})}function j(a,b){if("object"==typeof a&&a.error){var c={};a.message&&(c.message=a.message);a.payload&&(c.payload=a.payload);b&&b(c)}else b&&b(a)}function s(a,b,c){if("object"==typeof a){if(a.error){b={};a.message&&(b.message=a.message);a.payload&&(b.payload=a.payload);c&&c(b);return}if(a.payload){a.next_page?b&&b(a.payload,a.next_page):b&&b(a.payload);return}}b&&b(a)}function D(a){var b=0;N(Ba(G),function(c){if(c=G[c])b++,(a||A())(c)});return b}
function u(a){var b=0;N(Ca(P),function(c){if(c=P[c])b++,(a||A())(c)})}function r(a){if(ec){if(!ba.length)return}else{a&&(ba.n=0);if(ba.n||!ba.length)return;ba.n=1}J(ba.shift())}function f(){!fb&&h()}function h(){clearTimeout(ha);!O||500<=O||1>O||!Ba(G,v).length&&!Ca(P,v).length?fb=z:(fb=v,B.presence_heartbeat({callback:function(){ha=setTimeout(h,O*E)},error:function(a){t&&t("Presence Heartbeat unable to reach Pubnub servers."+JSON.stringify(a));ha=setTimeout(h,O*E)}}))}function m(a,b){return Ra.decrypt(a,
b||T)||Ra.decrypt(a,T)||a}function g(a,b,c){var d=z;if("undefined"===typeof a)return b;if("number"===typeof a)d=5<a||0==a?z:v;else{if("boolean"===typeof a)return a?30:0;d=v}return d?(c&&c("Presence Heartbeat value invalid. Valid range ( x > 5 or x = 0). Current Value : "+(b||5)),b||5):a}function l(a){var b="",c=[];N(a,function(a){c.push(a)});var d=c.sort(),e;for(e in d){var f=d[e],b=b+(f+"="+encodeURIComponent(a[f]));e!=d.length-1&&(b+="&")}return b}function C(a){a||(a={});N(H,function(b,c){b in a||
(a[b]=c)});return a}function x(a){return bc(a)}function ea(a){function b(a,c){var d=(a&65535)+(c&65535);return(a>>16)+(c>>16)+(d>>16)<<16|d&65535}function c(a,b){return a>>>b|a<<32-b}var d;d=a.replace(/\r\n/g,"\n");for(var a="",e=0;e<d.length;e++){var f=d.charCodeAt(e);128>f?a+=String.fromCharCode(f):(127<f&&2048>f?a+=String.fromCharCode(f>>6|192):(a+=String.fromCharCode(f>>12|224),a+=String.fromCharCode(f>>6&63|128)),a+=String.fromCharCode(f&63|128))}e=a;d=[];for(f=0;f<8*e.length;f+=8)d[f>>5]|=(e.charCodeAt(f/
8)&255)<<24-f%32;var j=8*a.length,e=[1116352408,1899447441,3049323471,3921009573,961987163,1508970993,2453635748,2870763221,3624381080,310598401,607225278,1426881987,1925078388,2162078206,2614888103,3248222580,3835390401,4022224774,264347078,604807628,770255983,1249150122,1555081692,1996064986,2554220882,2821834349,2952996808,3210313671,3336571891,3584528711,113926993,338241895,666307205,773529912,1294757372,1396182291,1695183700,1986661051,2177026350,2456956037,2730485921,2820302411,3259730800,3345764771,
...
a&&(P[a]=0,a in U&&delete U[a],ia&&(c=B.LEAVE_GROUP(a,0,f,b,j)),c||b({action:"leave"}))}));d()},subscribe:function(a,b){function e(a){a?setTimeout(d,E):(M=sa(ra,1),Mb=sa(ra,1),setTimeout(function(){B.time(e)},E));D(function(b){if(a&&b.d)return b.d=0,b.k(b.name);!a&&!b.d&&(b.d=1,b.j(b.name))});u(function(b){if(a&&b.d)return b.d=0,b.k(b.name);!a&&!b.d&&(b.d=1,b.j(b.name))})}function h(){var a=K(),b=Ba(G).join(","),g=Ca(P).join(",");if(b||g){b||(b=",");c();var l=C({uuid:I,auth:p});g&&(l["channel-group"]=
...
l(m);d=Lb(h,Sa);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");m.signature=d;J({a:g,data:m,c:function(a){s(a,b,c)},b:function(a){j(a,c)},url:[M,"v1","auth","audit","sub-key",w]})},revoke:function(a,b){a.read=z;a.write=z;B.grant(a,b)},set_uuid:function(a){I=a;d()},get_uuid:function(){return I},isArray:function(a){return za(a)},get_subscibed_channels:function(){return Ba(G,v)},presence_heartbeat:function(a){var b=a.callback||A(),c=a.error||A(),a=K(),d={uuid:I,auth:L};2<JSON.stringify(U).length&&(d.state=
JSON.stringify(U));0<R&&320>R&&(d.heartbeat=R);"0"!=a&&(d.callback=a);var e;e=Ba(G,v).join(",");e=encodeURIComponent(e);var f=Ca(P,v).join(",");e||(e=",");f&&(d["channel-group"]=f);Y&&(d.instanceid=S);J({a:a,data:C(d),timeout:5*E,url:[M,"v2","presence","sub-key",w,"channel",e,"heartbeat"],c:function(a){s(a,b,c)},b:function(a){j(a,c)}})},stop_timers:function(){clearTimeout(ga);clearTimeout(aa)},xdr:J,ready:Da,db:ma,uuid:ua,map:Aa,each:N,"each-channel":D,grep:xa,offline:function(){c(1,{message:"Offline. Please check your network settings."})},
supplant:ya,now:F,unique:qa,updater:wa};I||(I=B.uuid());S||(S=B.uuid());ma.set(w+"uuid",I);ga=setTimeout(p,E);aa=setTimeout(e,Eb);ha=setTimeout(f,(O-3)*E);b();var X=B,Ua;for(Ua in X)X.hasOwnProperty(Ua)&&(x[Ua]=X[Ua]);x.css=Bb;x.$=ub;x.create=Cb;x.bind=xb;x.head=yb;x.search=wb;x.attr=Ab;x.events=Zb;x.init=x;x.secure=x;xb("beforeunload",window,function(){if(bb)x["each-channel"](function(a){x.LEAVE(a.name,0)});return v});if(a.notest)return x;xb("offline",window,x.offline);xb("offline",document,x.offline);
return x};bc.init=bc;bc.secure=bc;"complete"===document.readyState?setTimeout(Da,0):xb("load",window,function(){setTimeout(Da,0)});var fc=$b||{};PUBNUB=bc({notest:1,publish_key:Ab(fc,"pub-key"),subscribe_key:Ab(fc,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==Ab(fc,"ssl"),origin:Ab(fc,"origin"),uuid:Ab(fc,"uuid")});window.jQuery&&(window.jQuery.PUBNUB=bc);"undefined"!==typeof module&&(module.exports=PUBNUB)&&Da();var Jb=ub("pubnubs")||0;if($b){Bb($b,{position:"absolute",top:-E});
if("opera"in window||Ab($b,"flash"))$b.innerHTML="<object id=pubnubs data=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=movie value=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=allowscriptaccess value=always></object>";PUBNUB.rdx=function(a,d){if(!d)return $[a].onerror();$[a].responseText=unescape(d);$[a].onload()};$.id=E}}
