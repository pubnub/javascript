...
function Fa(a,d,b){var d=Ga(d),c=Math.ceil(a.length/16),e=[],p,q=[];for(p=0;p<c;p++){var j=e,s=p,D=a.slice(16*p,16*p+16),u=[],r=ca,r=ca;16>D.length&&(r=16-D.length,u=[r,r,r,r,r,r,r,r,r,r,r,r,r,r,r,r]);for(r=0;r<D.length;r++)u[r]=D[r];j[s]=u}0===a.length%16&&e.push([16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16]);for(p=0;p<e.length;p++)e[p]=0===p?Ha(e[p],b):Ha(e[p],q[p-1]),q[p]=Ia(e[p],d);return q}
function Ka(a,d,b,c){var d=Ga(d),e=a.length/16,p=[],q,j=[],s="";for(q=0;q<e;q++)p.push(a.slice(16*q,16*(q+1)));for(q=p.length-1;0<=q;q--)j[q]=La(p[q],d),j[q]=0===q?Ha(j[q],b):Ha(j[q],p[q-1]);for(q=0;q<e-1;q++)s+=Ca(j[q]);var s=s+Ca(j[q],v),D;if(c)D=s;else try{D=decodeURIComponent(escape(s))}catch(u){throw"Bad Key";}return D}function Ia(a,d){Ba=z;var b=Ma(a,d,0),c;for(c=1;c<U+1;c++)b=Na(b),b=Ua(b),c<U&&(b=Va(b)),b=Ma(b,d,c);return b}
...
y,clearTimeout(Ja),a||!b||ab(b),setTimeout(function(){a&&Y();var b=tb(B),c=b&&b.parentNode;c&&c.removeChild(b)},E))}if(Cb||Z()){a:{var b,c,e=function(){if(!q){q=1;clearTimeout(s);try{c=JSON.parse(b.responseText)}catch(a){return h(1)}p=1;r(c)}},p=0,q=0,j=a.timeout||1E4,s=setTimeout(function(){h(1,{message:"timeout"})},j),D=a.b||A(),u=a.data||{},r=a.c||A(),f=!a.h,h=function(a,c){p||(p=1,clearTimeout(s),b&&(b.onerror=b.onload=y,b.abort&&b.abort(),b=y),a&&D(c))};try{b=Z()||window.XDomainRequest&&new XDomainRequest||
new XMLHttpRequest;b.onerror=b.onabort=function(){h(1,b.responseText||{error:"Network Connection Error"})};b.onload=b.onloadend=e;b.onreadystatechange=function(){if(b&&4==b.readyState)switch(b.status){case 200:break;default:try{c=JSON.parse(b.responseText),h(1,c)}catch(a){return h(1,{status:b.status,u:y,message:b.responseText})}}};var m=sa(a.url,u);b.open("GET",m,f);f&&(b.timeout=j);b.send()}catch(g){h(0);Cb=0;a=Fb(a);break a}a=h}return a}var l=Bb("script"),e=a.a,B=ma(),x=0,Ja=setTimeout(function(){d(1,
{message:"timeout"})},a.timeout||1E4),Y=a.b||A(),j=a.data||{},ab=a.c||A();window[e]=function(a){d(0,a)};a.h||(l[Gb]=Gb);l.onerror=function(){d(1)};l.src=sa(a.url,j);zb(l,"id",B);xb().appendChild(l);return d},Hb=function(){if(!("onLine"in navigator))return 1;try{return navigator.onLine}catch(a){return v}},Z=function(){if(!Ib||!Ib.get)return 0;var a={id:Z.id++,send:A(),abort:function(){a.id={}},open:function(d,b){Z[a.id]=a;Ib.get(a.id,b)}};return a},Gb="async",Ob=navigator.userAgent,Cb=-1==Ob.indexOf("MSIE 6");
...
b,e)},b:function(a){j(a,e)},url:a})}function j(a,b){if("object"==typeof a&&a.error){var c={};a.message&&(c.message=a.message);a.payload&&(c.payload=a.payload);b&&b(c)}else b&&b(a)}function s(a,b,c){if("object"==typeof a){if(a.error){b={};a.message&&(b.message=a.message);a.payload&&(b.payload=a.payload);c&&c(b);return}if(a.payload){a.next_page?b&&b(a.payload,a.next_page):b&&b(a.payload);return}}b&&b(a)}function D(a){var b=0;M(ya(G),function(c){if(c=G[c])b++,(a||A())(c)});return b}function u(a){var b=
0;M(za(N),function(c){if(c=N[c])b++,(a||A())(c)})}function r(a){if(dc){if(!aa.length)return}else{a&&(aa.n=0);if(aa.n||!aa.length)return;aa.n=1}I(aa.shift())}function f(){!eb&&h()}function h(){clearTimeout(Pa);!O||500<=O||1>O||!ya(G,v).length&&!za(N,v).length?eb=z:(eb=v,C.presence_heartbeat({callback:function(){Pa=setTimeout(h,O*E)},error:function(a){t&&t("Presence Heartbeat unable to reach Pubnub servers."+JSON.stringify(a));Pa=setTimeout(h,O*E)}}))}function m(a,b){return Qa.decrypt(a,b||V)||Qa.decrypt(a,
V)||a}function g(a,b,c){var d=z;if("number"===typeof a)d=5<a||0==a?z:v;else{if("boolean"===typeof a)return a?30:0;d=v}return d?(c&&c("Presence Heartbeat value invalid. Valid range ( x > 5 or x = 0). Current Value : "+(b||5)),b||5):a}function l(a){var b="",c=[];M(a,function(a){c.push(a)});var d=c.sort(),e;for(e in d){var f=d[e],b=b+(f+"="+encodeURIComponent(a[f]));e!=d.length-1&&(b+="&")}return b}function B(a){a||(a={});M(P,function(b,c){b in a||(a[b]=c)});return a}function x(a){return ac(a)}function Ja(a){function b(a,
...
{pnsdk:"PubNub-JS-Web/3.7.9"};var Wb=+a.windowing||10,$b=(+a.timeout||310)*E,Db=(+a.keepalive||60)*E,bc=a.timecheck||0,Jb=a.noleave||0,Q=a.publish_key||"demo",w=a.subscribe_key||"demo",K=a.auth_key||"",Ra=a.secret_key||"",Kb=a.hmac_SHA256,ba=a.ssl?"s":"",oa="http"+ba+"://"+(a.origin||"pubsub.pubnub.com"),L=pa(oa),Lb=pa(oa),aa=[],fb=v,db=0,gb=0,Mb=0,Oa=0,Sa=a.restore||0,ha=0,hb=z,G={},N={},S={},Pa=y,W=g(a.heartbeat||a.pnexpires||0,a.error),O=a.heartbeat_interval||W-3,eb=z,dc=a.no_wait_for_pending,
Nb=a["compatible_3.5"]||z,I=a.xdr,P=a.params||{},t=a.error||A(),cc=a._is_online||function(){return 1},J=a.jsonp_cb||function(){return 0},ia=a.db||{get:A(),set:A()},V=a.cipher_key,H=a.uuid||!a.unique_uuid&&ia&&ia.get(w+"uuid")||"",$,R,Qa=a.crypto_obj||{encrypt:function(a){return a},decrypt:function(a){return a}},C={LEAVE:function(a,b,c,d,e){var c={uuid:H,auth:c||K},f=pa(oa),d=d||A(),h=e||A(),e=J();if(0<a.indexOf(ga))return v;if(Nb&&(!ba||"0"==e)||Jb)return z;"0"!=e&&(c.callback=e);I({h:b||ba,timeout:2E3,
a:e,data:B(c),c:function(a){s(a,d,h)},b:function(a){j(a,h)},url:[f,"v2","presence","sub_key",w,"channel",encodeURIComponent(a),"leave"]});return v},LEAVE_GROUP:function(a,b,c,d,e){var c={uuid:H,auth:c||K},f=pa(oa),d=d||A(),h=e||A(),e=J();if(0<a.indexOf(ga))return v;if(Nb&&(!ba||"0"==e)||Jb)return z;"0"!=e&&(c.callback=e);a&&0<a.length&&(c["channel-group"]=a);I({h:b||ba,timeout:5E3,a:e,data:B(c),c:function(a){s(a,d,h)},b:function(a){j(a,h)},url:[f,"v2","presence","sub_key",w,"channel",encodeURIComponent(","),
"leave"]});return v},set_resumed:function(a){hb=a},get_cipher_key:function(){return V},set_cipher_key:function(a){V=a},raw_encrypt:function(a,b){return Qa.encrypt(a,b||V)||a},raw_decrypt:function(a,b){return m(a,b)},get_heartbeat:function(){return W},set_heartbeat:function(a){W=g(a,O,t);O=1<=W-3?W-3:1;d();h()},get_heartbeat_interval:function(){return O},set_heartbeat_interval:function(a){O=a;h()},get_version:function(){return"3.7.9"},getGcmMessageObject:function(a){return{data:a}},getApnsMessageObject:function(a){var b=
{aps:{badge:1,alert:""}};for(k in a)k[b]=a[k];return b},newPnMessage:function(){var a={};gcm&&(a.pn_gcm=gcm);apns&&(a.pn_apns=apns);for(k in n)a[k]=n[k];return a},_add_param:function(a,b){P[a]=b},channel_group:function(a,b){var c=a.channel_group,b=b||a.callback,d=a.channels||a.channel,e=a.cloak,f,j,h=[],m={},g=a.mode||"add";c&&(c=c.split(":"),1<c.length?(f="*"===c[0]?y:c[0],j=c[1]):j=c[0]);f&&h.push("namespace")&&h.push(encodeURIComponent(f));h.push("channel-group");j&&"*"!==j&&h.push(j);d?(wa(d)&&
(d=d.join(",")),m[g]=d,m.cloak=fb?"true":"false"):"remove"===g&&h.push("remove");"undefined"!=typeof e&&(m.cloak=e?"true":"false");q(a,b,h,m)},channel_group_list_groups:function(a,b){var c;(c=a.namespace||a.ns||a.channel_group||y)&&(a.channel_group=c+":*");C.channel_group(a,b)},channel_group_list_channels:function(a,b){if(!a.channel_group)return t("Missing Channel Group");C.channel_group(a,b)},channel_group_remove_channel:function(a,b){if(!a.channel_group)return t("Missing Channel Group");if(!a.channel&&
...
0;c&&(c=xa((c.join?c.join(","):""+c).split(","),function(a){if(G[a])return a+","+a+ga}).join(","),M(c.split(","),function(a){var c=v;a&&(G[a]=0,a in S&&delete S[a],ea&&(c=C.LEAVE(a,0,f,b,j)),c||b({action:"leave"}))}));e&&(e=xa((e.join?e.join(","):""+e).split(","),function(a){if(N[a])return a+","+a+ga}).join(","),M(e.split(","),function(a){var c=v;a&&(N[a]=0,a in S&&delete S[a],ea&&(c=C.LEAVE_GROUP(a,0,f,b,j)),c||b({action:"leave"}))}));d()},subscribe:function(a,b){function e(a){a?setTimeout(d,E):
(L=pa(oa,1),Lb=pa(oa,1),setTimeout(function(){C.time(e)},E));D(function(b){if(a&&b.d)return b.d=0,b.k(b.name);!a&&!b.d&&(b.d=1,b.j(b.name))});u(function(b){if(a&&b.d)return b.d=0,b.k(b.name);!a&&!b.d&&(b.d=1,b.j(b.name))})}function h(){var a=J(),b=ya(G).join(","),g=za(N).join(",");if(b||g){b||(b=",");c();var l=B({uuid:H,auth:p});g&&(l["channel-group"]=g);2<JSON.stringify(S).length&&(l.state=JSON.stringify(S));W&&(l.heartbeat=W);f();Oa=I({timeout:aa,a:a,b:function(a){a&&a.error&&a.service?(j(a,x),
e(1)):C.time(function(b){!b&&j(a,x);e(b)})},data:B(l),url:[Lb,"subscribe",w,encodeURIComponent(b),a,ha],c:function(a){if(!a||"object"==typeof a&&"error"in a&&a.error)return x(a.error),setTimeout(d,E);O(a[1]);ha=!ha&&Sa&&ia.get(w)||a[1];D(function(a){a.f||(a.f=1,a.i(a.name))});u(function(a){a.f||(a.f=1,a.i(a.name))});if(hb&&!Sa)ha=0,hb=z,ia.set(w,0);else{Q&&(ha=1E4,Q=0);ia.set(w,a[1]);var b,c="",e="";3<a.length?(c=a[3],e=a[2]):c=2<a.length?a[2]:xa(ya(G),function(b){return xa(Array(a[0].length).join(",").split(","),
function(){return b})}).join(",");var f=c.split(","),j=e?e.split(","):[];b=function(){var a=f.shift()||Mb,b=j.shift(),c={};b?(a&&(0<=a.indexOf("-pnpres")&&0>b.indexOf("-pnpres"))&&(b+="-pnpres"),c=N[b]||G[b]||{callback:A()}):c=G[a];a=[c.a||gb,a.split(ga)[0]];b&&a.push(b.split(ga)[0]);return a};var g=F()-db-+a[1]/1E4;M(a[0],function(c){var d=b(),c=m(c,G[d[1]]?G[d[1]].cipher_key:y);d[0]&&d[0](c,a,d[2]||d[1],g,d[1])})}setTimeout(h,$)}})}}var g=a.channel,l=a.channel_group,b=(b=b||a.callback)||a.message,
p=a.auth_key||K,q=a.connect||A(),r=a.reconnect||A(),s=a.disconnect||A(),x=a.error||x||A(),O=a.idle||A(),na=a.presence||0,P=a.noheresync||0,Q=a.backfill||0,Y=a.timetoken||0,aa=a.timeout||$b,$=a.windowing||Wb,R=a.state,V=a.heartbeat||a.pnexpires,ba=a.restore||Sa;Sa=ba;ha=Y;if(!g&&!l)return t("Missing Channel");if(!b)return t("Missing Callback");if(!w)return t("Missing Subscribe Key");(V||0===V)&&C.set_heartbeat(V);g&&M((g.join?g.join(","):""+g).split(","),function(c){var d=G[c]||{};G[Mb=c]={name:c,
f:d.f,d:d.d,e:1,a:gb=b,cipher_key:a.cipher_key,i:q,j:s,k:r};R&&(S[c]=c in R?R[c]:R);na&&(C.subscribe({channel:c+ga,callback:na,restore:ba}),!d.e&&!P&&C.here_now({channel:c,data:B({uuid:H,auth:p}),callback:function(a){M("uuids"in a?a.uuids:[],function(b){na({action:"join",uuid:b,timestamp:Math.floor(F()/1E3),occupancy:a.occupancy||1},a,c)})}}))});l&&M((l.join?l.join(","):""+l).split(","),function(c){var d=N[c]||{};N[c]={name:c,f:d.f,d:d.d,e:1,a:gb=b,cipher_key:a.cipher_key,i:q,j:s,k:r};na&&(C.subscribe({channel_group:c+
ga,callback:na,restore:ba,auth_key:p}),!d.e&&!P&&C.here_now({channel_group:c,data:B({uuid:H,auth:p}),callback:function(a){M("uuids"in a?a.uuids:[],function(b){na({action:"join",uuid:b,timestamp:Math.floor(F()/1E3),occupancy:a.occupancy||1},a,c)})}}))});d=function(){c();setTimeout(h,$)};if(!ea)return fa.push(d);d()},here_now:function(a,b){var b=a.callback||b,c=a.error||A(),d=a.auth_key||K,e=a.channel,f=a.channel_group,h=J(),g=a.state,d={uuid:H,auth:d};if(!("uuids"in a?a.uuids:1))d.disable_uuids=1;
g&&(d.state=1);if(!b)return t("Missing Callback");if(!w)return t("Missing Subscribe Key");g=[L,"v2","presence","sub_key",w];e&&g.push("channel")&&g.push(encodeURIComponent(e));"0"!=h&&(d.callback=h);f&&(d["channel-group"]=f,!e&&g.push("channel")&&g.push(","));I({a:h,data:B(d),c:function(a){s(a,b,c)},b:function(a){j(a,c)},url:g})},where_now:function(a,b){var b=a.callback||b,c=a.error||A(),d=a.auth_key||K,e=J(),f=a.uuid||H,d={auth:d};if(!b)return t("Missing Callback");if(!w)return t("Missing Subscribe Key");
"0"!=e&&(d.callback=e);I({a:e,data:B(d),c:function(a){s(a,b,c)},b:function(a){j(a,c)},url:[L,"v2","presence","sub_key",w,"uuid",encodeURIComponent(f)]})},state:function(a,b){var b=a.callback||b||A(),c=a.error||A(),d=a.auth_key||K,e=J(),f=a.state,h=a.uuid||H,g=a.channel,l=a.channel_group,d=B({auth:d});if(!w)return t("Missing Subscribe Key");if(!h)return t("Missing UUID");if(!g&&!l)return t("Missing Channel");"0"!=e&&(d.callback=e);"undefined"!=typeof g&&G[g]&&G[g].e&&f&&(S[g]=f);"undefined"!=typeof l&&
(N[l]&&N[l].e)&&(f&&(S[l]=f),d["channel-group"]=l,g||(g=","));d.state=JSON.stringify(f);f=f?[L,"v2","presence","sub-key",w,"channel",g,"uuid",h,"data"]:[L,"v2","presence","sub-key",w,"channel",g,"uuid",encodeURIComponent(h)];I({a:e,data:B(d),c:function(a){s(a,b,c)},b:function(a){j(a,c)},url:f})},grant:function(a,b){var b=a.callback||b,c=a.error||A(),d=a.channel,e=a.channel_group,f=J(),h=a.ttl,g=a.read?"1":"0",m=a.write?"1":"0",p=a.manage?"1":"0",q=a.auth_key;if(!b)return t("Missing Callback");if(!w)return t("Missing Subscribe Key");
if(!Q)return t("Missing Publish Key");if(!Ra)return t("Missing Secret Key");var r=w+"\n"+Q+"\ngrant\n",g={w:m,r:g,timestamp:Math.floor((new Date).getTime()/1E3)};a.manage&&(g.m=p);"undefined"!=typeof d&&(d!=y&&0<d.length)&&(g.channel=d);"undefined"!=typeof e&&(e!=y&&0<e.length)&&(g["channel-group"]=e);"0"!=f&&(g.callback=f);if(h||0===h)g.ttl=h;q&&(g.auth=q);g=B(g);q||delete g.auth;r+=l(g);d=Kb(r,Ra);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");g.signature=d;I({a:f,data:g,c:function(a){s(a,b,c)},
...
1E3)};"0"!=g&&(m.callback=g);"undefined"!=typeof d&&(d!=y&&0<d.length)&&(m.channel=d);"undefined"!=typeof e&&(e!=y&&0<e.length)&&(m["channel-group"]=e);f&&(m.auth=f);m=B(m);f||delete m.auth;h+=l(m);d=Kb(h,Ra);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");m.signature=d;I({a:g,data:m,c:function(a){s(a,b,c)},b:function(a){j(a,c)},url:[L,"v1","auth","audit","sub-key",w]})},revoke:function(a,b){a.read=z;a.write=z;C.grant(a,b)},set_uuid:function(a){H=a;d()},get_uuid:function(){return H},isArray:function(a){return wa(a)},
get_subscibed_channels:function(){return ya(G,v)},presence_heartbeat:function(a){var b=a.callback||A(),c=a.error||A(),a=J(),d={uuid:H,auth:K};2<JSON.stringify(S).length&&(d.state=JSON.stringify(S));0<W&&320>W&&(d.heartbeat=W);"0"!=a&&(d.callback=a);var e;e=ya(G,v).join(",");e=encodeURIComponent(e);var f=za(N,v).join(",");e||(e=",");f&&(d["channel-group"]=f);I({a:a,data:B(d),timeout:5*E,url:[L,"v2","presence","sub-key",w,"channel",e,"heartbeat"],c:function(a){s(a,b,c)},b:function(a){j(a,c)}})},stop_timers:function(){clearTimeout($);
clearTimeout(R)},xdr:I,ready:Aa,db:ia,uuid:ra,map:xa,each:M,"each-channel":D,grep:ua,offline:function(){c(1,{message:"Offline. Please check your network settings."})},supplant:va,now:F,unique:ma,updater:ta};H||(H=C.uuid());ia.set(w+"uuid",H);$=setTimeout(p,E);R=setTimeout(e,Db);Pa=setTimeout(f,(O-3)*E);b();var Y=C,Ta;for(Ta in Y)Y.hasOwnProperty(Ta)&&(x[Ta]=Y[Ta]);x.css=Ab;x.$=tb;x.create=Bb;x.bind=wb;x.head=xb;x.search=vb;x.attr=zb;x.events=Yb;x.init=x;x.secure=x;wb("beforeunload",window,function(){if(ab)x["each-channel"](function(a){x.LEAVE(a.name,
0)});return v});if(a.notest)return x;wb("offline",window,x.offline);wb("offline",document,x.offline);return x};ac.init=ac;ac.secure=ac;"complete"===document.readyState?setTimeout(Aa,0):wb("load",window,function(){setTimeout(Aa,0)});var ec=Zb||{};PUBNUB=ac({notest:1,publish_key:zb(ec,"pub-key"),subscribe_key:zb(ec,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==zb(ec,"ssl"),origin:zb(ec,"origin"),uuid:zb(ec,"uuid")});window.jQuery&&(window.jQuery.PUBNUB=ac);"undefined"!==typeof module&&
(module.exports=PUBNUB)&&Aa();var Ib=tb("pubnubs")||0;if(Zb){Ab(Zb,{position:"absolute",top:-E});if("opera"in window||zb(Zb,"flash"))Zb.innerHTML="<object id=pubnubs data=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=movie value=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=allowscriptaccess value=always></object>";PUBNUB.rdx=function(a,d){if(!d)return Z[a].onerror();Z[a].responseText=unescape(d);Z[a].onload()};Z.id=E}}
