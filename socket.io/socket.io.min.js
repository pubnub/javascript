...
window.PUBNUB||function(){function v(a){function b(a){return v(a)}a.jsonp?ja=0:ja=-1==Ba.indexOf("MSIE 6");var c=a.subscribe_key||"";a.uuid||va.get(c+"uuid");var d=a.leave_on_unload||0;a.xdr=f;a.db=va;a.error=a.error||pa;a._is_online=q;a.jsonp_cb=ea;a.hmac_SHA256=ga;a.crypto_obj=Y();a.sendBeacon=p;a.params={pnsdk:"PubNub-JS-Web/3.7.19"};var c=G(a),g;for(g in c)c.hasOwnProperty(g)&&(b[g]=c[g]);b.css=F;b.$=H;b.create=J;b.bind=R;b.head=S;b.search=T;b.attr=K;b.events=ha;b.init=b;b.secure=b;b.crypto_obj=
...
e)},url:a});return!0},set_resumed:function(a){La=a},get_cipher_key:function(){return xa},set_cipher_key:function(a){xa=a},raw_encrypt:function(a,b){return S(a,b)},raw_decrypt:function(a,b){return v(a,b)},get_heartbeat:function(){return V},set_heartbeat:function(a,b){V=Y(a,V,z);Z=b||V/2-1;2==V&&(Z=1);q();fa()},get_heartbeat_interval:function(){return Z},set_heartbeat_interval:function(a){Z=a;fa()},get_version:function(){return"3.7.19"},getGcmMessageObject:function(a){return{data:a}},getApnsMessageObject:function(a){var b=
...
c).split(","),function(a){M[a]&&h.push(a)});if(0==h.length){b({action:"leave"});return}g(h,function(a){a in M&&(M[a]=0);a in aa&&delete aa[a]});g(h,function(a){p.push(a+"-pnpres")});c=!0;wa&&(c=I.LEAVE(h.concat(p),0,d,b,e));c||b({action:"leave"})}if(f){var l=[],m=[];g(x(f)?f:(""+f).split(","),function(a){U[a]&&l.push(a)});if(0==l.length){b({action:"leave"});return}g(l,function(a){a in U&&(U[a]=0);a in aa&&delete aa[a]});g(l,function(a){m.push(a+"-pnpres")});c=!0;wa&&(c=I.LEAVE_GROUP(l.concat(m),0,
d,b,e));c||b({action:"leave"})}q()},subscribe:function(b,c){function f(a){a?setTimeout(q,fa):(Q=ta(sa,1),va=ta(sa,1),y(function(){I.time(f)},1E3));ga(function(b){if(a&&b.j)return b.j=0,b.da(b.name);a||b.j||(b.j=1,b.disconnect(b.name))});R(function(b){if(a&&b.j)return b.j=0,b.da(b.name);a||b.j||(b.j=1,b.disconnect(b.name))})}function h(){var b=P(),c=d(M).join(","),l=a(U).join(",");if(c||l){c||(c=",");ka();var m=p({uuid:N,auth:L});l&&(m["channel-group"]=l);2<JSON.stringify(aa).length&&(m.state=JSON.stringify(aa));
...
get_subscibed_channels:function(){return d(M,!0)},presence_heartbeat:function(b){var f=b.callback||function(){},g=b.error||function(){};b=P();var e={uuid:N,auth:L};2<JSON.stringify(aa).length&&(e.state=JSON.stringify(aa));0<V&&320>V&&(e.heartbeat=V);"0"!=b&&(e.callback=b);var h=c(d(M,!0).join(",")),l=a(U,!0).join(",");h||(h=",");l&&(e["channel-group"]=l);ca&&(e.instanceid=W);O({g:b,data:p(e),url:[Q,"v2","presence","sub-key",E,"channel",h,"heartbeat"],i:function(a){F(a,f,g)},h:function(a){J(a,g)}})},
...
function(a){b(1,a||d&&d.responseText||{error:"Network Connection Error"})};d.onload=d.onloadend=c;d.onreadystatechange=function(){if(d&&4==d.readyState)switch(d.status){case 200:break;default:try{g=JSON.parse(d.responseText),b(1,g)}catch(a){return b(1,{status:d.status,ib:null,message:d.responseText})}}};var w=h(a.url,G);d.open("GET",w,r);r&&(d.timeout=p);d.send()}catch(A){return b(0),ja=0,f(a)}return b}function q(){if(!("onLine"in navigator))return 1;try{return navigator.onLine}catch(a){return!0}}
