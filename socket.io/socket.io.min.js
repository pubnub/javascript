...
a},raw_encrypt:function(a,b){return Da.encrypt(a,b||ka)||a},raw_decrypt:function(a,b){return G(a,b)},get_heartbeat:function(){return T},set_heartbeat:function(a,b){T=Ha(a,T,m);R=b||T/2-1;2==T&&(R=1);c();u()},get_heartbeat_interval:function(){return R},set_heartbeat_interval:function(a){R=a;u()},get_version:function(){return"3.7.11"},getGcmMessageObject:function(a){return{data:a}},getApnsMessageObject:function(a){var b={aps:{badge:1,alert:""}};for(k in a)k[b]=a[k];return b},newPnMessage:function(){var a=
