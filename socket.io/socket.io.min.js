...
window.PUBNUB||function(){function v(a){function b(a){return v(a)}a.jsonp?ja=0:ja=-1==Ba.indexOf("MSIE 6");var c=a.subscribe_key||"";a.uuid||va.get(c+"uuid");var d=a.leave_on_unload||0;a.xdr=f;a.db=va;a.error=a.error||pa;a._is_online=q;a.jsonp_cb=ea;a.hmac_SHA256=ga;a.crypto_obj=Y();a.sendBeacon=p;a.params={pnsdk:"PubNub-JS-Web/3.7.20"};var c=G(a),g;for(g in c)c.hasOwnProperty(g)&&(b[g]=c[g]);b.css=F;b.$=H;b.create=J;b.bind=R;b.head=S;b.search=T;b.attr=K;b.events=ha;b.init=b;b.secure=b;b.crypto_obj=
...
(Array.isArray&&Array.isArray(a)||"number"===typeof a.length)}function g(a,b){if(a&&b)if(x(a))for(var c=0,d=a.length;c<d;)b.call(a[c],a[c],c++);else for(c in a)a.hasOwnProperty&&a.hasOwnProperty(c)&&b.call(a[c],c,a[c])}function w(a,b){var c=[];g(a||[],function(a,d){c.push(b(a,d))});return c}function A(a){return encodeURIComponent(a).replace(/[!'()*~]/g,function(a){return"%"+a.charCodeAt(0).toString(16).toUpperCase()})}function c(a){return encodeURIComponent(a)}function d(a,b){var c=[];g(a,function(a,
d){b?0>a.search("-pnpres")&&d.v&&c.push(a):d.v&&c.push(a)});return c.sort()}function a(a,b){var c=[];g(a,function(a,d){b?0>a.search("-pnpres")&&d.v&&c.push(a):d.v&&c.push(a)});return c.sort()}function b(){y(function(){wa||(wa=1,g(Ma,function(a){a()}))},1E3)}function G(f){function q(){}function p(C){C||(C={});g(Na,function(a,b){a in C||(C[a]=b)});return C}function G(C){var a=[];g(C,function(C){a.push(C)});return a}function u(C){var a="",b=G(C).sort(),c;for(c in b){var f=b[c],a=a+(f+"="+A(C[f]));c!=
b.length-1&&(a+="&")}return a}function Y(C,a,b){var c=!1;if("undefined"===typeof C)return a;if("number"===typeof C)c=5<C||0==C?!1:!0;else{if("boolean"===typeof C)return C?30:0;c=!0}return c?(b&&b("Presence Heartbeat value invalid. Valid range ( x > 5 or x = 0). Current Value : "+(a||5)),a||5):C}function S(C,a){return Ga.encrypt(C,a||xa)||C}function v(C,a){return Ga.decrypt(C,a||xa)||Ga.decrypt(C,xa)||C}function fa(){clearTimeout(ya);!Z||500<=Z||1>Z||!d(M,!0).length&&!a(U,!0).length?Ha=!1:(Ha=!0,I.presence_heartbeat({callback:function(){ya=
setTimeout(fa,1E3*Z)},error:function(C){z&&z("Presence Heartbeat unable to reach Pubnub servers."+JSON.stringify(C));ya=setTimeout(fa,1E3*Z)}}))}function H(){!Ha&&fa()}function T(C){if(Ra){if(!la.length)return}else{C&&(la.sa=0);if(la.sa||!la.length)return;la.sa=1}O(la.shift())}function R(C){var b=0;g(a(U),function(a){if(a=U[a])b++,(C||function(){})(a)})}function ga(a){var b=0;g(d(M),function(c){if(c=M[c])b++,(a||function(){})(c)});return b}function F(a,b,c){if("object"==typeof a){if(a.error){b={};
a.message&&(b.message=a.message);a.payload&&(b.payload=a.payload);c&&c(b);return}if(a.payload){a.next_page?b&&b(a.payload,a.next_page):b&&b(a.payload);return}}b&&b(a)}function J(a,b){if("object"==typeof a&&a.error){var c={};a.message&&(c.message=a.message);a.payload&&(c.payload=a.payload);b&&b(c)}else b&&b(a)}function K(a,b,c,f){b=a.callback||b;var d=a.error||z,g=P();f=f||{};f.auth||(f.auth=a.auth_key||L);a=[Q,"v1","channel-registration","sub-key",E];a.push.apply(a,c);g&&(f.callback=g);O({g:g,data:p(f),
i:function(a){F(a,b,d)},h:function(a){J(a,d)},url:a})}function X(){Sa()||ka(1,{error:"Offline. Please check your network settings. "});qa&&clearTimeout(qa);qa=setTimeout(X,1E3)}function pa(){Fa&&I.time(function(a){ea(function(){},a);a||ka(1,{error:"Heartbeat failed to connect to Pubnub Servers.Please check your network settings."});ra&&clearTimeout(ra);ra=setTimeout(pa,ha)})}function ka(a,b){Ca&&Ca(a,b);Ca=null;clearTimeout(qa);clearTimeout(ra)}function ea(a,b){function c(b){b&&(Ia=e()-(b/1E4+(e()-
f)/2),a&&a(Ia))}var f=e();b&&c(b)||I.time(c)}var Ba=+f.windowing||10,ja=1E3*(+f.timeout||310),ha=1E3*(+f.keepalive||60),Fa=f.timecheck||0,ia=f.noleave||0,ba=f.publish_key,E=f.subscribe_key,L=f.auth_key||"",da=f.secret_key||"",ua=f.hmac_SHA256,za=f.ssl?"s":"",sa="http"+za+"://"+(f.origin||"pubsub.pubnub.com"),Q=ta(sa),va=ta(sa),la=[],Ja=!0,Ia=0,Ka=0,Oa=0,Ca=0,Aa=f.restore||0,ma=0,La=!1,M={},U={},aa={},ya=null,V=Y(f.heartbeat||f.pnexpires||0,f.error),Z=f.heartbeat_interval||V/2-1,Ha=!1,Ra=f.no_wait_for_pending,
Pa=f["compatible_3.5"]||!1,O=f.xdr,Na=f.params||{},z=f.error||function(){},Sa=f._is_online||function(){return 1},P=f.jsonp_cb||function(){return 0},na=f.db||{get:function(){},set:function(){}},xa=f.cipher_key,N=f.uuid||!f.unique_uuid&&na&&na.get(E+"uuid")||"",ca=f.instance_id||!1,W="",Qa=f.shutdown,Da=("undefined"!=typeof f.use_send_beacon?f.use_send_beacon:1)?f.sendBeacon:null,qa,ra;2===V&&(Z=1);var Ga=f.crypto_obj||{encrypt:function(a){return a},decrypt:function(a){return a}},I={LEAVE:function(a,
b,c,f,d){c={uuid:N,auth:c||L};var g=ta(sa);f=f||function(){};var e=d||function(){};d=P();if(0<a.indexOf("-pnpres"))return!0;if(Pa&&(!za||"0"==d)||ia)return!1;"0"!=d&&(c.callback=d);ca&&(c.instanceid=W);a=[g,"v2","presence","sub_key",E,"channel",encodeURIComponent(a),"leave"];c=p(c);if(Da&&(url_string=h(a,c),Da(url_string)))return f&&f({status:200,action:"leave",message:"OK",service:"Presence"}),!0;O({V:b||za,g:d,data:c,i:function(a){F(a,f,e)},h:function(a){J(a,e)},url:a});return!0},LEAVE_GROUP:function(a,
b,c,f,d){c={uuid:N,auth:c||L};var g=ta(sa);f=f||function(){};var e=d||function(){};d=P();if(0<a.indexOf("-pnpres"))return!0;if(Pa&&(!za||"0"==d)||ia)return!1;"0"!=d&&(c.callback=d);a&&0<a.length&&(c["channel-group"]=a);ca&&(c.instanceid=W);a=[g,"v2","presence","sub_key",E,"channel",encodeURIComponent(","),"leave"];c=p(c);if(Da&&(url_string=h(a,c),Da(url_string)))return f&&f({status:200,action:"leave",message:"OK",service:"Presence"}),!0;O({V:b||za,g:d,data:c,i:function(a){F(a,f,e)},h:function(a){J(a,
e)},url:a});return!0},set_resumed:function(a){La=a},get_cipher_key:function(){return xa},set_cipher_key:function(a){xa=a},raw_encrypt:function(a,b){return S(a,b)},raw_decrypt:function(a,b){return v(a,b)},get_heartbeat:function(){return V},set_heartbeat:function(a,b){V=Y(a,V,z);Z=b||V/2-1;2==V&&(Z=1);q();fa()},get_heartbeat_interval:function(){return Z},set_heartbeat_interval:function(a){Z=a;fa()},get_version:function(){return"3.7.20"},getGcmMessageObject:function(a){return{data:a}},getApnsMessageObject:function(a){var b=
...
P();if(!h&&!q)return z("Missing Channel");if(!b)return z("Missing Callback");if(!E)return z("Missing Subscribe Key");m.stringtoken="true";m.count=c;m.reverse=f;m.auth=g;q&&(m["channel-group"]=q,h||(h=","));w&&(m.callback=w);G&&(m.start=G);l&&(m.end=l);u&&(m.include_token="true");r&&(m.string_message_token="true");O({g:w,data:p(m),i:function(a){if("object"==typeof a&&a.error)d({message:a.message,payload:a.payload});else{for(var c=a[0],f=[],C=0;C<c.length;C++)if(u){var g=v(c[C].message,e),h=c[C].timetoken;
try{f.push({message:JSON.parse(g),timetoken:h})}catch(p){f.push({message:g,timetoken:h})}}else{g=v(c[C],e);try{f.push(JSON.parse(g))}catch(p){f.push(g)}}b([f,a[1],a[2]])}},h:function(a){J(a,d)},url:[Q,"v2","history","sub-key",E,"channel",encodeURIComponent(h)]})},replay:function(a,b){b=b||a.callback||function(){};var c=a.auth_key||L,f=a.source,d=a.destination,g=a.stop,e=a.start,h=a.end,q=a.reverse,G=a.limit,m=P(),l={};if(!f)return z("Missing Source Channel");if(!d)return z("Missing Destination Channel");
if(!ba)return z("Missing Publish Key");if(!E)return z("Missing Subscribe Key");"0"!=m&&(l.callback=m);g&&(l.stop="all");q&&(l.reverse="true");e&&(l.start=e);h&&(l.end=h);G&&(l.count=G);l.auth=c;O({g:m,i:function(a){F(a,b,err)},h:function(){b([0,"Disconnected"])},url:[Q,"v1","replay",ba,E,f,d],data:p(l)})},auth:function(a){L=a;q()},time:function(a){var b=P(),c={uuid:N,auth:L};ca&&(c.instanceid=W);O({g:b,data:p(c),url:[Q,"time",b],i:function(b){a(b[0])},h:function(){a(0)}})},publish:function(a,b){var c=
a.message;if(!c)return z("Missing Message");b=b||a.callback||c.callback||a.success||function(){};var f=a.channel||c.channel,d=a.auth_key||L,g=a.cipher_key,e=a.error||c.error||function(){},h=a.post||!1,q="store_in_history"in a?a.store_in_history:!0,l=P(),m="push";a.prepend&&(m="unshift");if(!f)return z("Missing Channel");if(!ba)return z("Missing Publish Key");if(!E)return z("Missing Subscribe Key");c.getPubnubMessage&&(c=c.getPubnubMessage());c=JSON.stringify(S(c,g));c=[Q,"publish",ba,E,0,encodeURIComponent(f),
l,encodeURIComponent(c)];d={uuid:N,auth:d};q||(d.store="0");ca&&(d.instanceid=W);la[m]({g:l,url:c,data:p(d),h:function(a){J(a,e);T(1)},i:function(a){F(a,b,e);T(1)},mode:h?"POST":"GET"});T()},unsubscribe:function(a,b){var c=a.channel,f=a.channel_group,d=a.auth_key||L;b=b||a.callback||function(){};var e=a.error||function(){};ma=0;Aa=1;if(!c&&!f)return z("Missing Channel or Channel Group");if(!ba)return z("Missing Publish Key");if(!E)return z("Missing Subscribe Key");if(c){var h=[],p=[];g(x(c)?c:(""+
c).split(","),function(a){M[a]&&h.push(a)});if(0==h.length){b({action:"leave"});return}g(h,function(a){p.push(a+"-pnpres")});g(h.concat(p),function(a){a in M&&(M[a]=0);a in aa&&delete aa[a]});c=!0;wa&&(c=I.LEAVE(h.join(","),0,d,b,e));c||b({action:"leave"})}if(f){var l=[],m=[];g(x(f)?f:(""+f).split(","),function(a){U[a]&&l.push(a)});if(0==l.length){b({action:"leave"});return}g(l,function(a){m.push(a+"-pnpres")});g(l.concat(m),function(a){a in U&&(U[a]=0);a in aa&&delete aa[a]});c=!0;wa&&(c=I.LEAVE_GROUP(l.join(","),
0,d,b,e));c||b({action:"leave"})}q()},subscribe:function(b,c){function f(a){a?setTimeout(q,fa):(Q=ta(sa,1),va=ta(sa,1),y(function(){I.time(f)},1E3));ga(function(b){if(a&&b.j)return b.j=0,b.da(b.name);a||b.j||(b.j=1,b.disconnect(b.name))});R(function(b){if(a&&b.j)return b.j=0,b.da(b.name);a||b.j||(b.j=1,b.disconnect(b.name))})}function h(){var b=P(),c=d(M).join(","),l=a(U).join(",");if(c||l){c||(c=",");ka();var m=p({uuid:N,auth:L});l&&(m["channel-group"]=l);2<JSON.stringify(aa).length&&(m.state=JSON.stringify(aa));
V&&(m.heartbeat=V);ca&&(m.instanceid=W);H();Ca=O({timeout:T,g:b,h:function(a){a&&a.error&&a.service?(J(a,A),f(1)):I.time(function(b){!b&&J(a,A);f(b)})},data:p(m),url:[va,"subscribe",E,encodeURIComponent(c),b,ma],i:function(a){if(!a||"object"==typeof a&&"error"in a&&a.error)return A(a.error),setTimeout(q,1E3);Y(a[1]);ma=!ma&&Aa&&na.get(E)||a[1];ga(function(a){a.C||(a.C=1,a.connect(a.name))});R(function(a){a.C||(a.C=1,a.connect(a.name))});if(La&&!Aa)ma=0,La=!1,na.set(E,0);else{S&&(ma=1E4,S=0);na.set(E,
a[1]);var b=function(){var b="",c="";3<a.length?(b=a[3],c=a[2]):b=2<a.length?a[2]:w(d(M),function(b){return w(Array(a[0].length).join(",").split(","),function(){return b})}).join(",");var f=b.split(","),g=c?c.split(","):[];return function(){var a=f.shift()||Oa,b=g.shift(),c={};b?(a&&0<=a.indexOf("-pnpres")&&0>b.indexOf("-pnpres")&&(b+="-pnpres"),c=U[b]||M[b]||{callback:function(){}}):c=M[a];a=[c.g||Ka,a.split("-pnpres")[0]];b&&a.push(b.split("-pnpres")[0]);return a}}(),c=e()-Ia-+a[1]/1E4;g(a[0],function(f){var d=
b();f=v(f,M[d[1]]?M[d[1]].cipher_key:null);d[0]&&d[0](f,a,d[2]||d[1],c,d[1])})}setTimeout(h,fa)}})}}var l=b.channel,m=b.channel_group;c=(c=c||b.callback)||b.message;var G=b.connect||function(){},u=b.reconnect||function(){},r=b.disconnect||function(){},A=b.error||A||function(){},Y=b.idle||function(){},oa=b.presence||0,t=b.noheresync||0,S=b.backfill||0,F=b.timetoken||0,T=b.timeout||ja,fa=b.windowing||Ba,x=b.state,B=b.heartbeat||b.pnexpires,Ea=b.heartbeat_interval,K=b.restore||Aa;L=b.auth_key||L;Aa=
K;ma=F;if(!l&&!m)return z("Missing Channel");if(!c)return z("Missing Callback");if(!E)return z("Missing Subscribe Key");(B||0===B||Ea||0===Ea)&&I.set_heartbeat(B,Ea);l&&g((l.join?l.join(","):""+l).split(","),function(a){var f=M[a]||{};M[Oa=a]={name:a,C:f.C,j:f.j,v:1,g:Ka=c,cipher_key:b.cipher_key,connect:G,disconnect:r,da:u};x&&(aa[a]=a in x?x[a]:x);oa&&(I.subscribe({channel:a+"-pnpres",callback:oa,restore:K}),f.v||t||I.here_now({channel:a,data:p({uuid:N,auth:L}),callback:function(b){g("uuids"in b?
b.uuids:[],function(c){oa({action:"join",uuid:c,timestamp:Math.floor(e()/1E3),occupancy:b.occupancy||1},b,a)})}}))});m&&g((m.join?m.join(","):""+m).split(","),function(a){var f=U[a]||{};U[a]={name:a,C:f.C,j:f.j,v:1,g:Ka=c,cipher_key:b.cipher_key,connect:G,disconnect:r,da:u};oa&&(I.subscribe({channel_group:a+"-pnpres",callback:oa,restore:K,auth_key:L}),f.v||t||I.here_now({channel_group:a,data:p({uuid:N,auth:L}),callback:function(b){g("uuids"in b?b.uuids:[],function(c){oa({action:"join",uuid:c,timestamp:Math.floor(e()/
1E3),occupancy:b.occupancy||1},b,a)})}}))});q=function(){ka();setTimeout(h,fa)};if(!wa)return Ma.push(q);q()},here_now:function(a,b){b=a.callback||b;var c=a.debug,f=a.error||function(){},d=a.auth_key||L,g=a.channel,h=a.channel_group,e=P(),l=a.state,d={uuid:N,auth:d};("uuids"in a?a.uuids:1)||(d.disable_uuids=1);l&&(d.state=1);if(!b)return z("Missing Callback");if(!E)return z("Missing Subscribe Key");l=[Q,"v2","presence","sub_key",E];g&&l.push("channel")&&l.push(encodeURIComponent(g));"0"!=e&&(d.callback=
e);h&&(d["channel-group"]=h,!g&&l.push("channel")&&l.push(","));ca&&(d.instanceid=W);O({g:e,data:p(d),i:function(a){F(a,b,f)},h:function(a){J(a,f)},debug:c,url:l})},where_now:function(a,b){b=a.callback||b;var c=a.error||function(){},f=a.auth_key||L,d=P(),g=a.uuid||N,f={auth:f};if(!b)return z("Missing Callback");if(!E)return z("Missing Subscribe Key");"0"!=d&&(f.callback=d);ca&&(f.instanceid=W);O({g:d,data:p(f),i:function(a){F(a,b,c)},h:function(a){J(a,c)},url:[Q,"v2","presence","sub_key",E,"uuid",
encodeURIComponent(g)]})},state:function(a,b){b=a.callback||b||function(){};var c=a.error||function(){},f=a.auth_key||L,d=P(),g=a.state,e=a.uuid||N,h=a.channel,l=a.channel_group,f=p({auth:f});if(!E)return z("Missing Subscribe Key");if(!e)return z("Missing UUID");if(!h&&!l)return z("Missing Channel");"0"!=d&&(f.callback=d);"undefined"!=typeof h&&M[h]&&M[h].v&&g&&(aa[h]=g);"undefined"!=typeof l&&U[l]&&U[l].v&&(g&&(aa[l]=g),f["channel-group"]=l,h||(h=","));f.state=JSON.stringify(g);ca&&(f.instanceid=
W);g=g?[Q,"v2","presence","sub-key",E,"channel",h,"uuid",e,"data"]:[Q,"v2","presence","sub-key",E,"channel",h,"uuid",encodeURIComponent(e)];O({g:d,data:p(f),i:function(a){F(a,b,c)},h:function(a){J(a,c)},url:g})},grant:function(a,b){b=a.callback||b;var c=a.error||function(){},f=a.channel||a.channels,d=a.channel_group,g=P(),h=a.ttl,e=a.read?"1":"0",l=a.write?"1":"0",m=a.manage?"1":"0",q=a.auth_key||a.auth_keys;if(!b)return z("Missing Callback");if(!E)return z("Missing Subscribe Key");if(!ba)return z("Missing Publish Key");
if(!da)return z("Missing Secret Key");var G=E+"\n"+ba+"\ngrant\n",e={w:l,r:e,timestamp:Math.floor((new Date).getTime()/1E3)};a.manage&&(e.m=m);x(f)&&(f=f.join(","));x(q)&&(q=q.join(","));"undefined"!=typeof f&&null!=f&&0<f.length&&(e.channel=f);"undefined"!=typeof d&&null!=d&&0<d.length&&(e["channel-group"]=d);"0"!=g&&(e.callback=g);if(h||0===h)e.ttl=h;q&&(e.auth=q);e=p(e);q||delete e.auth;G+=u(e);f=ua(G,da);f=f.replace(/\+/g,"-");f=f.replace(/\//g,"_");e.signature=f;O({g:g,data:e,i:function(a){F(a,
b,c)},h:function(a){J(a,c)},url:[Q,"v1","auth","grant","sub-key",E]})},mobile_gw_provision:function(a){var b=a.callback||function(){},c=a.auth_key||L,f=a.error||function(){},d=P(),g=a.channel,e=a.op,h=a.gw_type;a=a.device_id;if(!a)return z("Missing Device ID (device_id)");if(!h)return z("Missing GW Type (gw_type: gcm or apns)");if(!e)return z("Missing GW Operation (op: add or remove)");if(!g)return z("Missing gw destination Channel (channel)");if(!ba)return z("Missing Publish Key");if(!E)return z("Missing Subscribe Key");
a=[Q,"v1/push/sub-key",E,"devices",a];c={uuid:N,auth:c,type:h};"add"==e?c.add=g:"remove"==e&&(c.remove=g);ca&&(data.instanceid=W);O({g:d,data:c,i:function(a){F(a,b,f)},h:function(a){J(a,f)},url:a})},audit:function(a,b){b=a.callback||b;var c=a.error||function(){},f=a.channel,d=a.channel_group,g=a.auth_key,e=P();if(!b)return z("Missing Callback");if(!E)return z("Missing Subscribe Key");if(!ba)return z("Missing Publish Key");if(!da)return z("Missing Secret Key");var h=E+"\n"+ba+"\naudit\n",l={timestamp:Math.floor((new Date).getTime()/
1E3)};"0"!=e&&(l.callback=e);"undefined"!=typeof f&&null!=f&&0<f.length&&(l.channel=f);"undefined"!=typeof d&&null!=d&&0<d.length&&(l["channel-group"]=d);g&&(l.auth=g);l=p(l);g||delete l.auth;h+=u(l);f=ua(h,da);f=f.replace(/\+/g,"-");f=f.replace(/\//g,"_");l.signature=f;O({g:e,data:l,i:function(a){F(a,b,c)},h:function(a){J(a,c)},url:[Q,"v1","auth","audit","sub-key",E]})},revoke:function(a,b){a.read=!1;a.write=!1;I.grant(a,b)},set_uuid:function(a){N=a;q()},get_uuid:function(){return N},isArray:function(a){return x(a)},
get_subscribed_channels:function(){return d(M,!0)},presence_heartbeat:function(b){var f=b.callback||function(){},g=b.error||function(){};b=P();var e={uuid:N,auth:L};2<JSON.stringify(aa).length&&(e.state=JSON.stringify(aa));0<V&&320>V&&(e.heartbeat=V);"0"!=b&&(e.callback=b);var h=c(d(M,!0).join(",")),l=a(U,!0).join(",");h||(h=",");l&&(e["channel-group"]=l);ca&&(e.instanceid=W);O({g:b,data:p(e),url:[Q,"v2","presence","sub-key",E,"channel",h,"heartbeat"],i:function(a){F(a,f,g)},h:function(a){J(a,g)}})},
stop_timers:function(){clearTimeout(qa);clearTimeout(ra);clearTimeout(ya)},shutdown:function(){I.stop_timers();Qa&&Qa()},xdr:O,ready:b,db:na,uuid:l,map:w,each:g,"each-channel":ga,grep:t,offline:function(){ka(1,{message:"Offline. Please check your network settings."})},supplant:B,now:e,unique:m,updater:r};N||(N=I.uuid());W||(W=I.uuid());na.set(E+"uuid",N);qa=setTimeout(X,1E3);ra=setTimeout(pa,ha);ya=setTimeout(H,1E3*(Z-3));ea();return I}function Y(){function a(b){b=b||{};b.hasOwnProperty("encryptKey")||
(b.encryptKey=h.encryptKey);b.hasOwnProperty("keyEncoding")||(b.keyEncoding=h.keyEncoding);b.hasOwnProperty("keyLength")||(b.keyLength=h.keyLength);b.hasOwnProperty("mode")||(b.mode=h.mode);-1==d.indexOf(b.keyEncoding.toLowerCase())&&(b.keyEncoding=h.keyEncoding);-1==g.indexOf(parseInt(b.keyLength,10))&&(b.keyLength=h.keyLength);-1==e.indexOf(b.mode.toLowerCase())&&(b.mode=h.mode);return b}function b(a,c){var f=a;a="base64"==c.keyEncoding?D.enc.Base64.parse(f):"hex"==c.keyEncoding?D.enc.Hex.parse(f):
f;return c.encryptKey?D.enc.Utf8.parse(D.SHA256(a).toString(D.enc.Hex).slice(0,32)):a}function c(a){return"ecb"==a.mode?D.mode.ECB:D.mode.CBC}function f(a){return"cbc"==a.mode?D.enc.Utf8.parse("0123456789012345"):null}var d=["hex","utf8","base64","binary"],g=[128,256],e=["ecb","cbc"],h={encryptKey:!0,keyEncoding:"utf8",keyLength:256,mode:"cbc"};return{encrypt:function(d,g,e){if(!g)return d;e=a(e);var h=f(e),l=c(e);g=b(g,e);e=JSON.stringify(d);return D.AES.encrypt(e,g,{iv:h,mode:l}).ciphertext.toString(D.enc.Base64)||
d},decrypt:function(d,e,g){if(!e)return d;g=a(g);var h=f(g),l=c(g);e=b(e,g);try{var p=D.enc.Base64.parse(d),q=D.AES.decrypt({ciphertext:p},e,{iv:h,mode:l}).toString(D.enc.Utf8);return JSON.parse(q)}catch(m){}}}}function ga(a,b){return D.HmacSHA256(a,b).toString(D.enc.Base64)}function H(a){return document.getElementById(a)}function pa(a){console.error(a)}function T(a,b){var c=[];g(a.split(/\s+/),function(a){g((b||document).getElementsByTagName(a),function(a){c.push(a)})});return c}function R(a,b,c){g(a.split(","),
function(a){function f(a){a||(a=window.event);c(a)||(a.cancelBubble=!0,a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation())}b.addEventListener?b.addEventListener(a,f,!1):b.attachEvent?b.attachEvent("on"+a,f):b["on"+a]=f})}function S(){return T("head")[0]}function K(a,b,c){if(c)a.setAttribute(b,c);else return a&&a.getAttribute&&a.getAttribute(b)}function F(a,b){for(var c in b)if(b.hasOwnProperty(c))try{a.style[c]=b[c]+(0<"|width|height|top|left|".indexOf(c)&&"number"==typeof b[c]?
"px":"")}catch(f){}}function J(a){return document.createElement(a)}function ea(){return ja||X()?0:m()}function f(a){function b(a,f){g||(g=1,c.onerror=null,clearTimeout(e),a||!f||q(f),y(function(){a&&l();var b=H(d),c=b&&b.parentNode;c&&c.removeChild(b)},1E3))}if(ja||X())return u(a);var c=J("script"),f=a.g,d=m(),g=0,e=y(function(){b(1,{message:"timeout"})},a.timeout||15E3),l=a.h||function(){},p=a.data||{},q=a.i||function(){};window[f]=function(a){b(0,a)};a.V||(c.async="async");c.onerror=function(){b(1)};
c.src=h(a.url,p);K(c,"id",d);S().appendChild(c);return b}function u(a){function b(a,c){e||(e=1,clearTimeout(q),d&&(d.onerror=d.onload=null,d.abort&&d.abort(),d=null),a&&m(c))}function c(){if(!l){l=1;clearTimeout(q);try{g=JSON.parse(d.responseText)}catch(a){return b(1)}e=1;u(g)}}var d,g,e=0,l=0,p=a.timeout||15E3,q=y(function(){b(1,{message:"timeout"})},p),m=a.h||function(){},G=a.data||{},u=a.i||function(){},r=!a.V;try{d=X()||window.XDomainRequest&&new XDomainRequest||new XMLHttpRequest;d.onerror=d.onabort=
function(a){b(1,a||d&&d.responseText||{error:"Network Connection Error"})};d.onload=d.onloadend=c;d.onreadystatechange=function(){if(d&&4==d.readyState)switch(d.status){case 200:break;default:var a=d.responseText,c=d.status;try{g=JSON.parse(a),b(1,g)}catch(f){return b(1,{status:c,ib:null,message:a})}}};var w=h(a.url,G);d.open("GET",w,r);r&&(d.timeout=p);d.send()}catch(A){return b(0),ja=0,f(a)}return b}function q(){if(!("onLine"in navigator))return 1;try{return navigator.onLine}catch(a){return!0}}
function p(a){return"sendBeacon"in navigator?navigator.sendBeacon(a):!1}function X(){if(!ua||!ua.get)return 0;var a={id:X.id++,send:function(){},abort:function(){a.id={}},open:function(b,c){X[a.id]=a;ua.get(a.id,c)}};return a}var ka=1,wa=!1,Ma=[],Fa=/{([\w\-]+)}/g,ta=function(){var a=Math.floor(20*Math.random());return function(b,c){return 0<b.indexOf("pubsub.")&&b.replace("pubsub","ps"+(c?l().split("-")[0]:20>++a?a:a=1))||b}}(),Ba=navigator.userAgent,ja=-1==Ba.indexOf("MSIE 6");window.console||(window.console=
window.console||{});console.log||(console.log=console.error=(window.opera||{}).postError||function(){});var va=function(){function a(b,c){document.cookie=b+"="+c+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}function b(a){return-1==document.cookie.indexOf(a)?null:((document.cookie||"").match(RegExp(a+"=([^;]+)"))||[])[1]||null}var c={},f=!1;try{f=window.localStorage}catch(d){}var g;try{a("pnctest","1"),g="1"===b("pnctest")}catch(d){g=!1}return{get:function(a){try{return f?f.getItem(a):g?b(a):c[a]}catch(d){return c[a]}},
set:function(b,d){try{if(f)return f.setItem(b,d)&&0;g&&a(b,d);c[b]=d}catch(e){c[b]=d}}}}(),ha={list:{},unbind:function(a){ha.list[a]=[]},bind:function(a,b){(ha.list[a]=ha.list[a]||[]).push(b)},fire:function(a,b){g(ha.list[a]||[],function(a){a(b)})}},ia=H("pubnub")||0;v.init=v;v.secure=v;v.crypto_obj=Y();"complete"===document.readyState?setTimeout(b,0):R("load",window,function(){setTimeout(b,0)});var da=ia||{};PUBNUB=v({notest:1,publish_key:K(da,"pub-key"),subscribe_key:K(da,"sub-key"),ssl:!document.location.href.indexOf("https")||
"on"==K(da,"ssl"),origin:K(da,"origin"),uuid:K(da,"uuid")});window.jQuery&&(window.jQuery.PUBNUB=v);"undefined"!==typeof module&&(module.exports=PUBNUB)&&b();var ua=H("pubnubs")||0;if(ia){F(ia,{position:"absolute",top:-1E3});if("opera"in window||K(ia,"flash"))ia.innerHTML="<object id=pubnubs data=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=movie value=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=allowscriptaccess value=always></object>";PUBNUB.rdx=function(a,b){if(!b)return X[a].onerror();
X[a].responseText=unescape(b);X[a].onload()};X.id=1E3}}();
...
a){return(new c.b(a)).l(d)}},ka:function(c){return function(d,a){return(new A.Ha.b(c,a)).l(d)}}});var A=h.F={};return h}(Math);
(function(v){function m(c){return 4294967296*(c-(c|0))|0}for(var e=D.u,h=e.H,r=e.ia,e=D.F,t=[],B=[],y=2,l=0;64>l;){var x;a:{x=y;for(var g=v.sqrt(x),w=2;w<=g;w++)if(!(x%w)){x=!1;break a}x=!0}x&&(8>l&&(t[l]=m(v.pow(y,.5))),B[l]=m(v.pow(y,1/3)),l++);y++}var A=[],e=e.Ja=r.extend({M:function(){this.o=new h.b(t.slice(0))},T:function(c,d){for(var a=this.o.c,b=a[0],g=a[1],e=a[2],h=a[3],l=a[4],m=a[5],r=a[6],w=a[7],t=0;64>t;t++){if(16>t)A[t]=c[d+t]|0;else{var v=A[t-15],F=A[t-2];A[t]=((v<<25|v>>>7)^(v<<14|v>>>
18)^v>>>3)+A[t-7]+((F<<15|F>>>17)^(F<<13|F>>>19)^F>>>10)+A[t-16]}v=w+((l<<26|l>>>6)^(l<<21|l>>>11)^(l<<7|l>>>25))+(l&m^~l&r)+B[t]+A[t];F=((b<<30|b>>>2)^(b<<19|b>>>13)^(b<<10|b>>>22))+(b&g^b&e^g&e);w=r;r=m;m=l;l=h+v|0;h=e;e=g;g=b;b=v+F|0}a[0]=a[0]+b|0;a[1]=a[1]+g|0;a[2]=a[2]+e|0;a[3]=a[3]+h|0;a[4]=a[4]+l|0;a[5]=a[5]+m|0;a[6]=a[6]+r|0;a[7]=a[7]+w|0},I:function(){var c=this.A,d=c.c,a=8*this.N,b=8*c.a;d[b>>>5]|=128<<24-b%32;d[(b+64>>>9<<4)+14]=v.floor(a/4294967296);d[(b+64>>>9<<4)+15]=a;c.a=4*d.length;
...
w+t,d=g[c];g[c]=(d<<8|d>>>24)&16711935|(d<<24|d>>>8)&4278255360}var t=this.o.c,c=g[w+0],d=g[w+1],a=g[w+2],b=g[w+3],G=g[w+4],v=g[w+5],x=g[w+6],y=g[w+7],B=g[w+8],T=g[w+9],R=g[w+10],S=g[w+11],K=g[w+12],F=g[w+13],J=g[w+14],ea=g[w+15],f=t[0],u=t[1],q=t[2],p=t[3],f=m(f,u,q,p,c,7,l[0]),p=m(p,f,u,q,d,12,l[1]),q=m(q,p,f,u,a,17,l[2]),u=m(u,q,p,f,b,22,l[3]),f=m(f,u,q,p,G,7,l[4]),p=m(p,f,u,q,v,12,l[5]),q=m(q,p,f,u,x,17,l[6]),u=m(u,q,p,f,y,22,l[7]),f=m(f,u,q,p,B,7,l[8]),p=m(p,f,u,q,T,12,l[9]),q=m(q,p,f,u,R,17,
l[10]),u=m(u,q,p,f,S,22,l[11]),f=m(f,u,q,p,K,7,l[12]),p=m(p,f,u,q,F,12,l[13]),q=m(q,p,f,u,J,17,l[14]),u=m(u,q,p,f,ea,22,l[15]),f=e(f,u,q,p,d,5,l[16]),p=e(p,f,u,q,x,9,l[17]),q=e(q,p,f,u,S,14,l[18]),u=e(u,q,p,f,c,20,l[19]),f=e(f,u,q,p,v,5,l[20]),p=e(p,f,u,q,R,9,l[21]),q=e(q,p,f,u,ea,14,l[22]),u=e(u,q,p,f,G,20,l[23]),f=e(f,u,q,p,T,5,l[24]),p=e(p,f,u,q,J,9,l[25]),q=e(q,p,f,u,b,14,l[26]),u=e(u,q,p,f,B,20,l[27]),f=e(f,u,q,p,F,5,l[28]),p=e(p,f,u,q,a,9,l[29]),q=e(q,p,f,u,y,14,l[30]),u=e(u,q,p,f,K,20,l[31]),
f=h(f,u,q,p,v,4,l[32]),p=h(p,f,u,q,B,11,l[33]),q=h(q,p,f,u,S,16,l[34]),u=h(u,q,p,f,J,23,l[35]),f=h(f,u,q,p,d,4,l[36]),p=h(p,f,u,q,G,11,l[37]),q=h(q,p,f,u,y,16,l[38]),u=h(u,q,p,f,R,23,l[39]),f=h(f,u,q,p,F,4,l[40]),p=h(p,f,u,q,c,11,l[41]),q=h(q,p,f,u,b,16,l[42]),u=h(u,q,p,f,x,23,l[43]),f=h(f,u,q,p,T,4,l[44]),p=h(p,f,u,q,K,11,l[45]),q=h(q,p,f,u,ea,16,l[46]),u=h(u,q,p,f,a,23,l[47]),f=r(f,u,q,p,c,6,l[48]),p=r(p,f,u,q,y,10,l[49]),q=r(q,p,f,u,J,15,l[50]),u=r(u,q,p,f,v,21,l[51]),f=r(f,u,q,p,K,6,l[52]),p=
r(p,f,u,q,b,10,l[53]),q=r(q,p,f,u,R,15,l[54]),u=r(u,q,p,f,d,21,l[55]),f=r(f,u,q,p,B,6,l[56]),p=r(p,f,u,q,ea,10,l[57]),q=r(q,p,f,u,x,15,l[58]),u=r(u,q,p,f,F,21,l[59]),f=r(f,u,q,p,G,6,l[60]),p=r(p,f,u,q,S,10,l[61]),q=r(q,p,f,u,a,15,l[62]),u=r(u,q,p,f,T,21,l[63]);t[0]=t[0]+f|0;t[1]=t[1]+u|0;t[2]=t[2]+q|0;t[3]=t[3]+p|0},I:function(){var g=this.A,e=g.c,h=8*this.N,c=8*g.a;e[c>>>5]|=128<<24-c%32;var d=v.floor(h/4294967296);e[(c+64>>>9<<4)+15]=(d<<8|d>>>24)&16711935|(d<<24|d>>>8)&4278255360;e[(c+64>>>9<<
...
b){this.Qa.O(a,b)},I:function(){var a=this.f.padding;if(this.ra==this.S){a.ya(this.A,this.s);var b=this.B(!0)}else b=this.B(!0),a.Wa(b);return b},s:4});var A=h.Ya=r.extend({b:function(a){this.ca(a)},toString:function(a){return(a||this.Ta).stringify(this)}}),g=(e.format={}).Ia={stringify:function(a){var b=a.W;a=a.ea;return(a?t.create([1398893684,1701076831]).concat(a).concat(b):b).toString(y)},parse:function(a){a=y.parse(a);var b=a.c;if(1398893684==b[0]&&1701076831==b[1]){var c=t.create(b.slice(2,
4));b.splice(0,4);a.a-=16}return A.create({W:a,ea:c})}},c=h.gb=r.extend({f:r.extend({format:g}),encrypt:function(a,b,c,d){d=this.f.extend(d);var e=a.Z(c,d);b=e.l(b);e=e.f;return A.create({W:b,key:c,D:e.D,algorithm:a,mode:e.mode,padding:e.padding,s:a.s,Ta:d.format})},decrypt:function(a,b,c,d){d=this.f.extend(d);b=this.pa(b,d.format);return a.Y(c,d).l(b.W)},pa:function(a,b){return"string"==typeof a?b.parse(a,this):a}}),e=(e.ba={}).Ia={wa:function(a,b,c,d){d||(d=t.random(8));a=l.create({G:b+c}).ta(a,
d);c=t.create(a.c.slice(b),4*c);a.a=4*b;return A.create({key:a,D:c,ea:d})}},d=h.eb=c.extend({f:c.f.extend({ba:e}),encrypt:function(a,b,d,e){e=this.f.extend(e);d=e.ba.wa(d,a.G,a.xa);e.D=d.D;a=c.encrypt.call(this,a,b,d.key,e);a.ca(d);return a},decrypt:function(a,b,d,e){e=this.f.extend(e);b=this.pa(b,e.format);d=e.ba.wa(d,a.G,a.xa,b.ea);e.D=d.D;return c.decrypt.call(this,a,b,d.key,e)}})}();
(function(){for(var v=D.u.Da,m=D.F,e=[],h=[],r=[],t=[],B=[],y=[],l=[],x=[],g=[],w=[],A=[],c=0;256>c;c++)A[c]=128>c?c<<1:c<<1^283;for(var d=0,a=0,c=0;256>c;c++){var b=a^a<<1^a<<2^a<<3^a<<4,b=b>>>8^b&255^99;e[d]=b;h[b]=d;var G=A[d],Y=A[G],ga=A[Y],H=257*A[b]^16843008*b;r[d]=H<<24|H>>>8;t[d]=H<<16|H>>>16;B[d]=H<<8|H>>>24;y[d]=H;H=16843009*ga^65537*Y^257*G^16843008*d;l[b]=H<<24|H>>>8;x[b]=H<<16|H>>>16;g[b]=H<<8|H>>>24;w[b]=H;d?(d=G^A[A[A[ga^G]]],a^=A[A[a]]):d=a=1}var pa=[0,1,2,4,8,16,32,64,128,27,54],
