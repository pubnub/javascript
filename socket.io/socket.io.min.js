...
Nb=a["compatible_3.5"]||z,H=a.xdr,P=a.params||{},t=a.error||A(),cc=a._is_online||function(){return 1},I=a.jsonp_cb||function(){return 0},ia=a.db||{get:A(),set:A()},V=a.cipher_key,J=a.uuid||!a.unique_uuid&&ia&&ia.get(w+"uuid")||"",$,R,Qa=a.crypto_obj||{encrypt:function(a){return a},decrypt:function(a){return a}},B={LEAVE:function(a,b,c,d){var e={uuid:J,auth:K},f=pa(oa),c=c||A(),h=d||A(),d=I();if(0<a.indexOf(ga))return v;if(Nb&&(!ba||"0"==d)||Jb)return z;"0"!=d&&(e.callback=d);H({h:b||ba,timeout:2E3,
a:d,data:D(e),c:function(a){s(a,c,h)},b:function(a){j(a,h)},url:[f,"v2","presence","sub_key",w,"channel",encodeURIComponent(a),"leave"]});return v},LEAVE_GROUP:function(a,b,c,d){var e={uuid:J,auth:K},f=pa(oa),c=c||A(),h=d||A(),d=I();if(0<a.indexOf(ga))return v;if(Nb&&(!ba||"0"==d)||Jb)return z;"0"!=d&&(e.callback=d);a&&0<a.length&&(e["channel-group"]=a);console.log("LEAVE_GROUP");H({h:b||ba,timeout:5E3,a:d,data:D(e),c:function(a){console.log("success "+JSON.stringify(a));s(a,c,h)},b:function(a){console.log("FAIL LEAVE GROUP "+
JSON.stringify(a));j(a,h)},url:[f,"v2","presence","sub_key",w,"channel",encodeURIComponent(","),"leave"]});return v},set_resumed:function(a){hb=a},get_cipher_key:function(){return V},set_cipher_key:function(a){V=a},raw_encrypt:function(a,b){return Qa.encrypt(a,b||V)||a},raw_decrypt:function(a,b){return m(a,b)},get_heartbeat:function(){return W},set_heartbeat:function(a){W=g(a,O,t);O=1<=W-3?W-3:1;d();h()},get_heartbeat_interval:function(){return O},set_heartbeat_interval:function(a){O=a;h()},get_version:function(){return"3.7.6"},
