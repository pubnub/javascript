...
window.PUBNUB||function(){function v(a){function b(a){return v(a)}a.jsonp?ja=0:ja=-1==Ba.indexOf("MSIE 6");var c=a.subscribe_key||"";a.uuid||va.get(c+"uuid");var d=a.leave_on_unload||0;a.xdr=f;a.db=va;a.error=a.error||pa;a._is_online=q;a.jsonp_cb=da;a.hmac_SHA256=ga;a.crypto_obj=Y();a.sendBeacon=p;a.params={pnsdk:"PubNub-JS-Web/3.7.21"};var c=G(a),g;for(g in c)c.hasOwnProperty(g)&&(b[g]=c[g]);b.css=F;b.$=H;b.create=J;b.bind=R;b.head=S;b.search=T;b.attr=K;b.events=ha;b.init=b;b.secure=b;b.crypto_obj=
...
e)},url:a});return!0},set_resumed:function(a){La=a},get_cipher_key:function(){return xa},set_cipher_key:function(a){xa=a},raw_encrypt:function(a,b){return S(a,b)},raw_decrypt:function(a,b){return v(a,b)},get_heartbeat:function(){return V},set_heartbeat:function(a,b){V=Y(a,V,A);Z=b||V/2-1;2==V&&(Z=1);q();ea()},get_heartbeat_interval:function(){return Z},set_heartbeat_interval:function(a){Z=a;ea()},get_version:function(){return"3.7.21"},getGcmMessageObject:function(a){return{data:a}},getApnsMessageObject:function(a){var b=
...
a.message;if(!c)return A("Missing Message");b=b||a.callback||c.callback||a.success||function(){};var f=a.channel||c.channel,d=a.auth_key||L,g=a.cipher_key,e=a.error||c.error||function(){},h=a.post||!1,q="store_in_history"in a?a.store_in_history:!0,l=P(),m="push";a.prepend&&(m="unshift");if(!f)return A("Missing Channel");if(!fa)return A("Missing Publish Key");if(!E)return A("Missing Subscribe Key");c.getPubnubMessage&&(c=c.getPubnubMessage());c=JSON.stringify(S(c,g));c=[Q,"publish",fa,E,0,encodeURIComponent(f),
l,encodeURIComponent(c)];d={uuid:N,auth:d};q||(d.store="0");ba&&(d.instanceid=W);la[m]({g:l,url:c,data:p(d),h:function(a){J(a,e);T(1)},i:function(a){F(a,b,e);T(1)},mode:h?"POST":"GET"});T()},unsubscribe:function(a,b){var c=a.channel,f=a.channel_group,d=a.auth_key||L;b=b||a.callback||function(){};var e=a.error||function(){};ma=0;Aa=1;if(!c&&!f)return A("Missing Channel or Channel Group");if(!E)return A("Missing Subscribe Key");if(c){var h=[],p=[];g(x(c)?c:(""+c).split(","),function(a){M[a]&&h.push(a)});
if(0==h.length){b({action:"leave"});return}g(h,function(a){p.push(a+"-pnpres")});g(h.concat(p),function(a){a in M&&(M[a]=0);a in aa&&delete aa[a]});c=!0;wa&&(c=I.LEAVE(h.join(","),0,d,b,e));c||b({action:"leave"})}if(f){var l=[],m=[];g(x(f)?f:(""+f).split(","),function(a){U[a]&&l.push(a)});if(0==l.length){b({action:"leave"});return}g(l,function(a){m.push(a+"-pnpres")});g(l.concat(m),function(a){a in U&&(U[a]=0);a in aa&&delete aa[a]});c=!0;wa&&(c=I.LEAVE_GROUP(l.join(","),0,d,b,e));c||b({action:"leave"})}q()},
subscribe:function(b,c){function f(a){a?setTimeout(q,ea):(Q=ta(sa,1),va=ta(sa,1),y(function(){I.time(f)},1E3));ga(function(b){if(a&&b.j)return b.j=0,b.da(b.name);a||b.j||(b.j=1,b.disconnect(b.name))});R(function(b){if(a&&b.j)return b.j=0,b.da(b.name);a||b.j||(b.j=1,b.disconnect(b.name))})}function h(){var b=P(),c=d(M).join(","),l=a(U).join(",");if(c||l){c||(c=",");ka();var m=p({uuid:N,auth:L});l&&(m["channel-group"]=l);2<JSON.stringify(aa).length&&(m.state=JSON.stringify(aa));V&&(m.heartbeat=V);ba&&
(m.instanceid=W);H();Ca=O({timeout:T,g:b,h:function(a){a&&a.error&&a.service?(J(a,z),f(1)):I.time(function(b){!b&&J(a,z);f(b)})},data:p(m),url:[va,"subscribe",E,encodeURIComponent(c),b,ma],i:function(a){if(!a||"object"==typeof a&&"error"in a&&a.error)return z(a.error),setTimeout(q,1E3);Y(a[1]);ma=!ma&&Aa&&na.get(E)||a[1];ga(function(a){a.C||(a.C=1,a.connect(a.name))});R(function(a){a.C||(a.C=1,a.connect(a.name))});if(La&&!Aa)ma=0,La=!1,na.set(E,0);else{S&&(ma=1E4,S=0);na.set(E,a[1]);var b=function(){var b=
"",c="";3<a.length?(b=a[3],c=a[2]):b=2<a.length?a[2]:w(d(M),function(b){return w(Array(a[0].length).join(",").split(","),function(){return b})}).join(",");var f=b.split(","),g=c?c.split(","):[];return function(){var a=f.shift()||Oa,b=g.shift(),c={};b?(a&&0<=a.indexOf("-pnpres")&&0>b.indexOf("-pnpres")&&(b+="-pnpres"),c=U[b]||M[b]||{callback:function(){}}):c=M[a];a=[c.g||Ka,a.split("-pnpres")[0]];b&&a.push(b.split("-pnpres")[0]);return a}}(),c=e()-Ia-+a[1]/1E4;g(a[0],function(f){var d=b();f=v(f,M[d[1]]?
M[d[1]].cipher_key:null);d[0]&&d[0](f,a,d[2]||d[1],c,d[1])})}setTimeout(h,ea)}})}}var l=b.channel,m=b.channel_group;c=(c=c||b.callback)||b.message;var G=b.connect||function(){},u=b.reconnect||function(){},r=b.disconnect||function(){},z=b.error||z||function(){},Y=b.idle||function(){},oa=b.presence||0,t=b.noheresync||0,S=b.backfill||0,F=b.timetoken||0,T=b.timeout||ja,ea=b.windowing||Ba,x=b.state,B=b.heartbeat||b.pnexpires,Ea=b.heartbeat_interval,K=b.restore||Aa;L=b.auth_key||L;Aa=K;ma=F;if(!l&&!m)return A("Missing Channel");
if(!c)return A("Missing Callback");if(!E)return A("Missing Subscribe Key");(B||0===B||Ea||0===Ea)&&I.set_heartbeat(B,Ea);l&&g((l.join?l.join(","):""+l).split(","),function(a){var f=M[a]||{};M[Oa=a]={name:a,C:f.C,j:f.j,v:1,g:Ka=c,cipher_key:b.cipher_key,connect:G,disconnect:r,da:u};x&&(aa[a]=a in x?x[a]:x);oa&&(I.subscribe({channel:a+"-pnpres",callback:oa,restore:K}),f.v||t||I.here_now({channel:a,data:p({uuid:N,auth:L}),callback:function(b){g("uuids"in b?b.uuids:[],function(c){oa({action:"join",uuid:c,
timestamp:Math.floor(e()/1E3),occupancy:b.occupancy||1},b,a)})}}))});m&&g((m.join?m.join(","):""+m).split(","),function(a){var f=U[a]||{};U[a]={name:a,C:f.C,j:f.j,v:1,g:Ka=c,cipher_key:b.cipher_key,connect:G,disconnect:r,da:u};oa&&(I.subscribe({channel_group:a+"-pnpres",callback:oa,restore:K,auth_key:L}),f.v||t||I.here_now({channel_group:a,data:p({uuid:N,auth:L}),callback:function(b){g("uuids"in b?b.uuids:[],function(c){oa({action:"join",uuid:c,timestamp:Math.floor(e()/1E3),occupancy:b.occupancy||
1},b,a)})}}))});q=function(){ka();setTimeout(h,ea)};if(!wa)return Ma.push(q);q()},here_now:function(a,b){b=a.callback||b;var c=a.debug,f=a.error||function(){},d=a.auth_key||L,g=a.channel,h=a.channel_group,e=P(),l=a.state,d={uuid:N,auth:d};("uuids"in a?a.uuids:1)||(d.disable_uuids=1);l&&(d.state=1);if(!b)return A("Missing Callback");if(!E)return A("Missing Subscribe Key");l=[Q,"v2","presence","sub_key",E];g&&l.push("channel")&&l.push(encodeURIComponent(g));"0"!=e&&(d.callback=e);h&&(d["channel-group"]=
h,!g&&l.push("channel")&&l.push(","));ba&&(d.instanceid=W);O({g:e,data:p(d),i:function(a){F(a,b,f)},h:function(a){J(a,f)},debug:c,url:l})},where_now:function(a,b){b=a.callback||b;var c=a.error||function(){},f=a.auth_key||L,d=P(),g=a.uuid||N,f={auth:f};if(!b)return A("Missing Callback");if(!E)return A("Missing Subscribe Key");"0"!=d&&(f.callback=d);ba&&(f.instanceid=W);O({g:d,data:p(f),i:function(a){F(a,b,c)},h:function(a){J(a,c)},url:[Q,"v2","presence","sub_key",E,"uuid",encodeURIComponent(g)]})},
state:function(a,b){b=a.callback||b||function(){};var c=a.error||function(){},f=a.auth_key||L,d=P(),g=a.state,e=a.uuid||N,h=a.channel,l=a.channel_group,f=p({auth:f});if(!E)return A("Missing Subscribe Key");if(!e)return A("Missing UUID");if(!h&&!l)return A("Missing Channel");"0"!=d&&(f.callback=d);"undefined"!=typeof h&&M[h]&&M[h].v&&g&&(aa[h]=g);"undefined"!=typeof l&&U[l]&&U[l].v&&(g&&(aa[l]=g),f["channel-group"]=l,h||(h=","));f.state=JSON.stringify(g);ba&&(f.instanceid=W);g=g?[Q,"v2","presence",
"sub-key",E,"channel",h,"uuid",e,"data"]:[Q,"v2","presence","sub-key",E,"channel",h,"uuid",encodeURIComponent(e)];O({g:d,data:p(f),i:function(a){F(a,b,c)},h:function(a){J(a,c)},url:g})},grant:function(a,b){b=a.callback||b;var c=a.error||function(){},f=a.channel||a.channels,d=a.channel_group,g=P(),h=a.ttl,e=a.read?"1":"0",l=a.write?"1":"0",m=a.manage?"1":"0",q=a.auth_key||a.auth_keys;if(!b)return A("Missing Callback");if(!E)return A("Missing Subscribe Key");if(!fa)return A("Missing Publish Key");if(!ca)return A("Missing Secret Key");
var G=E+"\n"+fa+"\ngrant\n",e={w:l,r:e,timestamp:Math.floor((new Date).getTime()/1E3)};a.manage&&(e.m=m);x(f)&&(f=f.join(","));x(q)&&(q=q.join(","));"undefined"!=typeof f&&null!=f&&0<f.length&&(e.channel=f);"undefined"!=typeof d&&null!=d&&0<d.length&&(e["channel-group"]=d);"0"!=g&&(e.callback=g);if(h||0===h)e.ttl=h;q&&(e.auth=q);e=p(e);q||delete e.auth;G+=u(e);f=ua(G,ca);f=f.replace(/\+/g,"-");f=f.replace(/\//g,"_");e.signature=f;O({g:g,data:e,i:function(a){F(a,b,c)},h:function(a){J(a,c)},url:[Q,
...
function(a){b(1,a||d&&d.responseText||{error:"Network Connection Error"})};d.onload=d.onloadend=c;d.onreadystatechange=function(){if(d&&4==d.readyState)switch(d.status){case 200:break;default:var a=d.responseText,c=d.status;try{g=JSON.parse(a),b(1,g)}catch(f){return b(1,{status:c,ib:null,message:a})}}};var w=h(a.url,G);d.open("GET",w,r);r&&(d.timeout=p);d.send()}catch(z){return b(0),ja=0,f(a)}return b}function q(){if(!("onLine"in navigator))return 1;try{return navigator.onLine}catch(a){return!0}}
