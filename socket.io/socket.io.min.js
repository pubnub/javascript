...
Math.floor((new Date).getTime()/1E3),h=t+"\n"+L+"\naudit\n";e&&(h+="auth="+encodeURIComponent(e)+"&");d&&(h+="channel="+encodeURIComponent(d)+"&");var h=h+("pnsdk="+encodeURIComponent(rb)+"&timestamp="+g),h=sb(h,Fa),h=h.replace(/\+/g,"-"),h=h.replace(/\//g,"_"),g={signature:h,timestamp:g};d&&(g.channel=d);e&&(g.auth=e);D({a:f,data:g,c:function(a){j(a,b,c)},b:function(a){n(a,c)},url:[G,"v1","auth","audit","sub-key",t]})},revoke:function(a,b){a.read=y;a.write=y;F.grant(a,b)},set_uuid:function(a){E=
