...
window.PUBNUB||function(){function v(a){function b(a){return v(a)}a.jsonp?ja=0:ja=-1==Ba.indexOf("MSIE 6");var c=a.subscribe_key||"";a.uuid||va.get(c+"uuid");var d=a.leave_on_unload||0;a.xdr=f;a.db=va;a.error=a.error||pa;a._is_online=q;a.jsonp_cb=ea;a.hmac_SHA256=ga;a.crypto_obj=Y();a.sendBeacon=p;a.params={pnsdk:"PubNub-JS-Web/3.7.18"};var c=G(a),g;for(g in c)c.hasOwnProperty(g)&&(b[g]=c[g]);b.css=F;b.$=H;b.create=J;b.bind=R;b.head=S;b.search=T;b.attr=K;b.events=ha;b.init=b;b.secure=b;b.crypto_obj=
...
e)},url:a});return!0},set_resumed:function(a){La=a},get_cipher_key:function(){return xa},set_cipher_key:function(a){xa=a},raw_encrypt:function(a,b){return S(a,b)},raw_decrypt:function(a,b){return v(a,b)},get_heartbeat:function(){return V},set_heartbeat:function(a,b){V=Y(a,V,z);Z=b||V/2-1;2==V&&(Z=1);q();fa()},get_heartbeat_interval:function(){return Z},set_heartbeat_interval:function(a){Z=a;fa()},get_version:function(){return"3.7.18"},getGcmMessageObject:function(a){return{data:a}},getApnsMessageObject:function(a){var b=
