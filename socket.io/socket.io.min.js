...
default:try{d=JSON.parse(b.responseText),q(1,d)}catch(a){return q(1,{status:b.status,fb:v,message:b.responseText})}}};var E=la(a.url,x);b.open("GET",E,A);A&&(b.timeout=j);b.send()}catch(H){q(0);Ra=0;a=Va(a);break a}a=q}return a}var u=Oa("script"),e=a.e,B=ea(),y=0,h=setTimeout(function(){c(1,{message:"timeout"})},a.timeout||Ua),i=a.f||D(),j=a.data||{},g=a.g||D();window[e]=function(a){c(0,a)};a.Q||(u[Wa]=Wa);u.onerror=function(){c(1)};u.src=la(a.url,j);Ma(u,"id",B);La().appendChild(u);return c},Xa=
function(){if(!("onLine"in navigator))return 1;try{return navigator.onLine}catch(a){return p}},Ya=function(a){return!("sendBeacon"in navigator)?w:navigator.sendBeacon(a)},Sa=function(){if(!Za||!Za.get)return 0;var a={id:Sa.id++,send:D(),abort:function(){a.id={}},open:function(c,b){Sa[a.id]=a;Za.get(a.id,b)}};return a},da=1,Ba=w,Ca=[],$a="-pnpres",Ua=1E4,I=1E3,ja="/",ka="&",ra=/{([\w\-]+)}/g,ab,bb=Math.floor(20*Math.random());ab=function(a,c){return 0<a.indexOf("pubsub.")&&a.replace("pubsub","ps"+
(c?ta().split("-")[0]:20>++bb?bb:bb=1))||a};var Wa="async",cb=navigator.userAgent,Ra=-1==cb.indexOf("MSIE 6");window.console||(window.console=window.console||{});console.log||(console.log=console.error=(window.opera||{}).postError||D());var db,eb={},fb=w;try{fb=window.localStorage}catch(gb){}var mb=function(a){return-1==document.cookie.indexOf(a)?v:((document.cookie||"").match(RegExp(a+"=([^;]+)"))||[])[1]||v},nb=function(a,c){document.cookie=a+"="+c+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"},
ob;try{nb("pnctest","1"),ob="1"===mb("pnctest")}catch(pb){ob=w}db={get:function(a){try{return fb?fb.getItem(a):ob?mb(a):eb[a]}catch(c){return eb[a]}},set:function(a,c){try{if(fb)return fb.setItem(a,c)&&0;ob&&nb(a,c);eb[a]=c}catch(b){eb[a]=c}}};var qb={list:{},unbind:function(a){qb.list[a]=[]},bind:function(a,c){(qb.list[a]=qb.list[a]||[]).push(c)},fire:function(a,c){F(qb.list[a]||[],function(a){a(c)})}},rb=Ha("pubnub")||0,sb=function(a){function c(){}function b(a,b){function c(b){b&&(yb=ia()-(b/1E4+
(ia()-d)/2),a&&a(yb))}var d=ia();b&&c(b)||G.time(c)}function d(a,b){hb&&hb(a,b);hb=v;clearTimeout(fa);clearTimeout(aa)}function e(){Kc&&G.time(function(a){b(D(),a);a||d(1,{error:"Heartbeat failed to connect to Pubnub Servers.Please check your network settings."});aa&&clearTimeout(aa);aa=setTimeout(e,Ub)})}function f(){Nc()||d(1,{error:"Offline. Please check your network settings. "});fa&&clearTimeout(fa);fa=setTimeout(f,I)}function m(a,b,c,d){var b=a.callback||b,e=a.error||t,f=T(),d=d||{};d.auth||
(d.auth=a.auth_key||J);a=[V,"v1","channel-registration","sub-key",z];a.push.apply(a,c);f&&(d.callback=f);O({e:f,data:B(d),g:function(a){r(a,b,e)},f:function(a){j(a,e)},url:a})}function j(a,b){if("object"==typeof a&&a.error){var c={};a.message&&(c.message=a.message);a.payload&&(c.payload=a.payload);b&&b(c)}else b&&b(a)}function r(a,b,c){if("object"==typeof a){if(a.error){b={};a.message&&(b.message=a.message);a.payload&&(b.payload=a.payload);c&&c(b);return}if(a.payload){a.next_page?b&&b(a.payload,a.next_page):
b&&b(a.payload);return}}b&&b(a)}function C(a){var b=0;F(za(L),function(c){if(c=L[c])b++,(a||D())(c)});return b}function x(a){var b=0;F(Aa(Y),function(c){if(c=Y[c])b++,(a||D())(c)})}function s(a){if(Oc){if(!ma.length)return}else{a&&(ma.ua=0);if(ma.ua||!ma.length)return;ma.ua=1}O(ma.shift())}function A(){!zb&&q()}function q(){clearTimeout(na);!W||500<=W||1>W||!za(L,p).length&&!Aa(Y,p).length?zb=w:(zb=p,G.presence_heartbeat({callback:function(){na=setTimeout(q,W*I)},error:function(a){t&&t("Presence Heartbeat unable to reach Pubnub servers."+
JSON.stringify(a));na=setTimeout(q,W*I)}}))}function E(a,b){return ib.decrypt(a,b||ga)||ib.decrypt(a,ga)||a}function H(a,b,c){var d=w;if("undefined"===typeof a)return b;if("number"===typeof a)d=5<a||0==a?w:p;else{if("boolean"===typeof a)return a?30:0;d=p}return d?(c&&c("Presence Heartbeat value invalid. Valid range ( x > 5 or x = 0). Current Value : "+(b||5)),b||5):a}function u(a){var b="",c=[];F(a,function(a){c.push(a)});var d=c.sort(),e;for(e in d){var f=d[e],b=b+(f+"="+wa(a[f]));e!=d.length-1&&
(b+="&")}return b}function B(a){a||(a={});F(bc,function(b,c){b in a||(a[b]=c)});return a}function y(a){return sb(a)}Ra=a.jsonp?0:-1==cb.indexOf("MSIE 6");var h=a.subscribe_key||"";a.uuid||db.get(h+"uuid");var i=a.leave_on_unload||0;a.xdr=Va;a.db=db;a.error=a.error||Ia;a._is_online=Xa;a.jsonp_cb=Ta;a.hmac_SHA256=Ga;a.crypto_obj=Fa();a.sendBeacon=Ya;a.params={pnsdk:"PubNub-JS-Web/3.7.16"};var g=+a.windowing||10,l=(+a.timeout||310)*I,Ub=(+a.keepalive||60)*I,Kc=a.timecheck||0,Vb=a.noleave||0,ba=a.publish_key,
z=a.subscribe_key,J=a.auth_key||"",jb=a.secret_key||"",cc=a.hmac_SHA256,oa=a.ssl?"s":"",Ea="http"+oa+"://"+(a.origin||"pubsub.pubnub.com"),V=ab(Ea),dc=ab(Ea),ma=[],Ab=p,yb=0,Bb=0,ec=0,hb=0,Qa=a.restore||0,xa=0,Cb=w,L={},Y={},ca={},na=v,Z=H(a.heartbeat||a.pnexpires||0,a.error),W=a.heartbeat_interval||Z/2-1,zb=w,Oc=a.no_wait_for_pending,fc=a["compatible_3.5"]||w,O=a.xdr,bc=a.params||{},t=a.error||D(),Nc=a._is_online||function(){return 1},T=a.jsonp_cb||function(){return 0},ya=a.db||{get:D(),set:D()},
ga=a.cipher_key,M=a.uuid||!a.unique_uuid&&ya&&ya.get(z+"uuid")||"",ha=a.instance_id||w,$="",gc=a.shutdown,kb=("undefined"!=typeof a.use_send_beacon?a.use_send_beacon:1)?a.sendBeacon:v,fa,aa;2===Z&&(W=1);var ib=a.crypto_obj||{encrypt:function(a){return a},decrypt:function(a){return a}},G={LEAVE:function(a,b,c,d,e){var c={uuid:M,auth:c||J},f=ab(Ea),d=d||D(),h=e||D(),e=T();if(0<a.indexOf($a))return p;if(fc&&(!oa||"0"==e)||Vb)return w;"0"!=e&&(c.callback=e);ha&&(c.instanceid=$);a=[f,"v2","presence","sub_key",
z,"channel",encodeURIComponent(a),"leave"];c=B(c);if(kb&&(url_string=la(a,c),kb(url_string)))return d&&d({status:200,action:"leave",message:"OK",service:"Presence"}),p;O({Q:b||oa,timeout:2E3,e:e,data:c,g:function(a){r(a,d,h)},f:function(a){j(a,h)},url:a});return p},LEAVE_GROUP:function(a,b,c,d,e){var c={uuid:M,auth:c||J},f=ab(Ea),d=d||D(),h=e||D(),e=T();if(0<a.indexOf($a))return p;if(fc&&(!oa||"0"==e)||Vb)return w;"0"!=e&&(c.callback=e);a&&0<a.length&&(c["channel-group"]=a);ha&&(c.instanceid=$);a=
[f,"v2","presence","sub_key",z,"channel",encodeURIComponent(","),"leave"];c=B(c);if(kb&&(url_string=la(a,c),kb(url_string)))return d&&d({status:200,action:"leave",message:"OK",service:"Presence"}),p;O({Q:b||oa,timeout:5E3,e:e,data:c,g:function(a){r(a,d,h)},f:function(a){j(a,h)},url:a});return p},set_resumed:function(a){Cb=a},get_cipher_key:function(){return ga},set_cipher_key:function(a){ga=a},raw_encrypt:function(a,b){return ib.encrypt(a,b||ga)||a},raw_decrypt:function(a,b){return E(a,b)},get_heartbeat:function(){return Z},
set_heartbeat:function(a,b){Z=H(a,Z,t);W=b||Z/2-1;2==Z&&(W=1);c();q()},get_heartbeat_interval:function(){return W},set_heartbeat_interval:function(a){W=a;q()},get_version:function(){return"3.7.16"},getGcmMessageObject:function(a){return{data:a}},getApnsMessageObject:function(a){var b={aps:{badge:1,alert:""}};for(k in a)k[b]=a[k];return b},newPnMessage:function(){var a={};gcm&&(a.pn_gcm=gcm);apns&&(a.pn_apns=apns);for(k in n)a[k]=n[k];return a},_add_param:function(a,b){bc[a]=b},channel_group:function(a,
...
1},a,c)})}}))});c=function(){d();setTimeout(f,fa)};if(!Ba)return Ca.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.debug,d=a.error||D(),e=a.auth_key||J,f=a.channel,h=a.channel_group,g=T(),i=a.state,e={uuid:M,auth:e};if(!("uuids"in a?a.uuids:1))e.disable_uuids=1;i&&(e.state=1);if(!b)return t("Missing Callback");if(!z)return t("Missing Subscribe Key");i=[V,"v2","presence","sub_key",z];f&&i.push("channel")&&i.push(encodeURIComponent(f));"0"!=g&&(e.callback=g);h&&(e["channel-group"]=h,!f&&
i.push("channel")&&i.push(","));ha&&(e.instanceid=$);O({e:g,data:B(e),g:function(a){r(a,b,d)},f:function(a){j(a,d)},debug:c,url:i})},where_now:function(a,b){var b=a.callback||b,c=a.error||D(),d=a.auth_key||J,e=T(),f=a.uuid||M,d={auth:d};if(!b)return t("Missing Callback");if(!z)return t("Missing Subscribe Key");"0"!=e&&(d.callback=e);ha&&(d.instanceid=$);O({e:e,data:B(d),g:function(a){r(a,b,c)},f:function(a){j(a,c)},url:[V,"v2","presence","sub_key",z,"uuid",encodeURIComponent(f)]})},state:function(a,
b){var b=a.callback||b||D(),c=a.error||D(),d=a.auth_key||J,e=T(),f=a.state,h=a.uuid||M,g=a.channel,i=a.channel_group,d=B({auth:d});if(!z)return t("Missing Subscribe Key");if(!h)return t("Missing UUID");if(!g&&!i)return t("Missing Channel");"0"!=e&&(d.callback=e);"undefined"!=typeof g&&L[g]&&L[g].o&&f&&(ca[g]=f);"undefined"!=typeof i&&(Y[i]&&Y[i].o)&&(f&&(ca[i]=f),d["channel-group"]=i,g||(g=","));d.state=JSON.stringify(f);ha&&(d.instanceid=$);f=f?[V,"v2","presence","sub-key",z,"channel",g,"uuid",h,
"data"]:[V,"v2","presence","sub-key",z,"channel",g,"uuid",encodeURIComponent(h)];O({e:e,data:B(d),g:function(a){r(a,b,c)},f:function(a){j(a,c)},url:f})},grant:function(a,b){var b=a.callback||b,c=a.error||D(),d=a.channel||a.channels,e=a.channel_group,f=T(),h=a.ttl,g=a.read?"1":"0",i=a.write?"1":"0",l=a.manage?"1":"0",m=a.auth_key||a.auth_keys;if(!b)return t("Missing Callback");if(!z)return t("Missing Subscribe Key");if(!ba)return t("Missing Publish Key");if(!jb)return t("Missing Secret Key");var q=
z+"\n"+ba+"\ngrant\n",g={w:i,r:g,timestamp:Math.floor((new Date).getTime()/1E3)};a.manage&&(g.m=l);ua(d)&&(d=d.join(","));ua(m)&&(m=m.join(","));"undefined"!=typeof d&&(d!=v&&0<d.length)&&(g.channel=d);"undefined"!=typeof e&&(e!=v&&0<e.length)&&(g["channel-group"]=e);"0"!=f&&(g.callback=f);if(h||0===h)g.ttl=h;m&&(g.auth=m);g=B(g);m||delete g.auth;q+=u(g);d=cc(q,jb);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");g.signature=d;O({e:f,data:g,g:function(a){r(a,b,c)},f:function(a){j(a,c)},url:[V,"v1","auth",
"grant","sub-key",z]})},mobile_gw_provision:function(a){var b=a.callback||D(),c=a.auth_key||J,d=a.error||D(),e=T(),f=a.channel,g=a.op,h=a.gw_type,a=a.device_id;if(!a)return t("Missing Device ID (device_id)");if(!h)return t("Missing GW Type (gw_type: gcm or apns)");if(!g)return t("Missing GW Operation (op: add or remove)");if(!f)return t("Missing gw destination Channel (channel)");if(!ba)return t("Missing Publish Key");if(!z)return t("Missing Subscribe Key");a=[V,"v1/push/sub-key",z,"devices",a];c=
{uuid:M,auth:c,type:h};"add"==g?c.add=f:"remove"==g&&(c.remove=f);ha&&(data.instanceid=$);O({e:e,data:c,g:function(a){r(a,b,d)},f:function(a){j(a,d)},url:a})},audit:function(a,b){var b=a.callback||b,c=a.error||D(),d=a.channel,e=a.channel_group,f=a.auth_key,g=T();if(!b)return t("Missing Callback");if(!z)return t("Missing Subscribe Key");if(!ba)return t("Missing Publish Key");if(!jb)return t("Missing Secret Key");var h=z+"\n"+ba+"\naudit\n",i={timestamp:Math.floor((new Date).getTime()/1E3)};"0"!=g&&
(i.callback=g);"undefined"!=typeof d&&(d!=v&&0<d.length)&&(i.channel=d);"undefined"!=typeof e&&(e!=v&&0<e.length)&&(i["channel-group"]=e);f&&(i.auth=f);i=B(i);f||delete i.auth;h+=u(i);d=cc(h,jb);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");i.signature=d;O({e:g,data:i,g:function(a){r(a,b,c)},f:function(a){j(a,c)},url:[V,"v1","auth","audit","sub-key",z]})},revoke:function(a,b){a.read=w;a.write=w;G.grant(a,b)},set_uuid:function(a){M=a;c()},get_uuid:function(){return M},isArray:function(a){return ua(a)},
get_subscibed_channels:function(){return za(L,p)},presence_heartbeat:function(a){var b=a.callback||D(),c=a.error||D(),a=T(),d={uuid:M,auth:J};2<JSON.stringify(ca).length&&(d.state=JSON.stringify(ca));0<Z&&320>Z&&(d.heartbeat=Z);"0"!=a&&(d.callback=a);var e;e=za(L,p).join(",");e=encodeURIComponent(e);var f=Aa(Y,p).join(",");e||(e=",");f&&(d["channel-group"]=f);ha&&(d.instanceid=$);O({e:a,data:B(d),timeout:5*I,url:[V,"v2","presence","sub-key",z,"channel",e,"heartbeat"],g:function(a){r(a,b,c)},f:function(a){j(a,
c)}})},stop_timers:function(){clearTimeout(fa);clearTimeout(aa);clearTimeout(na)},shutdown:function(){G.stop_timers();gc&&gc()},xdr:O,ready:Da,db:ya,uuid:ta,map:va,each:F,"each-channel":C,grep:qa,offline:function(){d(1,{message:"Offline. Please check your network settings."})},supplant:sa,now:ia,unique:ea,updater:pa};M||(M=G.uuid());$||($=G.uuid());ya.set(z+"uuid",M);fa=setTimeout(f,I);aa=setTimeout(e,Ub);na=setTimeout(A,(W-3)*I);b();var h=G,lb;for(lb in h)h.hasOwnProperty(lb)&&(y[lb]=h[lb]);y.css=
Na;y.$=Ha;y.create=Oa;y.bind=Ka;y.head=La;y.search=Ja;y.attr=Ma;y.events=qb;y.init=y;y.secure=y;y.crypto_obj=Fa();Ka("beforeunload",window,function(){if(i)y["each-channel"](function(a){y.LEAVE(a.name,0)});return p});if(a.notest)return y;Ka("offline",window,y.offline);Ka("offline",document,y.offline);return y};sb.init=sb;sb.secure=sb;sb.crypto_obj=Fa();"complete"===document.readyState?setTimeout(Da,0):Ka("load",window,function(){setTimeout(Da,0)});var tb=rb||{};PUBNUB=sb({notest:1,publish_key:Ma(tb,
...
PUBNUB.rdx=function(a,c){if(!c)return Sa[a].onerror();Sa[a].responseText=unescape(c);Sa[a].onload()};Sa.id=I}}
...
6-2*(f%4))<<24-8*(e%4),e++);return hc.create(d,e)},ka:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="};var ic=Math;function N(a,c,b,d,e,f,m){a=a+(c&b|~c&d)+e+m;return(a<<f|a>>>32-f)+c}function P(a,c,b,d,e,f,m){a=a+(c&d|b&~d)+e+m;return(a<<f|a>>>32-f)+c}function Q(a,c,b,d,e,f,m){a=a+(c^b^d)+e+m;return(a<<f|a>>>32-f)+c}function R(a,c,b,d,e,f,m){a=a+(b^(c|~d))+e+m;return(a<<f|a>>>32-f)+c}
for(var jc=K.n,kc=jc.z,lc=jc.fa,jc=K.u,S=[],mc=0;64>mc;mc++)S[mc]=4294967296*ic.abs(ic.sin(mc+1))|0;
jc=jc.ga=lc.extend({F:function(){this.k=new kc.b([1732584193,4023233417,2562383102,271733878])},O:function(a,c){for(var b=0;16>b;b++){var d=c+b,e=a[d];a[d]=(e<<8|e>>>24)&16711935|(e<<24|e>>>8)&4278255360}var b=this.k.c,d=a[c+0],e=a[c+1],f=a[c+2],m=a[c+3],j=a[c+4],r=a[c+5],C=a[c+6],x=a[c+7],s=a[c+8],A=a[c+9],q=a[c+10],E=a[c+11],H=a[c+12],u=a[c+13],B=a[c+14],y=a[c+15],h=b[0],i=b[1],g=b[2],l=b[3],h=N(h,i,g,l,d,7,S[0]),l=N(l,h,i,g,e,12,S[1]),g=N(g,l,h,i,f,17,S[2]),i=N(i,g,l,h,m,22,S[3]),h=N(h,i,g,l,j,
7,S[4]),l=N(l,h,i,g,r,12,S[5]),g=N(g,l,h,i,C,17,S[6]),i=N(i,g,l,h,x,22,S[7]),h=N(h,i,g,l,s,7,S[8]),l=N(l,h,i,g,A,12,S[9]),g=N(g,l,h,i,q,17,S[10]),i=N(i,g,l,h,E,22,S[11]),h=N(h,i,g,l,H,7,S[12]),l=N(l,h,i,g,u,12,S[13]),g=N(g,l,h,i,B,17,S[14]),i=N(i,g,l,h,y,22,S[15]),h=P(h,i,g,l,e,5,S[16]),l=P(l,h,i,g,C,9,S[17]),g=P(g,l,h,i,E,14,S[18]),i=P(i,g,l,h,d,20,S[19]),h=P(h,i,g,l,r,5,S[20]),l=P(l,h,i,g,q,9,S[21]),g=P(g,l,h,i,y,14,S[22]),i=P(i,g,l,h,j,20,S[23]),h=P(h,i,g,l,A,5,S[24]),l=P(l,h,i,g,B,9,S[25]),g=
P(g,l,h,i,m,14,S[26]),i=P(i,g,l,h,s,20,S[27]),h=P(h,i,g,l,u,5,S[28]),l=P(l,h,i,g,f,9,S[29]),g=P(g,l,h,i,x,14,S[30]),i=P(i,g,l,h,H,20,S[31]),h=Q(h,i,g,l,r,4,S[32]),l=Q(l,h,i,g,s,11,S[33]),g=Q(g,l,h,i,E,16,S[34]),i=Q(i,g,l,h,B,23,S[35]),h=Q(h,i,g,l,e,4,S[36]),l=Q(l,h,i,g,j,11,S[37]),g=Q(g,l,h,i,x,16,S[38]),i=Q(i,g,l,h,q,23,S[39]),h=Q(h,i,g,l,u,4,S[40]),l=Q(l,h,i,g,d,11,S[41]),g=Q(g,l,h,i,m,16,S[42]),i=Q(i,g,l,h,C,23,S[43]),h=Q(h,i,g,l,A,4,S[44]),l=Q(l,h,i,g,H,11,S[45]),g=Q(g,l,h,i,y,16,S[46]),i=Q(i,
g,l,h,f,23,S[47]),h=R(h,i,g,l,d,6,S[48]),l=R(l,h,i,g,x,10,S[49]),g=R(g,l,h,i,B,15,S[50]),i=R(i,g,l,h,r,21,S[51]),h=R(h,i,g,l,H,6,S[52]),l=R(l,h,i,g,m,10,S[53]),g=R(g,l,h,i,q,15,S[54]),i=R(i,g,l,h,e,21,S[55]),h=R(h,i,g,l,s,6,S[56]),l=R(l,h,i,g,y,10,S[57]),g=R(g,l,h,i,C,15,S[58]),i=R(i,g,l,h,u,21,S[59]),h=R(h,i,g,l,j,6,S[60]),l=R(l,h,i,g,E,10,S[61]),g=R(g,l,h,i,f,15,S[62]),i=R(i,g,l,h,A,21,S[63]);b[0]=b[0]+h|0;b[1]=b[1]+i|0;b[2]=b[2]+g|0;b[3]=b[3]+l|0},A:function(){var a=this.p,c=a.c,b=8*this.G,d=8*
...
for(var Fc=K.n.za,Gc=K.u,U=[],Hc=[],Ic=[],Jc=[],Lc=[],Mc=[],Pc=[],Qc=[],Rc=[],Sc=[],Tc=[],Uc=0;256>Uc;Uc++)Tc[Uc]=128>Uc?Uc<<1:Uc<<1^283;
for(var Vc=0,Wc=0,Uc=0;256>Uc;Uc++){var Xc=Wc^Wc<<1^Wc<<2^Wc<<3^Wc<<4,Xc=Xc>>>8^Xc&255^99;U[Vc]=Xc;Hc[Xc]=Vc;var Yc=Tc[Vc],Zc=Tc[Yc],$c=Tc[Zc],X=257*Tc[Xc]^16843008*Xc;Ic[Vc]=X<<24|X>>>8;Jc[Vc]=X<<16|X>>>16;Lc[Vc]=X<<8|X>>>24;Mc[Vc]=X;X=16843009*$c^65537*Zc^257*Yc^16843008*Vc;Pc[Xc]=X<<24|X>>>8;Qc[Xc]=X<<16|X>>>16;Rc[Xc]=X<<8|X>>>24;Sc[Xc]=X;Vc?(Vc=Yc^Tc[Tc[Tc[$c^Yc]]],Wc^=Tc[Tc[Wc]]):Vc=Wc=1}
var ad=[0,1,2,4,8,16,32,64,128,27,54],Gc=Gc.xa=Fc.extend({F:function(){for(var a=this.Ka,c=a.c,b=a.a/4,a=4*((this.Na=b+6)+1),d=this.La=[],e=0;e<a;e++)if(e<b)d[e]=c[e];else{var f=d[e-1];e%b?6<b&&4==e%b&&(f=U[f>>>24]<<24|U[f>>>16&255]<<16|U[f>>>8&255]<<8|U[f&255]):(f=f<<8|f>>>24,f=U[f>>>24]<<24|U[f>>>16&255]<<16|U[f>>>8&255]<<8|U[f&255],f^=ad[e/b|0]<<24);d[e]=d[e-b]^f}c=this.Ja=[];for(b=0;b<a;b++)e=a-b,f=b%4?d[e]:d[e-4],c[b]=4>b||4>=e?f:Pc[U[f>>>24]]^Qc[U[f>>>16&255]]^Rc[U[f>>>8&255]]^Sc[U[f&255]]},
ra:function(a,c){this.ia(a,c,this.La,Ic,Jc,Lc,Mc,U)},qa:function(a,c){var b=a[c+1];a[c+1]=a[c+3];a[c+3]=b;this.ia(a,c,this.Ja,Pc,Qc,Rc,Sc,Hc);b=a[c+1];a[c+1]=a[c+3];a[c+3]=b},ia:function(a,c,b,d,e,f,m,j){for(var r=this.Na,C=a[c]^b[0],x=a[c+1]^b[1],s=a[c+2]^b[2],A=a[c+3]^b[3],q=4,E=1;E<r;E++)var H=d[C>>>24]^e[x>>>16&255]^f[s>>>8&255]^m[A&255]^b[q++],u=d[x>>>24]^e[s>>>16&255]^f[A>>>8&255]^m[C&255]^b[q++],B=d[s>>>24]^e[A>>>16&255]^f[C>>>8&255]^m[x&255]^b[q++],A=d[A>>>24]^e[C>>>16&255]^f[x>>>8&255]^m[s&
