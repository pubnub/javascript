// Version: 3.5.47
(function(){
var m=null,u=!1;function w(){return function(){}}
window.JSON&&window.JSON.stringify||function(){function a(){try{return this.valueOf()}catch(a){return m}}function c(a){d.lastIndex=0;return d.test(a)?'"'+a.replace(d,function(a){var b=G[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function b(d,g){var s,r,t,q,h,i=e,f=g[d];f&&"object"===typeof f&&(f=a.call(f));"function"===typeof l&&(f=l.call(g,d,f));switch(typeof f){case "string":return c(f);case "number":return isFinite(f)?String(f):"null";case "boolean":case "null":return String(f);
case "object":if(!f)return"null";e+=v;h=[];if("[object Array]"===Object.prototype.toString.apply(f)){q=f.length;for(s=0;s<q;s+=1)h[s]=b(s,f)||"null";t=0===h.length?"[]":e?"[\n"+e+h.join(",\n"+e)+"\n"+i+"]":"["+h.join(",")+"]";e=i;return t}if(l&&"object"===typeof l){q=l.length;for(s=0;s<q;s+=1)r=l[s],"string"===typeof r&&(t=b(r,f))&&h.push(c(r)+(e?": ":":")+t)}else for(r in f)Object.hasOwnProperty.call(f,r)&&(t=b(r,f))&&h.push(c(r)+(e?": ":":")+t);t=0===h.length?"{}":e?"{\n"+e+h.join(",\n"+e)+"\n"+
i+"}":"{"+h.join(",")+"}";e=i;return t}}window.JSON||(window.JSON={});var d=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,e,v,G={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},l;"function"!==typeof JSON.stringify&&(JSON.stringify=function(a,c,d){var r;v=e="";if("number"===typeof d)for(r=0;r<d;r+=1)v+=" ";else"string"===typeof d&&(v=d);if((l=c)&&"function"!==typeof c&&("object"!==typeof c||"number"!==
typeof c.length))throw Error("JSON.stringify");return b("",{"":a})});"function"!==typeof JSON.parse&&(JSON.parse=function(a){return eval("("+a+")")})}();var aa=1,x=u,ba=[],C="-pnpres",F=1E3,ca="/",ea="&",fa=/{([\w\-]+)}/g;function ga(){return"x"+ ++aa+""+ +new Date}function H(){return+new Date}var I,ia=Math.floor(20*Math.random());I=function(a,c){return 0<a.indexOf("pubsub.")&&a.replace("pubsub","ps"+(c?ja().split("-")[0]:20>++ia?ia:ia=1))||a};
function ka(a,c){var b=a.join(ca),d=[];if(!c)return b;P(c,function(a,b){"undefined"!=typeof b&&(b!=m&&0<encodeURIComponent(b).length)&&d.push(a+"="+encodeURIComponent(b))});return b+="?"+d.join(ea)}function ma(a,c){function b(){e+c>H()?(clearTimeout(d),d=setTimeout(b,c)):(e=H(),a())}var d,e=0;return b}function na(a,c){var b=[];P(a||[],function(a){c(a)&&b.push(a)});return b}function oa(a,c){return a.replace(fa,function(a,d){return c[d]||a})}
...
function qa(){setTimeout(function(){x||(x=1,P(ba,function(a){a()}))},F)}
if(!window.PUBNUB){var ra=function(a,c){return CryptoJS.HmacSHA256(a,c).toString(CryptoJS.enc.Base64)},sa=function(a){return document.getElementById(a)},ta=function(a){console.error(a)},ua=function(a,c){var b=[];P(a.split(/\s+/),function(a){P((c||document).getElementsByTagName(a),function(a){b.push(a)})});return b},U=function(a,c,b){P(a.split(","),function(a){function e(a){a||(a=window.event);b(a)||(a.cancelBubble=!0,a.returnValue=u,a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation())}
c.addEventListener?c.addEventListener(a,e,u):c.attachEvent?c.attachEvent("on"+a,e):c["on"+a]=e})},wa=function(){return ua("head")[0]},V=function(a,c,b){if(b)a.setAttribute(c,b);else return a&&a.getAttribute&&a.getAttribute(c)},xa=function(a,c){for(var b in c)if(c.hasOwnProperty(b))try{a.style[b]=c[b]+(0<"|width|height|top|left|".indexOf(b)&&"number"==typeof c[b]?"px":"")}catch(d){}},Aa=function(a){return document.createElement(a)},Ca=function(){return Ba||W()?0:ga()},Ea=function(a){function c(a,b){N||
(N=1,f.onerror=m,clearTimeout(da),a||!b||O(b),setTimeout(function(){a&&K();var b=sa(y),c=b&&b.parentNode;c&&c.removeChild(b)},F))}if(Ba||W()){a:{var b,d,e=function(){if(!G){G=1;clearTimeout(X);try{d=JSON.parse(b.responseText)}catch(a){return q(1)}v=1;r(d)}},v=0,G=0,l=a.timeout||1E4,X=setTimeout(function(){q(1)},l),g=a.b||w(),s=a.data||{},r=a.c||w(),t="undefined"===typeof a.g,q=function(a,c){v||(v=1,clearTimeout(X),b&&(b.onerror=b.onload=m,b.abort&&b.abort(),b=m),a&&g(c))};try{b=W()||window.XDomainRequest&&
new XDomainRequest||new XMLHttpRequest;b.onerror=b.onabort=function(){q(1,b.responseText||{error:"Network Connection Error"})};b.onload=b.onloadend=e;b.onreadystatechange=function(){if(4==b.readyState)switch(b.status){case 401:case 402:case 403:try{d=JSON.parse(b.responseText),q(1,d)}catch(a){return q(1,b.responseText)}}};t&&(b.timeout=l);s.pnsdk=Da;var h=ka(a.url,s);b.open("GET",h,t);b.send()}catch(i){q(0);Ba=0;a=Ea(a);break a}a=q}return a}var f=Aa("script"),e=a.a,y=ga(),N=0,da=setTimeout(function(){c(1)},
a.timeout||1E4),K=a.b||w(),l=a.data||{},O=a.c||w();window[e]=function(a){c(0,a)};a.g||(f[Fa]=Fa);f.onerror=function(){c(1)};l.pnsdk=Da;f.src=ka(a.url,l);V(f,"id",y);wa().appendChild(f);return c},Ga=function(){return!("onLine"in navigator)?1:navigator.onLine},W=function(){if(!Ha||!Ha.get)return 0;var a={id:W.id++,send:w(),abort:function(){a.id={}},open:function(c,b){W[a.id]=a;Ha.get(a.id,b)}};return a},Fa="async",Da="PubNub-JS-Web/3.5.47",Ba=-1==navigator.userAgent.indexOf("MSIE 6");window.console||
(window.console=window.console||{});console.log||(console.log=console.error=(window.opera||{}).postError||w());var Ia,Ja=window.localStorage;Ia={get:function(a){try{return Ja?Ja.getItem(a):-1==document.cookie.indexOf(a)?m:((document.cookie||"").match(RegExp(a+"=([^;]+)"))||[])[1]||m}catch(c){}},set:function(a,c){try{if(Ja)return Ja.setItem(a,c)&&0;document.cookie=a+"="+c+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}catch(b){}}};var Y={list:{},unbind:function(a){Y.list[a]=[]},bind:function(a,c){(Y.list[a]=
Y.list[a]||[]).push(c)},fire:function(a,c){P(Y.list[a]||[],function(a){a(c)})}},Z=sa("pubnub")||0,Ka=function(a){function c(){}function b(a,b){function c(b){b&&(ha=H()-(b/1E4+(H()-d)/2),a&&a(ha))}var d=H();b&&c(b)||z.time(c)}function d(a,b){Q&&Q(a,b);Q=m}function e(){z.time(function(a){b(w(),a);a||d(1,{error:"Heartbeat failed to connect to Pubnub Servers.Please check your network settings."});setTimeout(e,t)})}function v(){Ma()||d(1,{error:"Offline. Please check your network settings. "});setTimeout(v,
F)}function G(a){var b=0;P(pa(L),function(c){if(c=L[c])b++,(a||w())(c)});return b}function l(a){if(Na){if(!D.length)return}else{a&&(D.h=0);if(D.h||!D.length)return;D.h=1}A(D.shift())}a.jsonp&&(Ba=0);var X=a.subscribe_key||"";a.uuid||Ia.get(X+"uuid");a.xdr=Ea;a.db=Ia;a.error=ta;a._is_online=Ga;a.jsonp_cb=Ca;a.PNSDK=Da;a.hmac_SHA256=ra;var g,s=+a.windowing||10,r=(+a.timeout||310)*F,t=(+a.keepalive||60)*F,q=a.noleave||0,h=a.publish_key||"demo",i=a.subscribe_key||"demo",f=a.auth_key||"",y=a.secret_key||
"",N=a.PNSDK||"",da=a.hmac_SHA256,K=a.ssl?"s":"",O="http"+K+"://"+(a.origin||"pubsub.pubnub.com"),J=I(O),va=I(O),D=[],ha=0,ya=0,za=0,Q=0,la=0,R=0,L={},Na=a.no_wait_for_pending,A=a.xdr,k=a.error||w(),Ma=a._is_online||function(){return 1},E=a.jsonp_cb||function(){return 0},S=a.db||{get:w(),set:w()},M=a.uuid||S&&S.get(i+"uuid")||"",z={LEAVE:function(a,b){var c={uuid:M,auth:f},d=I(O),e=E();!(0<a.indexOf(C))&&(!q&&K&&"0"!=e)&&("0"!=e&&(c.callback=e),A({g:b||K,timeout:2E3,a:e,data:c,url:[d,"v2","presence",
"sub_key",i,"channel",encodeURIComponent(a),"leave"]}))},history:function(a,b){var b=a.callback||b,c=a.count||a.limit||100,d=a.reverse||"false",e=a.error||w(),g=a.auth_key||f,B=a.channel,j=a.start,h=a.end,n={},p=E();if(!B)return k("Missing Channel");if(!b)return k("Missing Callback");if(!i)return k("Missing Subscribe Key");n.stringtoken="true";n.count=c;n.reverse=d;n.auth=g;p&&(n.callback=p);j&&(n.start=j);h&&(n.end=h);A({a:p,data:n,c:function(a){"object"==typeof a&&a.error?e(a):b(a)},b:e,url:[J,
"v2","history","sub-key",i,"channel",encodeURIComponent(B)]})},replay:function(a){var b=b||a.callback||w(),c=a.auth_key||f,d=a.source,e=a.destination,g=a.stop,B=a.start,j=a.end,Oa=a.reverse,a=a.limit,n=E(),p={};if(!d)return k("Missing Source Channel");if(!e)return k("Missing Destination Channel");if(!h)return k("Missing Publish Key");if(!i)return k("Missing Subscribe Key");"0"!=n&&(p.callback=n);g&&(p.stop="all");Oa&&(p.reverse="true");B&&(p.start=B);j&&(p.end=j);a&&(p.count=a);p.auth=c;A({a:n,c:function(a){"object"==
typeof a&&a.error?err(a):b(a)},b:function(){b([0,"Disconnected"])},url:[J,"v1","replay",h,i,d,e],data:p})},auth:function(a){f=a;c()},time:function(a){var b=E();A({a:b,data:{uuid:M,auth:f},timeout:5*F,url:[J,"time",b],c:function(b){a(b[0])},b:function(){a(0)}})},publish:function(a,b){var b=b||a.callback||w(),c=a.message,d=a.channel,e=a.auth_key||f,g=a.error||w(),B=E(),j="push";a.prepend&&(j="unshift");if(!c)return k("Missing Message");if(!d)return k("Missing Channel");if(!h)return k("Missing Publish Key");
if(!i)return k("Missing Subscribe Key");c=JSON.stringify(c);D[j]({a:B,timeout:5*F,url:[J,"publish",h,i,0,encodeURIComponent(d),B,encodeURIComponent(c)],data:{uuid:M,auth:e},b:function(a){g(a);l(1)},c:function(a){"object"==typeof a&&a.error?g(a):b(a);l(1)}});l()},unsubscribe:function(a){a=a.channel;R=0;la=1;a=T((a.join?a.join(","):""+a).split(","),function(a){return a+","+a+C}).join(",");P(a.split(","),function(a){x&&z.LEAVE(a,0);L[a]=0});c()},subscribe:function(a,b){function e(a){a?setTimeout(c,F):
(J=I(O,1),va=I(O,1),setTimeout(function(){z.time(e)},F));G(function(b){if(a&&b.d)return b.d=0,b.m(b.name);!a&&!b.d&&(b.d=1,b.l(b.name))})}function g(){var a=E(),b=pa(L).join(",");b&&(d(),Q=A({timeout:N,a:a,b:function(a){n(a);Q=m;z.time(e)},data:{uuid:M,auth:l},url:[va,"subscribe",i,encodeURIComponent(b),a,R],c:function(a){Q=m;if(!a||"object"==typeof a&&"error"in a&&a.error)return n(a),setTimeout(c,F);p(a[1]);R=!R&&la&&S.get(i)||a[1];G(function(a){a.f||(a.f=1,a.k(a.name))});y&&(R=1E4,y=0);S.set(i,
a[1]);var b,d=(2<a.length?a[2]:T(L,function(b){return T(Array(a[0].length).join(",").split(","),function(){return b})}).join(",")).split(",");b=function(){var a=d.shift()||za;return[(L[a]||{}).a||ya,a.split(C)[0]]};var e=H()-ha-+a[1]/1E4;P(a[0],function(c){var d=b();d[0](c,a,d[1],e)});setTimeout(g,K)}}))}var h=a.channel,b=(b=b||a.callback)||a.message,l=a.auth_key||f,B=a.connect||w(),j=a.reconnect||w(),t=a.disconnect||w(),n=a.error||w(),p=a.idle||w(),q=a.presence||0,v=a.noheresync||0,y=a.backfill||
0,D=a.timetoken||0,N=a.timeout||r,K=a.windowing||s;la=a.restore;R=D;if(!h)return k("Missing Channel");if(!b)return k("Missing Callback");if(!i)return k("Missing Subscribe Key");P((h.join?h.join(","):""+h).split(","),function(a){var c=L[a]||{};L[za=a]={name:a,f:c.f,d:c.d,j:1,a:ya=b,k:B,l:t,m:j};q&&(z.subscribe({channel:a+C,callback:q}),!c.j&&!v&&z.here_now({channel:a,callback:function(b){P("uuids"in b?b.uuids:[],function(c){q({action:"join",uuid:c,timestamp:H(),occupancy:b.occupancy||1},b,a)})}}))});
c=function(){d();setTimeout(g,K)};if(!x)return ba.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.error||w(),d=a.auth_key||f,e=a.channel,g=E(),d={uuid:M,auth:d};if(!e)return k("Missing Channel");if(!b)return k("Missing Callback");if(!i)return k("Missing Subscribe Key");"0"!=g&&(d.callback=g);A({a:g,data:d,c:function(a){"object"==typeof a&&a.error?c(a):b(a)},b:c,url:[J,"v2","presence","sub_key",i,"channel",encodeURIComponent(e)]})},grant:function(a,b){var b=a.callback||b,c=a.error||w(),
d=a.channel,e=E(),g=a.ttl||-1,f=a.read?"1":"0",j=a.write?"1":"0",l=a.auth_key;if(!d)return k("Missing Channel");if(!b)return k("Missing Callback");if(!i)return k("Missing Subscribe Key");if(!h)return k("Missing Publish Key");if(!y)return k("Missing Secret Key");"0"!=e&&(n.callback=e);var n=Math.floor((new Date).getTime()/1E3),p=da(i+"\n"+h+"\ngrant\n"+(l&&0<encodeURIComponent(l).length?"auth="+encodeURIComponent(l)+"&":"")+"channel="+encodeURIComponent(d)+"&pnsdk="+encodeURIComponent(N)+"&r="+f+"&timestamp="+
encodeURIComponent(n)+(-1<g?"&ttl="+g:"")+"&w="+j,y),p=p.replace(/\+/g,"-"),p=p.replace(/\//g,"_"),n={w:j,r:f,signature:p,channel:encodeURIComponent(d),timestamp:n};-1<g&&(n.ttl=g);l&&(n.auth=encodeURIComponent(l));A({a:e,data:n,c:function(a){b(a)},b:c,url:[J,"v1","auth","grant","sub-key",i]})},audit:function(a,b){var b=a.callback||b,c=a.error||w(),d=a.channel,e=a.auth_key,g=E();if(!b)return k("Missing Callback");if(!i)return k("Missing Subscribe Key");if(!h)return k("Missing Publish Key");if(!y)return k("Missing Secret Key");
"0"!=g&&(f.callback=g);var f=Math.floor((new Date).getTime()/1E3),j=i+"\n"+h+"\naudit\n";e&&(j+="auth="+encodeURIComponent(e)+"&");d&&(j+="channel="+encodeURIComponent(d)+"&");var j=j+("pnsdk="+encodeURIComponent(N)+"&timestamp="+f),j=da(j,y),j=j.replace(/\+/g,"-"),j=j.replace(/\//g,"_"),f={signature:j,timestamp:f};d&&(f.channel=encodeURIComponent(d));e&&(f.auth=encodeURIComponent(e));A({a:g,data:f,c:function(a){b(a)},b:c,url:[J,"v1","auth","audit","sub-key",i]})},revoke:function(a,b){a.read=u;a.write=
u;z.grant(a,b)},xdr:A,ready:qa,db:S,uuid:ja,map:T,each:P,"each-channel":G,grep:na,offline:function(){d(1)},supplant:oa,now:H,unique:ga,updater:ma};M||(M=z.uuid());S.set(i+"uuid",M);setTimeout(v,F);setTimeout(e,t);b();g=z;g.css=xa;g.$=sa;g.create=Aa;g.bind=U;g.head=wa;g.search=ua;g.attr=V;g.events=Y;g.init=Ka;U("beforeunload",window,function(){g["each-channel"](function(a){g.LEAVE(a.name,0)});return!0});if(a.notest)return g;U("offline",window,g.offline);U("offline",document,g.offline);return g};"complete"===
document.readyState?setTimeout(qa,0):U("load",window,function(){setTimeout(qa,0)});var $=Z||{};PUBNUB=Ka({notest:1,publish_key:V($,"pub-key"),subscribe_key:V($,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==V($,"ssl"),origin:V($,"origin"),uuid:V($,"uuid")});window.jQuery&&(window.jQuery.PUBNUB=PUBNUB);"undefined"!==typeof module&&(module.exports=PUBNUB)&&qa();var Ha=sa("pubnubs")||0;if(Z){xa(Z,{position:"absolute",top:-F});if("opera"in window||V(Z,"flash"))Z.innerHTML="<object id=pubnubs data=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=movie value=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=allowscriptaccess value=always></object>";
...
w();b.binaryType="";b.extensions="";b.bufferedAmount=0;b.trasnmitting=u;b.buffer=[];b.readyState=b.CONNECTING;if(!a)return b.readyState=b.CLOSED,b.onclose({code:b.CLOSE_ABNORMAL,reason:"Missing URL",wasClean:!0}),b;b.e=PUBNUB.init(d);b.e.i=d;b.i=d;b.e.subscribe({restore:u,channel:d.channel,disconnect:b.onerror,reconnect:b.onopen,error:function(){b.onclose({code:b.CLOSE_ABNORMAL,reason:"Missing URL",wasClean:u})},callback:function(a){b.onmessage({data:a})},connect:function(){b.readyState=b.OPEN;b.onopen()}})};
