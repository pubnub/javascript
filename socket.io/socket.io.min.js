...
function la(a,c){return Q((""+a||"").split(""),function(a){return 0>c.indexOf(a)?a:"%"+a.charCodeAt(0).toString(16).toUpperCase()}).join("")}function U(a,c){return la(a,c||"?,/%&")}function qa(a){var c=[];P(a,function(a,d){d.j&&c.push(a)});return c.sort()}function ra(){setTimeout(function(){v||(v=1,P(ba,function(a){a()}))},D)}
...
c.addEventListener?c.addEventListener(a,e,t):c.attachEvent?c.attachEvent("on"+a,e):c["on"+a]=e})},xa=function(){return va("head")[0]},W=function(a,c,b){if(b)a.setAttribute(c,b);else return a&&a.getAttribute&&a.getAttribute(c)},ya=function(a,c){for(var b in c)if(c.hasOwnProperty(b))try{a.style[b]=c[b]+(0<"|width|height|top|left|".indexOf(b)&&"number"==typeof c[b]?"px":"")}catch(d){}},Ba=function(a){return document.createElement(a)},Da=function(){return Ca||X()?0:ga()},Fa=function(a){function c(a,b){L||
(L=1,h.onerror=m,clearTimeout(ca),a||!b||M(b),setTimeout(function(){a&&N();var b=ta(A),c=b&&b.parentNode;c&&c.removeChild(b)},D))}if(Ca||X()){a:{var b,d,e=function(){if(!E){E=1;clearTimeout(K);try{d=JSON.parse(b.responseText)}catch(a){return r(1)}s=1;l(d)}},s=0,E=0,f=a.timeout||1E4,K=setTimeout(function(){r(1)},f),g=a.b||u(),p=a.data||{},l=a.c||u(),q="undefined"===typeof a.g,r=function(a,c){s||(s=1,clearTimeout(K),b&&(b.onerror=b.onload=m,b.abort&&b.abort(),b=m),a&&g(c))};try{b=X()||window.XDomainRequest&&
new XDomainRequest||new XMLHttpRequest;b.onerror=b.onabort=function(){r(1,b.responseText||{error:"Network Connection Error"})};b.onload=b.onloadend=e;b.onreadystatechange=function(){if(4==b.readyState)switch(b.status){case 401:case 402:case 403:try{d=JSON.parse(b.responseText),r(1,d)}catch(a){return r(1,b.responseText)}}};q&&(b.timeout=f);p.pnsdk=Ea;var i=ka(a.url,p);b.open("GET",i,q);b.send()}catch(j){r(0);Ca=0;a=Fa(a);break a}a=r}return a}var h=Ba("script"),e=a.a,A=ga(),L=0,ca=setTimeout(function(){c(1)},
a.timeout||1E4),N=a.b||u(),f=a.data||{},M=a.c||u();window[e]=function(a){c(0,a)};a.g||(h[Ga]=Ga);h.onerror=function(){c(1)};f.pnsdk=Ea;h.src=ka(a.url,f);W(h,"id",A);xa().appendChild(h);return c},Ha=function(){return!("onLine"in navigator)?1:navigator.onLine},X=function(){if(!Ia||!Ia.get)return 0;var a={id:X.id++,send:u(),abort:function(){a.id={}},open:function(c,b){X[a.id]=a;Ia.get(a.id,b)}};return a},Ga="async",Ea="PubNub-JS-Web/3.5.43",Ca=-1==navigator.userAgent.indexOf("MSIE 6");window.console||
...
D)}function E(a){var b=0;P(qa(I),function(c){if(c=I[c])b++,(a||u())(c)});return b}function f(a){a&&(B.h=0);!B.h&&B.length&&(B.h=1,x(B.shift()))}a.jsonp&&(Ca=0);var K=a.subscribe_key||"";a.uuid||Ja.get(K+"uuid");a.xdr=Fa;a.db=Ja;a.error=ua;a._is_online=Ha;a.jsonp_cb=Da;a.PNSDK=Ea;a.hmac_SHA256=sa;var g,p=+a.windowing||10,l=(+a.timeout||310)*D,q=(+a.keepalive||60)*D,r=a.noleave||0,i=a.publish_key||"",j=a.subscribe_key||"",h=a.auth_key||"",A=a.secret_key||"",L=a.PNSDK||"",ca=a.hmac_SHA256,N=a.ssl?"s":
"",M="http"+N+"://"+(a.origin||"pubsub.pubnub.com"),H=G(M),wa=G(M),B=[],ia=0,za=0,Aa=0,R=0,ma=0,S=0,I={},x=a.xdr,k=a.error||u(),Na=a._is_online||function(){return 1},C=a.jsonp_cb||function(){return 0},T=a.db||{get:u(),set:u()},J=a.uuid||T&&T.get(j+"uuid")||"",w={LEAVE:function(a,b){var c={uuid:J,auth:h},d=G(M),e=C();!(0<a.indexOf(z))&&(!r&&N&&"0"!=e)&&("0"!=e&&(c.callback=e),x({g:b||N,timeout:2E3,a:e,data:c,url:[d,"v2","presence","sub_key",j,"channel",U(a),"leave"]}))},history:function(a,b){var b=
a.callback||b,c=a.count||a.limit||100,d=a.reverse||"false",e=a.error||u(),Oa=a.auth_key||h,y=a.channel,O=a.start,g=a.end,n={},i=C();if(!y)return k("Missing Channel");if(!b)return k("Missing Callback");if(!j)return k("Missing Subscribe Key");n.stringtoken="true";n.count=c;n.reverse=d;n.auth=Oa;i&&(n.callback=i);O&&(n.start=O);g&&(n.end=g);x({a:i,data:n,c:function(a){"object"==typeof a&&a.error?e(a):b(a)},b:e,url:[H,"v2","history","sub-key",j,"channel",U(y)]})},replay:function(a){var b=b||a.callback||
u(),c=a.auth_key||h,d=a.source,e=a.destination,g=a.stop,y=a.start,O=a.end,l=a.reverse,a=a.limit,n=C(),f={};if(!d)return k("Missing Source Channel");if(!e)return k("Missing Destination Channel");if(!i)return k("Missing Publish Key");if(!j)return k("Missing Subscribe Key");"0"!=n&&(f.callback=n);g&&(f.stop="all");l&&(f.reverse="true");y&&(f.start=y);O&&(f.end=O);a&&(f.count=a);f.auth=c;x({a:n,c:function(a){"object"==typeof a&&a.error?err(a):b(a)},b:function(){b([0,"Disconnected"])},url:[H,"v1","replay",
i,j,d,e],data:f})},auth:function(a){h=a;c()},time:function(a){var b=C();x({a:b,data:{uuid:J,auth:h},timeout:5*D,url:[H,"time",b],c:function(b){a(b[0])},b:function(){a(0)}})},publish:function(a,b){var b=b||a.callback||u(),c=a.message,d=a.channel,e=a.auth_key||h,g=a.error||u(),y=C();if(!c)return k("Missing Message");if(!d)return k("Missing Channel");if(!i)return k("Missing Publish Key");if(!j)return k("Missing Subscribe Key");c=JSON.stringify(c);c=[H,"publish",i,j,0,U(d),y,U(c,"?%")];B.push({a:y,timeout:5*
D,url:c,data:{uuid:J,auth:e},c:function(a){"object"==typeof a&&a.error?g(a):b(a);f(1)},b:function(a){g(a);f(1)}});f()},unsubscribe:function(a){a=a.channel;S=0;ma=1;a=Q((a.join?a.join(","):""+a).split(","),function(a){return a+","+a+z}).join(",");P(a.split(","),function(a){v&&w.LEAVE(a,0);I[a]=0});c()},subscribe:function(a,b){function e(a){a?setTimeout(c,D):(H=G(M,1),wa=G(M,1),setTimeout(function(){w.time(e)},D));E(function(b){if(a&&b.d)return b.d=0,b.m(b.name);!a&&!b.d&&(b.d=1,b.l(b.name))})}function g(){var a=
C(),b=qa(I).join(",");b&&(d(),R=x({timeout:N,a:a,b:function(a){n(a);R=m;w.time(e)},data:{uuid:J,auth:i},url:[wa,"subscribe",j,U(b),a,S],c:function(a){R=m;if(!a||"object"==typeof a&&"error"in a&&a.error)return n(a),setTimeout(c,D);r(a[1]);S=!S&&ma&&T.get(j)||a[1];E(function(a){a.f||(a.f=1,a.k(a.name))});B&&(S=1E4,B=0);T.set(j,a[1]);var b,d=(2<a.length?a[2]:Q(I,function(b){return Q(Array(a[0].length).join(",").split(","),function(){return b})}).join(",")).split(",");b=function(){var a=d.shift()||Aa;
return[(I[a]||{}).a||za,a.split(z)[0]]};var e=F()-ia-+a[1]/1E4;P(a[0],function(c){var d=b();d[0](c,a,d[1],e)});setTimeout(g,K)}}))}var f=a.channel,b=(b=b||a.callback)||a.message,i=a.auth_key||h,y=a.connect||u(),O=a.reconnect||u(),q=a.disconnect||u(),n=a.error||u(),r=a.idle||u(),s=a.presence||0,A=a.noheresync||0,B=a.backfill||0,L=a.timetoken||0,N=a.timeout||l,K=a.windowing||p;ma=a.restore;S=L;if(!f)return k("Missing Channel");if(!b)return k("Missing Callback");if(!j)return k("Missing Subscribe Key");
P((f.join?f.join(","):""+f).split(","),function(a){var c=I[a]||{};I[Aa=a]={name:a,f:c.f,d:c.d,j:1,a:za=b,k:y,l:q,m:O};s&&(w.subscribe({channel:a+z,callback:s}),!c.j&&!A&&w.here_now({channel:a,callback:function(b){P("uuids"in b?b.uuids:[],function(c){s({action:"join",uuid:c,timestamp:F(),occupancy:b.occupancy||1},b,a)})}}))});c=function(){d();setTimeout(g,K)};if(!v)return ba.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.error||u(),d=a.auth_key||h,e=a.channel,g=C(),d={uuid:J,auth:d};if(!e)return k("Missing Channel");
...
if(!A)return k("Missing Secret Key");"0"!=e&&(n.callback=e);var n=Math.floor((new Date).getTime()/1E3),p=ca(j+"\n"+i+"\ngrant\n"+(l&&0<encodeURIComponent(l).length?"auth="+encodeURIComponent(l)+"&":"")+"channel="+encodeURIComponent(d)+"&pnsdk="+encodeURIComponent(L)+"&r="+h+"&timestamp="+encodeURIComponent(n)+(-1<g?"&ttl="+g:"")+"&w="+f,A),p=p.replace(RegExp("\\+","g"),"-"),p=p.replace(RegExp("\\/","g"),"_"),n={w:f,r:h,signature:p,channel:encodeURIComponent(d),timestamp:n};-1<g&&(n.ttl=g);l&&(n.auth=
