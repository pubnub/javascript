...
function N(a){return P(encodeURIComponent(a).split(""),function(a){return 0>"-_.!~*'()".indexOf(a)?a:"%"+a.charCodeAt(0).toString(16).toUpperCase()}).join("")}function oa(a){var c=[];M(a,function(a,d){d.i&&c.push(a)});return c.sort()}function pa(){setTimeout(function(){v||(v=1,M(ba,function(a){a()}))},z)}
...
Q(x),c=b&&b.parentNode;c&&c.removeChild(b)},z))}if(T||U()){a:{var b,d,e=function(){if(!q){q=1;clearTimeout(g);try{d=JSON.parse(b.responseText)}catch(a){return j(1)}s=1;i(d)}},s=0,q=0,k=a.timeout||1E4,g=setTimeout(function(){j(1)},k),H=a.fail||t(),h=a.data||{},i=a.success||t(),l="undefined"===typeof a.blocking,j=function(a){s||(s=1,clearTimeout(g),b&&(b.onerror=b.onload=n,b.abort&&b.abort(),b=n),a&&H())};try{b=U()||window.XDomainRequest&&new XDomainRequest||new XMLHttpRequest;b.onerror=b.onabort=function(){j(1)};
b.onload=b.onloadend=e;l&&(b.timeout=k);h.pnsdk=xa;var m=ka(a.url,h);b.open("GET",m,l);b.send()}catch(D){j(0);T=0;a=ya(a);break a}a=j}return a}var f=va("script"),e=a.callback,x=E(),O=0,u=setTimeout(function(){c(1)},a.timeout||1E4),Y=a.fail||t(),k=a.data||{},X=a.success||t();window[e]=function(a){c(0,a)};a.blocking||(f[za]=za);f.onerror=function(){c(1)};k.pnsdk=xa;f.src=ka(a.url,k);S(f,"id",x);sa().appendChild(f);return c},Aa=function(){return!("onLine"in navigator)?1:navigator.onLine},U=function(){if(!Ba||
!Ba.get)return 0;var a={id:U.id++,send:t(),abort:function(){a.id={}},open:function(c,b){U[a.id]=a;Ba.get(a.id,b)}};return a},za="async",xa="PubNub-JS-Web/3.5.2",T=-1==navigator.userAgent.indexOf("MSIE 6");window.console||(window.console=window.console||{});console.log||(console.log=console.error=(window.opera||{}).postError||t());var Ca,V=window.localStorage;Ca={get:function(a){try{return V?V.getItem(a):-1==document.cookie.indexOf(a)?n:((document.cookie||"").match(RegExp(a+"=([^;]+)"))||[])[1]||n}catch(c){}},
set:function(a,c){try{if(V)return V.setItem(a,c)&&0;document.cookie=a+"="+c+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}catch(b){}}};var W={list:{},unbind:function(a){W.list[a]=[]},bind:function(a,c){(W.list[a]=W.list[a]||[]).push(c)},fire:function(a,c){M(W.list[a]||[],function(a){a(c)})}},Z=Q("pubnub")||0,Da=function(a){function c(){}function b(a){J&&J(a);J=n}function d(){y.time(function(a){a||b(1);setTimeout(d,i)})}function e(){fa()||b(1);setTimeout(e,z)}function s(a){var b=0;M(oa(A),function(c){if(c=
A[c])b++,(a||t())(c)});return b}function q(a){a&&(u.g=0);!u.g&&u.length&&(u.g=1,B(u.shift()))}a.jsonp&&(T=0);var k=a.subscribe_key||"";a.uuid||Ca.get(k+"uuid");a.xdr=ya;a.db=Ca;a.error=qa;a._is_online=Aa;a.jsonp_cb=wa;var g,H=+a.windowing||10,h=(+a.timeout||310)*z,i=(+a.keepalive||60)*z,l=a.publish_key||"",j=a.subscribe_key||"",m=a.auth_key||"",D=a.ssl?"s":"",f="http"+D+"://"+(a.origin||"pubsub.pubnub.com"),x=I(f),O=I(f),u=[],Y=0,X=0,J=0,ca=0,K=0,A={},B=a.xdr,p=a.error||t(),fa=a._is_online||function(){return 1},
F=a.jsonp_cb||function(){return 0},L=a.db||{get:t(),set:t()},C=a.uuid||L&&L.get(j+"uuid")||"",y={LEAVE:function(a,b){var c={uuid:C,auth:m},d=I(f),e=F();0<a.indexOf(w)||("0"!=e&&(c.callback=e),B({blocking:b||D,timeout:2E3,callback:e,data:c,url:[d,"v2","presence","sub_key",j,"channel",N(a),"leave"]}))},history:function(a,b){var b=a.callback||b,c=a.count||a.limit||100,d=a.reverse||"false",e=a.error||t(),f=a.channel,g=a.start,i=a.end,h={},l=F();if(!f)return p("Missing Channel");if(!b)return p("Missing Callback");
if(!j)return p("Missing Subscribe Key");h.stringtoken="true";h.count=c;h.reverse=d;h.auth=m;l&&(h.callback=l);g&&(h.start=g);i&&(h.end=i);B({a:l,data:h,d:function(a){b(a)},c:e,url:[x,"v2","history","sub-key",j,"channel",N(f)]})},replay:function(a){var b=b||a.callback||t(),c=a.source,d=a.destination,e=a.stop,f=a.start,h=a.end,g=a.reverse,a=a.limit,i=F(),k={};if(!c)return p("Missing Source Channel");if(!d)return p("Missing Destination Channel");if(!l)return p("Missing Publish Key");if(!j)return p("Missing Subscribe Key");
"0"!=i&&(k.callback=i);e&&(k.stop="all");g&&(k.reverse="true");f&&(k.start=f);h&&(k.end=h);a&&(k.count=a);k.auth=m;B({a:i,d:function(a){b(a)},c:function(){b([0,"Disconnected"])},url:[x,"v1","replay",l,j,c,d],data:k})},auth:function(a){m=a;c()},time:function(a){var b=F();B({a:b,data:{uuid:C,auth:m},timeout:5*z,url:[x,"time",b],d:function(b){a(b[0])},c:function(){a(0)}})},publish:function(a,b){var b=b||a.callback||t(),c=a.message,d=a.channel,e=F();if(!c)return p("Missing Message");if(!d)return p("Missing Channel");
if(!l)return p("Missing Publish Key");if(!j)return p("Missing Subscribe Key");c=JSON.stringify(c);d=[x,"publish",l,j,0,N(d),e,N(c)];u.push({a:e,timeout:5*z,url:d,data:{uuid:C,auth:m},d:function(a){b(a);q(1)},c:function(){b([0,"Failed",c]);q(1)}});q()},unsubscribe:function(a){a=a.channel;K=0;ca=1;a=P((a.join?a.join(","):""+a).split(","),function(a){return a+","+a+w}).join(",");M(a.split(","),function(a){v&&y.LEAVE(a,0);A[a]=0});c()},subscribe:function(a,d){function e(a){a?setTimeout(c,z):(x=I(f,1),
O=I(f,1),setTimeout(function(){y.time(e)},z));s(function(b){if(a&&b.b)return b.b=0,b.l(b.name);!a&&!b.b&&(b.b=1,b.k(b.name))})}function i(){var a=F(),d=oa(A).join(",");d&&(b(),J=B({timeout:Fa,a:a,c:function(){J=n;y.time(e)},data:{uuid:C,auth:m},url:[O,"subscribe",j,N(d),a,K],d:function(a){J=n;if(!a||"object"==typeof a&&"error"in a&&!a.error)return u(a),setTimeout(c,ga);K=!K&&ca&&L.get(j)||a[1];s(function(a){a.f||(a.f=1,a.j(a.name))});ta&&(K=1E4,ta=0);L.set(j,a[1]);var b,d=(2<a.length?a[2]:P(A,function(b){return P(Array(a[0].length).join(",").split(","),
...
M((g.join?g.join(","):""+g).split(","),function(a){var b=A[a]||{};A[X=a]={name:a,f:b.f,b:b.b,i:1,a:Y=d,j:k,k:q,l:l};D&&(y.subscribe({channel:a+w,callback:D}),!b.i&&!fa&&y.here_now({channel:a,callback:function(b){M("uuids"in b?b.uuids:[],function(c){D({action:"join",uuid:c,timestamp:G(),occupancy:b.occupancy||1},b,a)})}}))});c=function(){b();setTimeout(i,ga)};if(!v)return ba.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.error||t(),d=a.channel,e=F(),f={uuid:C,auth:m};if(!d)return p("Missing Channel");
if(!b)return p("Missing Callback");if(!j)return p("Missing Subscribe Key");"0"!=e&&(f.callback=e);B({a:e,data:f,d:function(a){b(a,d)},c:c,url:[x,"v2","presence","sub_key",j,"channel",N(d)]})},xdr:B,ready:pa,db:L,uuid:ja,map:P,each:M,"each-channel":s,grep:ma,offline:function(){b(1)},supplant:na,now:G,unique:E,updater:la};C||(C=y.uuid());L.set(j+"uuid",C);setTimeout(e,z);setTimeout(d,i);y.time(t());g=y;g.css=ua;g.$=Q;g.create=va;g.bind=R;g.head=sa;g.search=ra;g.attr=S;g.events=W;g.init=Da;R("beforeunload",
...
t();b.binaryType="";b.extensions="";b.bufferedAmount=0;b.trasnmitting=r;b.buffer=[];b.readyState=b.CONNECTING;if(!a)return b.readyState=b.CLOSED,b.onclose({code:b.CLOSE_ABNORMAL,reason:"Missing URL",wasClean:!0}),b;b.e=PUBNUB.init(d);b.e.h=d;b.h=d;b.e.subscribe({restore:r,channel:d.channel,disconnect:b.onerror,reconnect:b.onopen,error:function(){b.onclose({code:b.CLOSE_ABNORMAL,reason:"Missing URL",wasClean:r})},callback:function(a){b.onmessage({data:a})},connect:function(){b.readyState=b.OPEN;b.onopen()}})};
Ea.prototype.send=function(a){var c=this;c.e.publish({channel:c.e.h.channel,message:a,callback:function(a){c.onsend({data:a})}})};
})();
(function(){
