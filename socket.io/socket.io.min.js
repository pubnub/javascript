...
l=0,R=setTimeout(function(){c(1,{message:"timeout"})},a.timeout||1E4),Na=a.b||A(),p=a.data||{},Ma=a.c||A();window[f]=function(a){c(0,a)};a.h||(s[fb]=fb);s.onerror=function(){c(1)};s.src=qa(a.url,p);Xa(s,"id",C);Wa().appendChild(s);return c},gb=function(){if(!("onLine"in navigator))return 1;try{return navigator.onLine}catch(a){return q}},hb=function(a){return!("sendBeacon"in navigator)?z:navigator.p(a)},ab=function(){if(!ob||!ob.get)return 0;var a={id:ab.id++,send:A(),abort:function(){a.id={}},open:function(c,
b){ab[a.id]=a;ob.get(a.id,b)}};return a},fb="async",pb=navigator.userAgent,$a=-1==pb.indexOf("MSIE 6");window.console||(window.console=window.console||{});console.log||(console.log=console.error=(window.opera||{}).postError||A());var qb,rb={},sb=z;try{sb=window.localStorage}catch(tb){}var ub=function(a){return-1==document.cookie.indexOf(a)?y:((document.cookie||"").match(RegExp(a+"=([^;]+)"))||[])[1]||y},vb=function(a,c){document.cookie=a+"="+c+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"},wb;
...
set_heartbeat_interval:function(a){P=a;v()},get_version:function(){return"3.7.12"},getGcmMessageObject:function(a){return{data:a}},getApnsMessageObject:function(a){var b={aps:{badge:1,alert:""}};for(k in a)k[b]=a[k];return b},newPnMessage:function(){var a={};gcm&&(a.pn_gcm=gcm);apns&&(a.pn_apns=apns);for(k in n)a[k]=n[k];return a},_add_param:function(a,b){ta[a]=b},channel_group:function(a,b){var c=a.channel_group,b=b||a.callback,d=a.channels||a.channel,i=a.cloak,w,B,h=[],e={},f=a.mode||"add";c&&(c=
