...
var v=void 0,y=!0,z=null,A=!1;function B(){return function(){}}
...
d.addEventListener(a,f,A):d.attachEvent?d.attachEvent("on"+a,f):d["on"+a]=f})},rb=function(){return pb("head")[0]},V=function(a,d,b){if(b)a.setAttribute(d,b);else return a&&a.getAttribute&&a.getAttribute(d)},sb=function(a,d){for(var b in d)if(d.hasOwnProperty(b))try{a.style[b]=d[b]+(0<"|width|height|top|left|".indexOf(b)&&"number"==typeof d[b]?"px":"")}catch(c){}},tb=function(a){return document.createElement(a)},zb=function(){return ub||$()?0:la()},Ab=function(a){function d(a,b){G||(G=1,e.onerror=
z,clearTimeout(Ra),a||!b||Sa(b),setTimeout(function(){a&&S();var b=mb(aa),c=b&&b.parentNode;c&&c.removeChild(b)},D))}if(ub||$()){a:{var b,c,f=function(){if(!q){q=1;clearTimeout(u);try{c=JSON.parse(b.responseText)}catch(a){return j(1)}p=1;r(c)}},p=0,q=0,m=a.timeout||1E4,u=setTimeout(function(){j(1,{message:"timeout"})},m),x=a.b||B(),t=a.data||{},r=a.c||B(),g=!a.h,j=function(a,c){p||(p=1,clearTimeout(u),b&&(b.onerror=b.onload=z,b.abort&&b.abort(),b=z),a&&x(c))};try{b=$()||window.XDomainRequest&&new XDomainRequest||
new XMLHttpRequest;b.onerror=b.onabort=function(){j(1,b.responseText||{error:"Network Connection Error"})};b.onload=b.onloadend=f;b.onreadystatechange=function(){if(b&&4==b.readyState)switch(b.status){case 401:case 402:case 403:try{c=JSON.parse(b.responseText),j(1,c)}catch(a){return j(1,b.responseText)}}};g&&(b.timeout=m);var h=qa(a.url,t);b.open("GET",h,g);b.send()}catch(l){j(0);ub=0;a=Ab(a);break a}a=j}return a}var e=tb("script"),f=a.a,aa=la(),G=0,Ra=setTimeout(function(){d(1,{message:"timeout"})},
a.timeout||1E4),S=a.b||B(),m=a.data||{},Sa=a.c||B();window[f]=function(a){d(0,a)};a.h||(e[Bb]=Bb);e.onerror=function(){d(1)};e.src=qa(a.url,m);V(e,"id",aa);rb().appendChild(e);return d},Cb=function(){return!("onLine"in navigator)?1:navigator.onLine},$=function(){if(!Db||!Db.get)return 0;var a={id:$.id++,send:B(),abort:function(){a.id={}},open:function(d,b){$[a.id]=a;Db.get(a.id,b)}};return a},Bb="async",ub=-1==navigator.userAgent.indexOf("MSIE 6");window.console||(window.console=window.console||{});
console.log||(console.log=console.error=(window.opera||{}).postError||B());var Eb,Fb=window.localStorage;Eb={get:function(a){try{return Fb?Fb.getItem(a):-1==document.cookie.indexOf(a)?z:((document.cookie||"").match(RegExp(a+"=([^;]+)"))||[])[1]||z}catch(d){}},set:function(a,d){try{if(Fb)return Fb.setItem(a,d)&&0;document.cookie=a+"="+d+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}catch(b){}}};var Gb={list:{},unbind:function(a){Gb.list[a]=[]},bind:function(a,d){(Gb.list[a]=Gb.list[a]||[]).push(d)},
fire:function(a,d){N(Gb.list[a]||[],function(a){a(d)})}},Ib=mb("pubnub")||0,Jb=function(a){function d(){}function b(a,b){function c(b){b&&(Va=L()-(b/1E4+(L()-d)/2),a&&a(Va))}var d=L();b&&c(b)||H.time(c)}function c(a,b){Ha&&Ha(a,b);Ha=z}function f(){H.time(function(a){b(B(),a);a||c(1,{error:"Heartbeat failed to connect to Pubnub Servers.Please check your network settings."});setTimeout(f,ob)})}function p(){Nb()||c(1,{error:"Offline. Please check your network settings. "});setTimeout(p,D)}function q(a,
b){"object"==typeof a&&a.error&&a.message&&a.payload?b({message:a.message,payload:a.payload}):b(a)}function m(a,b,c){if("object"==typeof a){if(a.error&&a.message&&a.payload){c({message:a.message,payload:a.payload});return}if(a.payload){b(a.payload);return}}b(a)}function u(a){var b=0;N(va(C),function(c){if(c=C[c])b++,(a||B())(c)});return b}function x(a){if(Ob){if(!Q.length)return}else{a&&(Q.j=0);if(Q.j||!Q.length)return;Q.j=1}E(Q.shift())}function t(){!Wa&&r()}function r(){clearTimeout(W);!I||500<=
I||1>I||!va(C,y).length?Wa=A:(Wa=y,H.presence_heartbeat({callback:function(){W=setTimeout(r,I*D)},error:function(a){s&&s("Presence Heartbeat unable to reach Pubnub servers."+JSON.stringify(a));W=setTimeout(r,I*D)}}))}function g(a,b){return ba.decrypt(a,b||X)||ba.decrypt(a,X)||a}function j(a,b,c){var d=A;if("number"===typeof a)d=5<a||0==a?A:y;else{if("boolean"===typeof a)return a?30:0;d=y}return d?(c&&c("Presence Heartbeat value invalid. Valid range ( x > 5 or x = 0). Current Value : "+(b||5)),b||
...
a[4]=b(h,a[4]);a[5]=b(q,a[5]);a[6]=b(p,a[6]);a[7]=b(r,a[7])}d="";for(f=0;f<4*a.length;f++)d+="0123456789abcdef".charAt(a[f>>2]>>8*(3-f%4)+4&15)+"0123456789abcdef".charAt(a[f>>2]>>8*(3-f%4)&15);return d}a.jsonp&&(ub=0);var G=a.subscribe_key||"";a.uuid||Eb.get(G+"uuid");var Ra=a.leave_on_unload||0;a.xdr=Ab;a.db=Eb;a.error=a.error||nb;a._is_online=Cb;a.jsonp_cb=zb;a.hmac_SHA256=lb;O.size(256);var S=O.s2a("0123456789012345");a.crypto_obj={encrypt:function(a,b){if(!b)return a;var c=O.s2a(aa(b).slice(0,
32)),d=O.s2a(JSON.stringify(a)),c=O.rawEncrypt(d,c,S);return O.Base64.encode(c)||a},decrypt:function(a,b){if(!b)return a;var c=O.s2a(aa(b).slice(0,32));try{var d=O.Base64.decode(a),e=O.rawDecrypt(d,c,S,A);return JSON.parse(e)}catch(f){}}};a.params={pnsdk:"PubNub-JS-Web/3.6.5"};var Sa=+a.windowing||10,Hb=(+a.timeout||310)*D,ob=(+a.keepalive||60)*D,Lb=a.noleave||0,P=a.publish_key||"demo",w=a.subscribe_key||"demo",M=a.auth_key||"",Ia=a.secret_key||"",vb=a.hmac_SHA256,Xa=a.ssl?"s":"",oa="http"+Xa+"://"+
(a.origin||"pubsub.pubnub.com"),J=ma(oa),wb=ma(oa),Q=[],Va=0,xb=0,yb=0,Ha=0,Ja=0,da=0,Ya=A,C={},Z={},W=z,R=j(a.heartbeat||a.pnexpires||0,a.error),I=a.heartbeat_interval||R-3,Wa=A,Ob=a.no_wait_for_pending,Pb=a["compatible_3.5"]||A,E=a.xdr,Y=a.params||{},s=a.error||B(),Nb=a._is_online||function(){return 1},K=a.jsonp_cb||function(){return 0},ea=a.db||{get:B(),set:B()},X=a.cipher_key,F=a.uuid||ea&&ea.get(w+"uuid")||"",ba=a.crypto_obj||{encrypt:function(a){return a},decrypt:function(a){return a}},H={LEAVE:function(a,
b,c,d){var e={uuid:F,auth:M},f=ma(oa),c=c||B(),g=d||B(),d=K();if(0<a.indexOf(ha))return y;if(Pb&&(!Xa||"0"==d)||Lb)return A;"0"!=d&&(e.callback=d);E({h:b||Xa,timeout:2E3,a:d,data:l(e),c:function(a){m(a,c,g)},b:function(a){q(a,g)},url:[f,"v2","presence","sub_key",w,"channel",encodeURIComponent(a),"leave"]});return y},set_resumed:function(a){Ya=a},get_cipher_key:function(){return X},set_cipher_key:function(a){X=a},raw_encrypt:function(a,b){return ba.encrypt(a,b||X)||a},raw_decrypt:function(a,b){return g(a,
b)},get_heartbeat:function(){return R},set_heartbeat:function(a){R=j(a,I,s);I=1<=R-3?R-3:1;d();r()},get_heartbeat_interval:function(){return I},set_heartbeat_interval:function(a){I=a;r()},get_version:function(){return"3.6.5"},getGcmMessageObject:function(a){return{data:a}},getApnsMessageObject:function(a){var b={aps:{badge:1,alert:""}};for(k in a)k[b]=a[k];return b},newPnMessage:function(){var a={};gcm&&(a.pn_gcm=gcm);apns&&(a.pn_apns=apns);for(k in n)a[k]=n[k];return a},_add_param:function(a,b){Y[a]=
b},history:function(a,b){var b=a.callback||b,c=a.count||a.limit||100,d=a.reverse||"false",e=a.error||B(),f=a.auth_key||M,h=a.cipher_key,m=a.channel,j=a.start,p=a.end,r=a.include_token,t={},u=K();if(!m)return s("Missing Channel");if(!b)return s("Missing Callback");if(!w)return s("Missing Subscribe Key");t.stringtoken="true";t.count=c;t.reverse=d;t.auth=f;u&&(t.callback=u);j&&(t.start=j);p&&(t.end=p);r&&(t.include_token="true");E({a:u,data:l(t),c:function(a){if("object"==typeof a&&a.error)e({message:a.message,
payload:a.payload});else{for(var c=a[0],d=[],f=0;f<c.length;f++){var l=g(c[f],h);try{d.push(JSON.parse(l))}catch(m){d.push(l)}}b([d,a[1],a[2]])}},b:function(a){q(a,e)},url:[J,"v2","history","sub-key",w,"channel",encodeURIComponent(m)]})},replay:function(a,b){var b=b||a.callback||B(),c=a.auth_key||M,d=a.source,e=a.destination,f=a.stop,g=a.start,h=a.end,j=a.reverse,q=a.limit,p=K(),r={};if(!d)return s("Missing Source Channel");if(!e)return s("Missing Destination Channel");if(!P)return s("Missing Publish Key");
if(!w)return s("Missing Subscribe Key");"0"!=p&&(r.callback=p);f&&(r.stop="all");j&&(r.reverse="true");g&&(r.start=g);h&&(r.end=h);q&&(r.count=q);r.auth=c;E({a:p,c:function(a){m(a,b,err)},b:function(){b([0,"Disconnected"])},url:[J,"v1","replay",P,w,d,e],data:l(r)})},auth:function(a){M=a;d()},time:function(a){var b=K();E({a:b,data:l({uuid:F,auth:M}),timeout:5*D,url:[J,"time",b],c:function(b){a(b[0])},b:function(){a(0)}})},publish:function(a,b){var b=b||a.callback||B(),c=a.message,d=a.channel,e=a.auth_key||
M,f=a.cipher_key,g=a.error||B(),h=a.post||A,j="store_in_history"in a?a.store_in_history:y,p=K(),r="push";a.prepend&&(r="unshift");if(!c)return s("Missing Message");if(!d)return s("Missing Channel");if(!P)return s("Missing Publish Key");if(!w)return s("Missing Subscribe Key");c=JSON.stringify(ba.encrypt(c,f||X)||c);c=[J,"publish",P,w,0,encodeURIComponent(d),p,encodeURIComponent(c)];Y={uuid:F,auth:e};j||(Y.store="0");Q[r]({a:p,timeout:5*D,url:c,data:l(Y),b:function(a){q(a,g);x(1)},c:function(a){m(a,
b,g);x(1)},mode:h?"POST":"GET"});x()},unsubscribe:function(a,b){var c=a.channel,b=b||a.callback||B(),e=a.error||B();da=0;Ja=1;c=ua((c.join?c.join(","):""+c).split(","),function(a){if(C[a])return a+","+a+ha}).join(",");N(c.split(","),function(a){var c=y;a&&(fa&&(c=H.LEAVE(a,0,b,e)),c||b({action:"leave"}),C[a]=0,a in Z&&delete Z[a])});d()},subscribe:function(a,b){function e(a){a?setTimeout(d,D):(J=ma(oa,1),wb=ma(oa,1),setTimeout(function(){H.time(e)},D));u(function(b){if(a&&b.d)return b.d=0,b.p(b.name);
!a&&!b.d&&(b.d=1,b.o(b.name))})}function f(){var a=K(),b=va(C).join(",");if(b){c();var h=l({uuid:F,auth:m});2<JSON.stringify(Z).length&&(h.state=JSON.stringify(Z));R&&(h.heartbeat=R);t();Ha=E({timeout:aa,a:a,b:function(a){q(a,x);H.time(e)},data:l(h),url:[wb,"subscribe",w,encodeURIComponent(b),a,da],c:function(a){if(!a||"object"==typeof a&&"error"in a&&a.error)return x(a.error),setTimeout(d,D);I(a[1]);da=!da&&Ja&&ea.get(w)||a[1];u(function(a){a.g||(a.g=1,a.n(a.name))});if(Ya&&!Ja)da=0,Ya=A,ea.set(w,
0);else{Q&&(da=1E4,Q=0);ea.set(w,a[1]);var b,c=(2<a.length?a[2]:ua(va(C),function(b){return ua(Array(a[0].length).join(",").split(","),function(){return b})}).join(",")).split(",");b=function(){var a=c.shift()||yb;return[(C[a]||{}).a||xb,a.split(ha)[0]]};var e=L()-Va-+a[1]/1E4;N(a[0],function(c){var d=b(),c=g(c,C[d[1]].cipher_key);d[0](c,a,d[1],e)})}setTimeout(f,Y)}})}}var h=a.channel,b=(b=b||a.callback)||a.message,m=a.auth_key||M,j=a.connect||B(),p=a.reconnect||B(),r=a.disconnect||B(),x=a.error||
B(),I=a.idle||B(),G=a.presence||0,P=a.noheresync||0,Q=a.backfill||0,X=a.timetoken||0,aa=a.timeout||Hb,Y=a.windowing||Sa,S=a.state,W=a.heartbeat||a.pnexpires,ba=a.restore;Ja=ba;da=X;if(!h)return s("Missing Channel");if(!b)return s("Missing Callback");if(!w)return s("Missing Subscribe Key");(W||0===W)&&H.set_heartbeat(W);N((h.join?h.join(","):""+h).split(","),function(c){var d=C[c]||{};C[yb=c]={name:c,g:d.g,d:d.d,f:1,a:xb=b,cipher_key:a.cipher_key,n:j,o:r,p:p};S&&(Z[c]=c in S?S[c]:S);G&&(H.subscribe({channel:c+
ha,callback:G,restore:ba}),!d.f&&!P&&H.here_now({channel:c,callback:function(a){N("uuids"in a?a.uuids:[],function(b){G({action:"join",uuid:b,timestamp:L(),occupancy:a.occupancy||1},a,c)})}}))});d=function(){c();setTimeout(f,Y)};if(!fa)return ga.push(d);d()},here_now:function(a,b){var b=a.callback||b,c=a.error||B(),d=a.auth_key||M,e=a.channel,f=K(),g=a.state,d={uuid:F,auth:d};if(!("uuids"in a?a.uuids:1))d.disable_uuids=1;g&&(d.state=1);if(!b)return s("Missing Callback");if(!w)return s("Missing Subscribe Key");
g=[J,"v2","presence","sub_key",w];e&&g.push("channel")&&g.push(encodeURIComponent(e));"0"!=f&&(d.callback=f);E({a:f,data:l(d),c:function(a){m(a,b,c)},b:function(a){q(a,c)},url:g})},where_now:function(a,b){var b=a.callback||b,c=a.error||B(),d=a.auth_key||M,e=K(),f=a.uuid||F,d={auth:d};if(!b)return s("Missing Callback");if(!w)return s("Missing Subscribe Key");"0"!=e&&(d.callback=e);E({a:e,data:l(d),c:function(a){m(a,b,c)},b:function(a){q(a,c)},url:[J,"v2","presence","sub_key",w,"uuid",encodeURIComponent(f)]})},
state:function(a,b){var b=a.callback||b||B(),c=a.error||B(),d=a.auth_key||M,e=K(),f=a.state,g=a.uuid||F,h=a.channel,d=l({auth:d});if(!w)return s("Missing Subscribe Key");if(!g)return s("Missing UUID");if(!h)return s("Missing Channel");"0"!=e&&(d.callback=e);C[h]&&(C[h].f&&f)&&(Z[h]=f);d.state=JSON.stringify(f);f=f?[J,"v2","presence","sub-key",w,"channel",encodeURIComponent(h),"uuid",g,"data"]:[J,"v2","presence","sub-key",w,"channel",encodeURIComponent(h),"uuid",encodeURIComponent(g)];E({a:e,data:l(d),
c:function(a){m(a,b,c)},b:function(a){q(a,c)},url:f})},grant:function(a,b){var b=a.callback||b,c=a.error||B(),d=a.channel,e=K(),f=a.ttl,g=a.read?"1":"0",j=a.write?"1":"0",p=a.auth_key;if(!b)return s("Missing Callback");if(!w)return s("Missing Subscribe Key");if(!P)return s("Missing Publish Key");if(!Ia)return s("Missing Secret Key");var r=w+"\n"+P+"\ngrant\n",g={w:j,r:g,timestamp:Math.floor((new Date).getTime()/1E3)};"undefined"!=d&&(d!=z&&0<d.length)&&(g.channel=d);"0"!=e&&(g.callback=e);if(f||0===
f)g.ttl=f;p&&(g.auth=p);g=l(g);p||delete g.auth;r+=h(g);d=vb(r,Ia);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");g.signature=d;E({a:e,data:g,c:function(a){m(a,b,c)},b:function(a){q(a,c)},url:[J,"v1","auth","grant","sub-key",w]})},audit:function(a,b){var b=a.callback||b,c=a.error||B(),d=a.channel,e=a.auth_key,f=K();if(!b)return s("Missing Callback");if(!w)return s("Missing Subscribe Key");if(!P)return s("Missing Publish Key");if(!Ia)return s("Missing Secret Key");var g=w+"\n"+P+"\naudit\n",j={timestamp:Math.floor((new Date).getTime()/
1E3)};"0"!=f&&(j.callback=f);"undefined"!=d&&(d!=z&&0<d.length)&&(j.channel=d);e&&(j.auth=e);j=l(j);e||delete j.auth;g+=h(j);d=vb(g,Ia);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");j.signature=d;E({a:f,data:j,c:function(a){m(a,b,c)},b:function(a){q(a,c)},url:[J,"v1","auth","audit","sub-key",w]})},revoke:function(a,b){a.read=A;a.write=A;H.grant(a,b)},set_uuid:function(a){F=a;d()},get_uuid:function(){return F},presence_heartbeat:function(a){var b=a.callback||B(),c=a.error||B(),a=K(),d={uuid:F,auth:M};
2<JSON.stringify(Z).length&&(d.state=JSON.stringify(Z));0<R&&320>R&&(d.heartbeat=R);"0"!=a&&(d.callback=a);var e=E,d=l(d),f=5*D,g=J,h=w,j=va(C,y).join(",");e({a:a,data:d,timeout:f,url:[g,"v2","presence","sub-key",h,"channel",encodeURIComponent(j),"heartbeat"],c:function(a){m(a,b,c)},b:function(a){q(a,c)}})},xdr:E,ready:wa,db:ea,uuid:pa,map:ua,each:N,"each-channel":u,grep:sa,offline:function(){c(1,{message:"Offline. Please check your network settings."})},supplant:ta,now:L,unique:la,updater:ra};F||
(F=H.uuid());ea.set(w+"uuid",F);setTimeout(p,D);setTimeout(f,ob);W=setTimeout(t,(I-3)*D);b();var G=H,Ka;for(Ka in G)G.hasOwnProperty(Ka)&&(e[Ka]=G[Ka]);e.css=sb;e.$=mb;e.create=tb;e.bind=qb;e.head=rb;e.search=pb;e.attr=V;e.events=Gb;e.init=e;e.secure=e;qb("beforeunload",window,function(){if(Ra)e["each-channel"](function(a){e.LEAVE(a.name,0)});return y});if(a.notest)return e;qb("offline",window,e.offline);qb("offline",document,e.offline);return e};Jb.init=Jb;Jb.secure=Jb;"complete"===document.readyState?
setTimeout(wa,0):qb("load",window,function(){setTimeout(wa,0)});var Kb=Ib||{};PUBNUB=Jb({notest:1,publish_key:V(Kb,"pub-key"),subscribe_key:V(Kb,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==V(Kb,"ssl"),origin:V(Kb,"origin"),uuid:V(Kb,"uuid")});window.jQuery&&(window.jQuery.PUBNUB=Jb);"undefined"!==typeof module&&(module.exports=PUBNUB)&&wa();var Db=mb("pubnubs")||0;if(Ib){sb(Ib,{position:"absolute",top:-D});if("opera"in window||V(Ib,"flash"))Ib.innerHTML="<object id=pubnubs data=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=movie value=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=allowscriptaccess value=always></object>";
PUBNUB.rdx=function(a,d){if(!d)return $[a].onerror();$[a].responseText=unescape(d);$[a].onload()};$.id=D}}
...
B();b.binaryType="";b.extensions="";b.bufferedAmount=0;b.trasnmitting=A;b.buffer=[];b.readyState=b.CONNECTING;if(!a)return b.readyState=b.CLOSED,b.onclose({code:b.CLOSE_ABNORMAL,reason:"Missing URL",wasClean:y}),b;b.e=PUBNUB.init(c);b.e.k=c;b.k=c;b.e.subscribe({restore:A,channel:c.channel,disconnect:b.onerror,reconnect:b.onopen,error:function(){b.onclose({code:b.CLOSE_ABNORMAL,reason:"Missing URL",wasClean:A})},callback:function(a){b.onmessage({data:a})},connect:function(){b.readyState=b.OPEN;b.onopen()}})};
