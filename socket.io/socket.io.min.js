...
window.JSON&&window.JSON.stringify||function(){function a(){try{return this.valueOf()}catch(a){return y}}function c(a){e.lastIndex=0;return e.test(a)?'"'+a.replace(e,function(a){var b=E[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function b(e,ba){var K,g,N,u,G,E=f,s=ba[e];s&&"object"===typeof s&&(s=a.call(s));"function"===typeof q&&(s=q.call(ba,e,s));switch(typeof s){case "string":return c(s);case "number":return isFinite(s)?String(s):"null";
case "boolean":case "null":return String(s);case "object":if(!s)return"null";f+=w;G=[];if("[object Array]"===Object.prototype.toString.apply(s)){u=s.length;for(K=0;K<u;K+=1)G[K]=b(K,s)||"null";N=0===G.length?"[]":f?"[\n"+f+G.join(",\n"+f)+"\n"+E+"]":"["+G.join(",")+"]";f=E;return N}if(q&&"object"===typeof q){u=q.length;for(K=0;K<u;K+=1)g=q[K],"string"===typeof g&&(N=b(g,s))&&G.push(c(g)+(f?": ":":")+N)}else for(g in s)Object.hasOwnProperty.call(s,g)&&(N=b(g,s))&&G.push(c(g)+(f?": ":":")+N);N=0===
...
y,clearTimeout(V),a||!b||La(b),setTimeout(function(){a&&Ma();var b=Na(B),c=b&&b.parentNode;c&&c.removeChild(b)},F))}if($a||ab()){a:{var b,e,f=function(){if(!E){E=1;clearTimeout(p);try{e=JSON.parse(b.responseText)}catch(a){return u(1)}w=1;g(e)}},w=0,E=0,q=a.timeout||1E4,p=setTimeout(function(){u(1,{message:"timeout"})},q),ba=a.b||C(),K=a.data||{},g=a.c||C(),N=!a.h,u=function(a,c){w||(w=1,clearTimeout(p),b&&(b.onerror=b.onload=y,b.abort&&b.abort(),b=y),a&&ba(c))};try{b=ab()||window.XDomainRequest&&
new XDomainRequest||new XMLHttpRequest;b.onerror=b.onabort=function(a){u(1,a||b&&b.responseText||{error:"Network Connection Error"})};b.onload=b.onloadend=f;b.onreadystatechange=function(){if(b&&4==b.readyState)switch(b.status){case 200:break;default:try{e=JSON.parse(b.responseText),u(1,e)}catch(a){return u(1,{status:b.status,o:y,message:b.responseText})}}};var G=ra(a.url,K);b.open("GET",G,N);N&&(b.timeout=q);b.send()}catch(Ha){u(0);$a=0;a=eb(a);break a}a=u}return a}var s=Za("script"),f=a.a,B=na(),
...
function(b){if(b=I[b])a++,(i||C())(b)});return a}function K(a){var b=0;$(Aa(S),function(c){if(c=S[c])b++,(a||C())(c)})}function g(a){if(Bb){if(!W.length)return}else{a&&(W.l=0);if(W.l||!W.length)return;W.l=1}L(W.shift())}function N(){!Qa&&u()}function u(){clearTimeout(Ca);!Q||500<=Q||1>Q||!za(I,r).length&&!Aa(S,r).length?Qa=A:(Qa=r,x.presence_heartbeat({callback:function(){Ca=setTimeout(u,Q*F)},error:function(a){m&&m("Presence Heartbeat unable to reach Pubnub servers."+JSON.stringify(a));Ca=setTimeout(u,
Q*F)}}))}function G(a,b){return Da.decrypt(a,b||ka)||Da.decrypt(a,ka)||a}function Ha(a,b,c){var d=A;if("undefined"===typeof a)return b;if("number"===typeof a)d=5<a||0==a?A:r;else{if("boolean"===typeof a)return a?30:0;d=r}return d?(c&&c("Presence Heartbeat value invalid. Valid range ( x > 5 or x = 0). Current Value : "+(b||5)),b||5):a}function s(a){var b="",c=[];$(a,function(a){c.push(a)});var d=c.sort(),j;for(j in d){var v=d[j],b=b+(v+"="+ya(a[v]));j!=d.length-1&&(b+="&")}return b}function B(a){a||
(a={});$(R,function(b,c){b in a||(a[b]=c)});return a}function l(a){return zb(a)}$a=a.jsonp?0:-1==mb.indexOf("MSIE 6");var V=a.subscribe_key||"";a.uuid||nb.get(V+"uuid");var Ma=a.leave_on_unload||0;a.xdr=eb;a.db=nb;a.error=a.error||Oa;a._is_online=gb;a.jsonp_cb=db;a.hmac_SHA256=Ka;a.crypto_obj=Ja();a.params={pnsdk:"PubNub-JS-Web/3.7.10"};var La=+a.windowing||10,xb=(+a.timeout||310)*F,bb=(+a.keepalive||60)*F,yb=a.timecheck||0,cb=a.noleave||0,P=a.publish_key||"demo",t=a.subscribe_key||"demo",D=a.auth_key||
"",Ea=a.secret_key||"",ib=a.hmac_SHA256,ta=a.ssl?"s":"",la="http"+ta+"://"+(a.origin||"pubsub.pubnub.com"),O=oa(la),jb=oa(la),W=[],Ra=r,Pa=0,Sa=0,kb=0,Ba=0,Fa=a.restore||0,ga=0,Ta=A,I={},S={},X={},Ca=y,T=Ha(a.heartbeat||a.pnexpires||0,a.error),Q=a.heartbeat_interval||T/2-1,Qa=A,Bb=a.no_wait_for_pending,lb=a["compatible_3.5"]||A,L=a.xdr,R=a.params||{},m=a.error||C(),Ab=a._is_online||function(){return 1},M=a.jsonp_cb||function(){return 0},ha=a.db||{get:C(),set:C()},ka=a.cipher_key,J=a.uuid||!a.unique_uuid&&
ha&&ha.get(t+"uuid")||"",Z=a.instance_id||A,U="",Y,ja;2===T&&(Q=1);var Da=a.crypto_obj||{encrypt:function(a){return a},decrypt:function(a){return a}},x={LEAVE:function(a,b,c,d,j){var c={uuid:J,auth:c||D},v=oa(la),d=d||C(),z=j||C(),j=M();if(0<a.indexOf(ea))return r;if(lb&&(!ta||"0"==j)||cb)return A;"0"!=j&&(c.callback=j);Z&&(c.instanceid=U);L({h:b||ta,timeout:2E3,a:j,data:B(c),c:function(a){p(a,d,z)},b:function(a){q(a,z)},url:[v,"v2","presence","sub_key",t,"channel",encodeURIComponent(a),"leave"]});
...
a},raw_encrypt:function(a,b){return Da.encrypt(a,b||ka)||a},raw_decrypt:function(a,b){return G(a,b)},get_heartbeat:function(){return T},set_heartbeat:function(a,b){T=Ha(a,T,m);Q=b||T/2-1;2==T&&(Q=1);c();u()},get_heartbeat_interval:function(){return Q},set_heartbeat_interval:function(a){Q=a;u()},get_version:function(){return"3.7.10"},getGcmMessageObject:function(a){return{data:a}},getApnsMessageObject:function(a){var b={aps:{badge:1,alert:""}};for(k in a)k[b]=a[k];return b},newPnMessage:function(){var a=
...
z=a.start,h=a.end,e=a.reverse,f=a.limit,q=M(),g={};if(!d)return m("Missing Source Channel");if(!j)return m("Missing Destination Channel");if(!P)return m("Missing Publish Key");if(!t)return m("Missing Subscribe Key");"0"!=q&&(g.callback=q);v&&(g.stop="all");e&&(g.reverse="true");z&&(g.start=z);h&&(g.end=h);f&&(g.count=f);g.auth=c;L({a:q,c:function(a){p(a,b,err)},b:function(){b([0,"Disconnected"])},url:[O,"v1","replay",P,t,d,j],data:B(g)})},auth:function(a){D=a;c()},time:function(a){var b=M(),c={uuid:J,
auth:D};Z&&(c.instanceid=U);L({a:b,data:B(c),timeout:5*F,url:[O,"time",b],c:function(b){a(b[0])},b:function(){a(0)}})},publish:function(a,b){var c=a.message;if(!c)return m("Missing Message");var b=b||a.callback||c.callback||C(),d=a.channel||c.channel,j=a.auth_key||D,v=a.cipher_key,z=a.error||c.error||C(),h=a.post||A,e="store_in_history"in a?a.store_in_history:r,f=M(),s="push";a.prepend&&(s="unshift");if(!d)return m("Missing Channel");if(!P)return m("Missing Publish Key");if(!t)return m("Missing Subscribe Key");
c.getPubnubMessage&&(c=c.getPubnubMessage());c=JSON.stringify(Da.encrypt(c,v||ka)||c);c=[O,"publish",P,t,0,encodeURIComponent(d),f,encodeURIComponent(c)];R={uuid:J,auth:j};e||(R.store="0");Z&&(R.instanceid=U);W[s]({a:f,timeout:5*F,url:c,data:B(R),b:function(a){q(a,z);g(1)},c:function(a){p(a,b,z);g(1)},mode:h?"POST":"GET"});g()},unsubscribe:function(a,b){var e=a.channel,d=a.channel_group,j=a.auth_key||D,b=b||a.callback||C(),f=a.error||C();ga=0;e&&(e=xa((e.join?e.join(","):""+e).split(","),function(a){if(I[a])return a+
","+a+ea}).join(","),$(e.split(","),function(a){var c=r;a&&(I[a]=0,a in X&&delete X[a],ca&&(c=x.LEAVE(a,0,j,b,f)),c||b({action:"leave"}))}));d&&(d=xa((d.join?d.join(","):""+d).split(","),function(a){if(S[a])return a+","+a+ea}).join(","),$(d.split(","),function(a){var c=r;a&&(S[a]=0,a in X&&delete X[a],ca&&(c=x.LEAVE_GROUP(a,0,j,b,f)),c||b({action:"leave"}))}));c()},subscribe:function(a,b){function f(a){a?setTimeout(c,F):(O=oa(la,1),jb=oa(la,1),setTimeout(function(){x.time(f)},F));ba(function(b){if(a&&
b.d)return b.d=0,b.k(b.name);!a&&!b.d&&(b.d=1,b.j(b.name))});K(function(b){if(a&&b.d)return b.d=0,b.k(b.name);!a&&!b.d&&(b.d=1,b.j(b.name))})}function d(){var a=M(),b=za(I).join(","),i=Aa(S).join(",");if(b||i){b||(b=",");e();var j=B({uuid:J,auth:D});i&&(j["channel-group"]=i);2<JSON.stringify(X).length&&(j.state=JSON.stringify(X));T&&(j.heartbeat=T);Z&&(j.instanceid=U);N();Ba=L({timeout:Q,a:a,b:function(a){a&&a.error&&a.service?(q(a,p),f(1)):x.time(function(b){!b&&q(a,p);f(b)})},data:B(j),url:[jb,
"subscribe",t,encodeURIComponent(b),a,ga],c:function(a){if(!a||"object"==typeof a&&"error"in a&&a.error)return p(a.error),setTimeout(c,F);s(a[1]);ga=!ga&&Fa&&ha.get(t)||a[1];ba(function(a){a.f||(a.f=1,a.i(a.name))});K(function(a){a.f||(a.f=1,a.i(a.name))});if(Ta&&!Fa)ga=0,Ta=A,ha.set(t,0);else{w&&(ga=1E4,w=0);ha.set(t,a[1]);var b,i="",j="";3<a.length?(i=a[3],j=a[2]):i=2<a.length?a[2]:xa(za(I),function(b){return xa(Array(a[0].length).join(",").split(","),function(){return b})}).join(",");var e=i.split(","),
f=j?j.split(","):[];b=function(){var a=e.shift()||kb,b=f.shift(),c={};b?(a&&(0<=a.indexOf("-pnpres")&&0>b.indexOf("-pnpres"))&&(b+="-pnpres"),c=S[b]||I[b]||{callback:C()}):c=I[a];a=[c.a||Sa,a.split(ea)[0]];b&&a.push(b.split(ea)[0]);return a};var h=H()-Pa-+a[1]/1E4;$(a[0],function(c){var i=b(),c=G(c,I[i[1]]?I[i[1]].cipher_key:y);i[0]&&i[0](c,a,i[2]||i[1],h,i[1])})}setTimeout(d,R)}})}}var j=a.channel,v=a.channel_group,b=(b=b||a.callback)||a.message,z=a.connect||C(),h=a.reconnect||C(),g=a.disconnect||
C(),p=a.error||p||C(),s=a.idle||C(),l=a.presence||0,u=a.noheresync||0,w=a.backfill||0,E=a.timetoken||0,Q=a.timeout||xb,R=a.windowing||La,P=a.state,V=a.heartbeat||a.pnexpires,W=a.heartbeat_interval,Y=a.restore||Fa;D=a.auth_key||D;Fa=Y;ga=E;if(!j&&!v)return m("Missing Channel");if(!b)return m("Missing Callback");if(!t)return m("Missing Subscribe Key");(V||0===V||W||0===W)&&x.set_heartbeat(V,W);j&&$((j.join?j.join(","):""+j).split(","),function(c){var d=I[c]||{};I[kb=c]={name:c,f:d.f,d:d.d,e:1,a:Sa=
b,cipher_key:a.cipher_key,i:z,j:g,k:h};P&&(X[c]=c in P?P[c]:P);l&&(x.subscribe({channel:c+ea,callback:l,restore:Y}),!d.e&&!u&&x.here_now({channel:c,data:B({uuid:J,auth:D}),callback:function(a){$("uuids"in a?a.uuids:[],function(b){l({action:"join",uuid:b,timestamp:Math.floor(H()/1E3),occupancy:a.occupancy||1},a,c)})}}))});v&&$((v.join?v.join(","):""+v).split(","),function(c){var d=S[c]||{};S[c]={name:c,f:d.f,d:d.d,e:1,a:Sa=b,cipher_key:a.cipher_key,i:z,j:g,k:h};l&&(x.subscribe({channel_group:c+ea,
callback:l,restore:Y,auth_key:D}),!d.e&&!u&&x.here_now({channel_group:c,data:B({uuid:J,auth:D}),callback:function(a){$("uuids"in a?a.uuids:[],function(b){l({action:"join",uuid:b,timestamp:Math.floor(H()/1E3),occupancy:a.occupancy||1},a,c)})}}))});c=function(){e();setTimeout(d,R)};if(!ca)return da.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.error||C(),d=a.auth_key||D,j=a.channel,e=a.channel_group,f=M(),h=a.state,d={uuid:J,auth:d};if(!("uuids"in a?a.uuids:1))d.disable_uuids=1;h&&(d.state=
1);if(!b)return m("Missing Callback");if(!t)return m("Missing Subscribe Key");h=[O,"v2","presence","sub_key",t];j&&h.push("channel")&&h.push(encodeURIComponent(j));"0"!=f&&(d.callback=f);e&&(d["channel-group"]=e,!j&&h.push("channel")&&h.push(","));Z&&(d.instanceid=U);L({a:f,data:B(d),c:function(a){p(a,b,c)},b:function(a){q(a,c)},url:h})},where_now:function(a,b){var b=a.callback||b,c=a.error||C(),d=a.auth_key||D,j=M(),e=a.uuid||J,d={auth:d};if(!b)return m("Missing Callback");if(!t)return m("Missing Subscribe Key");
"0"!=j&&(d.callback=j);Z&&(d.instanceid=U);L({a:j,data:B(d),c:function(a){p(a,b,c)},b:function(a){q(a,c)},url:[O,"v2","presence","sub_key",t,"uuid",encodeURIComponent(e)]})},state:function(a,b){var b=a.callback||b||C(),c=a.error||C(),d=a.auth_key||D,j=M(),e=a.state,f=a.uuid||J,h=a.channel,g=a.channel_group,d=B({auth:d});if(!t)return m("Missing Subscribe Key");if(!f)return m("Missing UUID");if(!h&&!g)return m("Missing Channel");"0"!=j&&(d.callback=j);"undefined"!=typeof h&&I[h]&&I[h].e&&e&&(X[h]=e);
...
if(!f)return m("Missing gw destination Channel (channel)");if(!P)return m("Missing Publish Key");if(!t)return m("Missing Subscribe Key");a=[O,"v1/push/sub-key",t,"devices",a];R={uuid:J,auth:c,type:h};"add"==g?R.add=f:"remove"==g&&(R.remove=f);Z&&(data.instanceid=U);L({a:e,data:R,c:function(a){p(a,b,d)},b:function(a){q(a,d)},url:a})},audit:function(a,b){var b=a.callback||b,c=a.error||C(),d=a.channel,e=a.channel_group,f=a.auth_key,g=M();if(!b)return m("Missing Callback");if(!t)return m("Missing Subscribe Key");
if(!P)return m("Missing Publish Key");if(!Ea)return m("Missing Secret Key");var h=t+"\n"+P+"\naudit\n",l={timestamp:Math.floor((new Date).getTime()/1E3)};"0"!=g&&(l.callback=g);"undefined"!=typeof d&&(d!=y&&0<d.length)&&(l.channel=d);"undefined"!=typeof e&&(e!=y&&0<e.length)&&(l["channel-group"]=e);f&&(l.auth=f);l=B(l);f||delete l.auth;h+=s(l);d=ib(h,Ea);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");l.signature=d;L({a:g,data:l,c:function(a){p(a,b,c)},b:function(a){q(a,c)},url:[O,"v1","auth","audit",
"sub-key",t]})},revoke:function(a,b){a.read=A;a.write=A;x.grant(a,b)},set_uuid:function(a){J=a;c()},get_uuid:function(){return J},isArray:function(a){return wa(a)},get_subscibed_channels:function(){return za(I,r)},presence_heartbeat:function(a){var b=a.callback||C(),c=a.error||C(),a=M(),d={uuid:J,auth:D};2<JSON.stringify(X).length&&(d.state=JSON.stringify(X));0<T&&320>T&&(d.heartbeat=T);"0"!=a&&(d.callback=a);var e;e=za(I,r).join(",");e=encodeURIComponent(e);var f=Aa(S,r).join(",");e||(e=",");f&&
(d["channel-group"]=f);Z&&(d.instanceid=U);L({a:a,data:B(d),timeout:5*F,url:[O,"v2","presence","sub-key",t,"channel",e,"heartbeat"],c:function(a){p(a,b,c)},b:function(a){q(a,c)}})},stop_timers:function(){clearTimeout(Y);clearTimeout(ja)},xdr:L,ready:Ia,db:ha,uuid:qa,map:xa,each:$,"each-channel":ba,grep:ua,offline:function(){e(1,{message:"Offline. Please check your network settings."})},supplant:va,now:H,unique:na,updater:sa};J||(J=x.uuid());U||(U=x.uuid());ha.set(t+"uuid",J);Y=setTimeout(w,F);ja=
setTimeout(f,bb);Ca=setTimeout(N,(Q-3)*F);b();var V=x,Ga;for(Ga in V)V.hasOwnProperty(Ga)&&(l[Ga]=V[Ga]);l.css=Ya;l.$=Na;l.create=Za;l.bind=Va;l.head=Wa;l.search=Ua;l.attr=Xa;l.events=vb;l.init=l;l.secure=l;l.crypto_obj=Ja();Va("beforeunload",window,function(){if(Ma)l["each-channel"](function(a){l.LEAVE(a.name,0)});return r});if(a.notest)return l;Va("offline",window,l.offline);Va("offline",document,l.offline);return l};zb.init=zb;zb.secure=zb;zb.crypto_obj=Ja();"complete"===document.readyState?setTimeout(Ia,
