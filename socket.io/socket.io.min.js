...
b){return Ca.encrypt(a,b||ja)||a},raw_decrypt:function(a,b){return G(a,b)},get_heartbeat:function(){return T},set_heartbeat:function(a,b){T=Ga(a,T,m);P=b||T/2-1;2==T&&(P=1);c();u()},get_heartbeat_interval:function(){return P},set_heartbeat_interval:function(a){P=a;u()},get_version:function(){return"3.7.12"},getGcmMessageObject:function(a){return{data:a}},getApnsMessageObject:function(a){var b={aps:{badge:1,alert:""}};for(k in a)k[b]=a[k];return b},newPnMessage:function(){var a={};gcm&&(a.pn_gcm=gcm);
