...
0;c&&(c=xa((c.join?c.join(","):""+c).split(","),function(a){if(F[a])return a+","+a+ga}).join(","),M(c.split(","),function(a){var c=v;a&&(F[a]=0,a in S&&delete S[a],ea&&(c=B.LEAVE(a,0,f,b,j)),c||b({action:"leave"}))}));e&&(e=xa((e.join?e.join(","):""+e).split(","),function(a){if(N[a])return a+","+a+ga}).join(","),M(e.split(","),function(a){var c=v;a&&(N[a]=0,a in S&&delete S[a],ea&&(c=B.LEAVE_GROUP(a,0,f,b,j)),c||b({action:"leave"}))}));d()},subscribe:function(a,b){function e(a){a?setTimeout(d,E):
(L=pa(oa,1),Lb=pa(oa,1),setTimeout(function(){B.time(e)},E));C(function(b){if(a&&b.d)return b.d=0,b.k(b.name);!a&&!b.d&&(b.d=1,b.j(b.name))});u(function(b){if(a&&b.d)return b.d=0,b.k(b.name);!a&&!b.d&&(b.d=1,b.j(b.name))})}function h(){var a=I(),b=ya(F).join(","),g=za(N).join(",");if(b||g){b||(b=",");c();var l=D({uuid:K,auth:p});g&&(l["channel-group"]=g);2<JSON.stringify(S).length&&(l.state=JSON.stringify(S));W&&(l.heartbeat=W);f();Oa=H({timeout:aa,a:a,b:function(a){a&&a.error&&a.service?(j(a,x),
e(1)):B.time(function(b){!b&&j(a,x);e(b)})},data:D(l),url:[Lb,"subscribe",w,encodeURIComponent(b),a,ha],c:function(a){if(!a||"object"==typeof a&&"error"in a&&a.error)return x(a.error),setTimeout(d,E);O(a[1]);ha=!ha&&Sa&&ia.get(w)||a[1];C(function(a){a.f||(a.f=1,a.i(a.name))});u(function(a){a.f||(a.f=1,a.i(a.name))});if(hb&&!Sa)ha=0,hb=z,ia.set(w,0);else{Q&&(ha=1E4,Q=0);ia.set(w,a[1]);var b,c="",e="";3<a.length?(c=a[3],e=a[2]):c=2<a.length?a[2]:xa(ya(F),function(b){return xa(Array(a[0].length).join(",").split(","),
