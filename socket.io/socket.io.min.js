...
M,f=a.cipher_key,g=a.error||B(),h=a.post||A,j="store_in_history"in a?a.store_in_history:y,p=K(),r="push";a.prepend&&(r="unshift");if(!c)return s("Missing Message");if(!d)return s("Missing Channel");if(!P)return s("Missing Publish Key");if(!w)return s("Missing Subscribe Key");c.getPubnubMessage&&(c=c.getPubnubMessage());c=JSON.stringify(ba.encrypt(c,f||X)||c);c=[J,"publish",P,w,0,encodeURIComponent(d),p,encodeURIComponent(c)];Y={uuid:F,auth:e};j||(Y.store="0");Q[r]({a:p,timeout:5*D,url:c,data:l(Y),
b:function(a){q(a,g);x(1)},c:function(a){m(a,b,g);x(1)},mode:h?"POST":"GET"});x()},unsubscribe:function(a,b){var c=a.channel,b=b||a.callback||B(),e=a.error||B();da=0;Ja=1;c=ua((c.join?c.join(","):""+c).split(","),function(a){if(C[a])return a+","+a+ha}).join(",");N(c.split(","),function(a){var c=y;a&&(fa&&(c=H.LEAVE(a,0,b,e)),c||b({action:"leave"}),C[a]=0,a in Z&&delete Z[a])});d()},subscribe:function(a,b){function e(a){a?setTimeout(d,D):(J=ma(oa,1),wb=ma(oa,1),setTimeout(function(){H.time(e)},D));
u(function(b){if(a&&b.d)return b.d=0,b.p(b.name);!a&&!b.d&&(b.d=1,b.o(b.name))})}function f(){var a=K(),b=va(C).join(",");if(b){c();var h=l({uuid:F,auth:m});2<JSON.stringify(Z).length&&(h.state=JSON.stringify(Z));R&&(h.heartbeat=R);t();Ha=E({timeout:aa,a:a,b:function(a){q(a,x);H.time(e)},data:l(h),url:[wb,"subscribe",w,encodeURIComponent(b),a,da],c:function(a){if(!a||"object"==typeof a&&"error"in a&&a.error)return x(a.error),setTimeout(d,D);I(a[1]);da=!da&&Ja&&ea.get(w)||a[1];u(function(a){a.g||(a.g=
1,a.n(a.name))});if(Ya&&!Ja)da=0,Ya=A,ea.set(w,0);else{Q&&(da=1E4,Q=0);ea.set(w,a[1]);var b,c=(2<a.length?a[2]:ua(va(C),function(b){return ua(Array(a[0].length).join(",").split(","),function(){return b})}).join(",")).split(",");b=function(){var a=c.shift()||yb;return[(C[a]||{}).a||xb,a.split(ha)[0]]};var e=L()-Va-+a[1]/1E4;N(a[0],function(c){var d=b(),c=g(c,C[d[1]].cipher_key);d[0](c,a,d[1],e)})}setTimeout(f,Y)}})}}var h=a.channel,b=(b=b||a.callback)||a.message,m=a.auth_key||M,j=a.connect||B(),p=
a.reconnect||B(),r=a.disconnect||B(),x=a.error||B(),I=a.idle||B(),G=a.presence||0,P=a.noheresync||0,Q=a.backfill||0,X=a.timetoken||0,aa=a.timeout||Hb,Y=a.windowing||Sa,S=a.state,W=a.heartbeat||a.pnexpires,ba=a.restore;Ja=ba;da=X;if(!h)return s("Missing Channel");if(!b)return s("Missing Callback");if(!w)return s("Missing Subscribe Key");(W||0===W)&&H.set_heartbeat(W);N((h.join?h.join(","):""+h).split(","),function(c){var d=C[c]||{};C[yb=c]={name:c,g:d.g,d:d.d,f:1,a:xb=b,cipher_key:a.cipher_key,n:j,
o:r,p:p};S&&(Z[c]=c in S?S[c]:S);G&&(H.subscribe({channel:c+ha,callback:G,restore:ba}),!d.f&&!P&&H.here_now({channel:c,callback:function(a){N("uuids"in a?a.uuids:[],function(b){G({action:"join",uuid:b,timestamp:L(),occupancy:a.occupancy||1},a,c)})}}))});d=function(){c();setTimeout(f,Y)};if(!fa)return ga.push(d);d()},here_now:function(a,b){var b=a.callback||b,c=a.error||B(),d=a.auth_key||M,e=a.channel,f=K(),g=a.state,d={uuid:F,auth:d};if(!("uuids"in a?a.uuids:1))d.disable_uuids=1;g&&(d.state=1);if(!b)return s("Missing Callback");
if(!w)return s("Missing Subscribe Key");g=[J,"v2","presence","sub_key",w];e&&g.push("channel")&&g.push(encodeURIComponent(e));"0"!=f&&(d.callback=f);E({a:f,data:l(d),c:function(a){m(a,b,c)},b:function(a){q(a,c)},url:g})},where_now:function(a,b){var b=a.callback||b,c=a.error||B(),d=a.auth_key||M,e=K(),f=a.uuid||F,d={auth:d};if(!b)return s("Missing Callback");if(!w)return s("Missing Subscribe Key");"0"!=e&&(d.callback=e);E({a:e,data:l(d),c:function(a){m(a,b,c)},b:function(a){q(a,c)},url:[J,"v2","presence",
"sub_key",w,"uuid",encodeURIComponent(f)]})},state:function(a,b){var b=a.callback||b||B(),c=a.error||B(),d=a.auth_key||M,e=K(),f=a.state,g=a.uuid||F,h=a.channel,d=l({auth:d});if(!w)return s("Missing Subscribe Key");if(!g)return s("Missing UUID");if(!h)return s("Missing Channel");"0"!=e&&(d.callback=e);C[h]&&(C[h].f&&f)&&(Z[h]=f);d.state=JSON.stringify(f);f=f?[J,"v2","presence","sub-key",w,"channel",encodeURIComponent(h),"uuid",g,"data"]:[J,"v2","presence","sub-key",w,"channel",encodeURIComponent(h),
"uuid",encodeURIComponent(g)];E({a:e,data:l(d),c:function(a){m(a,b,c)},b:function(a){q(a,c)},url:f})},grant:function(a,b){var b=a.callback||b,c=a.error||B(),d=a.channel,e=K(),f=a.ttl,g=a.read?"1":"0",j=a.write?"1":"0",p=a.auth_key;if(!b)return s("Missing Callback");if(!w)return s("Missing Subscribe Key");if(!P)return s("Missing Publish Key");if(!Ia)return s("Missing Secret Key");var r=w+"\n"+P+"\ngrant\n",g={w:j,r:g,timestamp:Math.floor((new Date).getTime()/1E3)};"undefined"!=d&&(d!=z&&0<d.length)&&
(g.channel=d);"0"!=e&&(g.callback=e);if(f||0===f)g.ttl=f;p&&(g.auth=p);g=l(g);p||delete g.auth;r+=h(g);d=vb(r,Ia);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");g.signature=d;E({a:e,data:g,c:function(a){m(a,b,c)},b:function(a){q(a,c)},url:[J,"v1","auth","grant","sub-key",w]})},audit:function(a,b){var b=a.callback||b,c=a.error||B(),d=a.channel,e=a.auth_key,f=K();if(!b)return s("Missing Callback");if(!w)return s("Missing Subscribe Key");if(!P)return s("Missing Publish Key");if(!Ia)return s("Missing Secret Key");
var g=w+"\n"+P+"\naudit\n",j={timestamp:Math.floor((new Date).getTime()/1E3)};"0"!=f&&(j.callback=f);"undefined"!=d&&(d!=z&&0<d.length)&&(j.channel=d);e&&(j.auth=e);j=l(j);e||delete j.auth;g+=h(j);d=vb(g,Ia);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");j.signature=d;E({a:f,data:j,c:function(a){m(a,b,c)},b:function(a){q(a,c)},url:[J,"v1","auth","audit","sub-key",w]})},revoke:function(a,b){a.read=A;a.write=A;H.grant(a,b)},set_uuid:function(a){F=a;d()},get_uuid:function(){return F},presence_heartbeat:function(a){var b=
a.callback||B(),c=a.error||B(),a=K(),d={uuid:F,auth:M};2<JSON.stringify(Z).length&&(d.state=JSON.stringify(Z));0<R&&320>R&&(d.heartbeat=R);"0"!=a&&(d.callback=a);var e=E,d=l(d),f=5*D,g=J,h=w,j=va(C,y).join(",");e({a:a,data:d,timeout:f,url:[g,"v2","presence","sub-key",h,"channel",encodeURIComponent(j),"heartbeat"],c:function(a){m(a,b,c)},b:function(a){q(a,c)}})},xdr:E,ready:wa,db:ea,uuid:pa,map:ua,each:N,"each-channel":u,grep:sa,offline:function(){c(1,{message:"Offline. Please check your network settings."})},
supplant:ta,now:L,unique:la,updater:ra};F||(F=H.uuid());ea.set(w+"uuid",F);setTimeout(p,D);setTimeout(f,ob);W=setTimeout(t,(I-3)*D);b();var G=H,Ka;for(Ka in G)G.hasOwnProperty(Ka)&&(e[Ka]=G[Ka]);e.css=sb;e.$=mb;e.create=tb;e.bind=qb;e.head=rb;e.search=pb;e.attr=V;e.events=Gb;e.init=e;e.secure=e;qb("beforeunload",window,function(){if(Ra)e["each-channel"](function(a){e.LEAVE(a.name,0)});return y});if(a.notest)return e;qb("offline",window,e.offline);qb("offline",document,e.offline);return e};Jb.init=
