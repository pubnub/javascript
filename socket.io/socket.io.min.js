...
window.JSON&&window.JSON.stringify||function(){function a(){try{return this.valueOf()}catch(a){return l}}function c(a){d.lastIndex=0;return d.test(a)?'"'+a.replace(d,function(a){var b=F[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function b(d,g){var r,h,s,q,i,j=e,f=g[d];f&&"object"===typeof f&&(f=a.call(f));"function"===typeof p&&(f=p.call(g,d,f));switch(typeof f){case "string":return c(f);case "number":return isFinite(f)?String(f):"null";case "boolean":case "null":return String(f);
...
function qa(){setTimeout(function(){w||(w=1,P(ba,function(a){a()}))},E)}
...
(N=1,f.onerror=l,clearTimeout(da),a||!b||O(b),setTimeout(function(){a&&J();var b=sa(x),c=b&&b.parentNode;c&&c.removeChild(b)},E))}if(Ba||W()){a:{var b,d,e=function(){if(!F){F=1;clearTimeout(X);try{d=JSON.parse(b.responseText)}catch(a){return q(1)}u=1;h(d)}},u=0,F=0,p=a.timeout||1E4,X=setTimeout(function(){q(1)},p),g=a.b||v(),r=a.data||{},h=a.c||v(),s="undefined"===typeof a.g,q=function(a,c){u||(u=1,clearTimeout(X),b&&(b.onerror=b.onload=l,b.abort&&b.abort(),b=l),a&&g(c))};try{b=W()||window.XDomainRequest&&
...
Y.list[a]||[]).push(c)},fire:function(a,c){P(Y.list[a]||[],function(a){a(c)})}},Z=sa("pubnub")||0,Ka=function(a){function c(){}function b(a,b){function c(b){b&&(ha=G()-(b/1E4+(G()-d)/2),a&&a(ha))}var d=G();b&&c(b)||y.time(c)}function d(a,b){Q&&Q(a,b);Q=l}function e(){y.time(function(a){b(v(),a);a||d(1,{error:"Heartbeat failed to connect to Pubnub Servers.Please check your network settings."});setTimeout(e,s)})}function u(){Ma()||d(1,{error:"Offline. Please check your network settings. "});setTimeout(u,
E)}function F(a){var b=0;P(pa(L),function(c){if(c=L[c])b++,(a||v())(c)});return b}function p(a){a&&(K.h=0);!K.h&&K.length&&(K.h=1,z(K.shift()))}a.jsonp&&(Ba=0);var X=a.subscribe_key||"";a.uuid||Ia.get(X+"uuid");a.xdr=Ea;a.db=Ia;a.error=ta;a._is_online=Ga;a.jsonp_cb=Ca;a.PNSDK=Da;a.hmac_SHA256=ra;var g,r=+a.windowing||10,h=(+a.timeout||310)*E,s=(+a.keepalive||60)*E,q=a.noleave||0,i=a.publish_key||"demo",j=a.subscribe_key||"demo",f=a.auth_key||"",x=a.secret_key||"",N=a.PNSDK||"",da=a.hmac_SHA256,J=
a.ssl?"s":"",O="http"+J+"://"+(a.origin||"pubsub.pubnub.com"),I=H(O),va=H(O),K=[],ha=0,ya=0,za=0,Q=0,la=0,R=0,L={},z=a.xdr,k=a.error||v(),Ma=a._is_online||function(){return 1},D=a.jsonp_cb||function(){return 0},S=a.db||{get:v(),set:v()},M=a.uuid||S&&S.get(j+"uuid")||"",y={LEAVE:function(a,b){var c={uuid:M,auth:f},d=H(O),e=D();!(0<a.indexOf(C))&&(!q&&J&&"0"!=e)&&("0"!=e&&(c.callback=e),z({g:b||J,timeout:2E3,a:e,data:c,url:[d,"v2","presence","sub_key",j,"channel",encodeURIComponent(a),"leave"]}))},
history:function(a,b){var b=a.callback||b,c=a.count||a.limit||100,d=a.reverse||"false",e=a.error||v(),g=a.auth_key||f,A=a.channel,B=a.start,i=a.end,m={},n=D();if(!A)return k("Missing Channel");if(!b)return k("Missing Callback");if(!j)return k("Missing Subscribe Key");m.stringtoken="true";m.count=c;m.reverse=d;m.auth=g;n&&(m.callback=n);B&&(m.start=B);i&&(m.end=i);z({a:n,data:m,c:function(a){"object"==typeof a&&a.error?e(a):b(a)},b:e,url:[I,"v2","history","sub-key",j,"channel",encodeURIComponent(A)]})},
replay:function(a){var b=b||a.callback||v(),c=a.auth_key||f,d=a.source,e=a.destination,g=a.stop,A=a.start,B=a.end,h=a.reverse,a=a.limit,m=D(),n={};if(!d)return k("Missing Source Channel");if(!e)return k("Missing Destination Channel");if(!i)return k("Missing Publish Key");if(!j)return k("Missing Subscribe Key");"0"!=m&&(n.callback=m);g&&(n.stop="all");h&&(n.reverse="true");A&&(n.start=A);B&&(n.end=B);a&&(n.count=a);n.auth=c;z({a:m,c:function(a){"object"==typeof a&&a.error?err(a):b(a)},b:function(){b([0,
"Disconnected"])},url:[I,"v1","replay",i,j,d,e],data:n})},auth:function(a){f=a;c()},time:function(a){var b=D();z({a:b,data:{uuid:M,auth:f},timeout:5*E,url:[I,"time",b],c:function(b){a(b[0])},b:function(){a(0)}})},publish:function(a,b){var b=b||a.callback||v(),c=a.message,d=a.channel,e=a.auth_key||f,g=a.error||v(),A=D();if(!c)return k("Missing Message");if(!d)return k("Missing Channel");if(!i)return k("Missing Publish Key");if(!j)return k("Missing Subscribe Key");c=JSON.stringify(c);K.push({a:A,timeout:5*
E,url:[I,"publish",i,j,0,encodeURIComponent(d),A,encodeURIComponent(c)],data:{uuid:M,auth:e},b:function(a){g(a);p(1)},c:function(a){"object"==typeof a&&a.error?g(a):b(a);p(1)}});p()},unsubscribe:function(a){a=a.channel;R=0;la=1;a=T((a.join?a.join(","):""+a).split(","),function(a){return a+","+a+C}).join(",");P(a.split(","),function(a){w&&y.LEAVE(a,0);L[a]=0});c()},subscribe:function(a,b){function e(a){a?setTimeout(c,E):(I=H(O,1),va=H(O,1),setTimeout(function(){y.time(e)},E));F(function(b){if(a&&b.d)return b.d=
0,b.m(b.name);!a&&!b.d&&(b.d=1,b.l(b.name))})}function g(){var a=D(),b=pa(L).join(",");b&&(d(),Q=z({timeout:N,a:a,b:function(a){m(a);Q=l;y.time(e)},data:{uuid:M,auth:p},url:[va,"subscribe",j,encodeURIComponent(b),a,R],c:function(a){Q=l;if(!a||"object"==typeof a&&"error"in a&&a.error)return m(a),setTimeout(c,E);n(a[1]);R=!R&&la&&S.get(j)||a[1];F(function(a){a.f||(a.f=1,a.k(a.name))});x&&(R=1E4,x=0);S.set(j,a[1]);var b,d=(2<a.length?a[2]:T(L,function(b){return T(Array(a[0].length).join(",").split(","),
function(){return b})}).join(",")).split(",");b=function(){var a=d.shift()||za;return[(L[a]||{}).a||ya,a.split(C)[0]]};var e=G()-ha-+a[1]/1E4;P(a[0],function(c){var d=b();d[0](c,a,d[1],e)});setTimeout(g,J)}}))}var i=a.channel,b=(b=b||a.callback)||a.message,p=a.auth_key||f,A=a.connect||v(),B=a.reconnect||v(),s=a.disconnect||v(),m=a.error||v(),n=a.idle||v(),q=a.presence||0,u=a.noheresync||0,x=a.backfill||0,K=a.timetoken||0,N=a.timeout||h,J=a.windowing||r;la=a.restore;R=K;if(!i)return k("Missing Channel");
if(!b)return k("Missing Callback");if(!j)return k("Missing Subscribe Key");P((i.join?i.join(","):""+i).split(","),function(a){var c=L[a]||{};L[za=a]={name:a,f:c.f,d:c.d,j:1,a:ya=b,k:A,l:s,m:B};q&&(y.subscribe({channel:a+C,callback:q}),!c.j&&!u&&y.here_now({channel:a,callback:function(b){P("uuids"in b?b.uuids:[],function(c){q({action:"join",uuid:c,timestamp:G(),occupancy:b.occupancy||1},b,a)})}}))});c=function(){d();setTimeout(g,J)};if(!w)return ba.push(c);c()},here_now:function(a,b){var b=a.callback||
b,c=a.error||v(),d=a.auth_key||f,e=a.channel,g=D(),d={uuid:M,auth:d};if(!e)return k("Missing Channel");if(!b)return k("Missing Callback");if(!j)return k("Missing Subscribe Key");"0"!=g&&(d.callback=g);z({a:g,data:d,c:function(a){"object"==typeof a&&a.error?c(a):b(a)},b:c,url:[I,"v2","presence","sub_key",j,"channel",encodeURIComponent(e)]})},grant:function(a,b){var b=a.callback||b,c=a.error||v(),d=a.channel,e=D(),g=a.ttl||-1,f=a.read?"1":"0",B=a.write?"1":"0",h=a.auth_key;if(!d)return k("Missing Channel");
...
m={w:B,r:f,signature:n,channel:encodeURIComponent(d),timestamp:m};-1<g&&(m.ttl=g);h&&(m.auth=encodeURIComponent(h));z({a:e,data:m,c:function(a){b(a)},b:c,url:[I,"v1","auth","grant","sub-key",j]})},audit:function(a,b){var b=a.callback||b,c=a.error||v(),d=a.channel,e=a.auth_key,g=D();if(!b)return k("Missing Callback");if(!j)return k("Missing Subscribe Key");if(!i)return k("Missing Publish Key");if(!x)return k("Missing Secret Key");"0"!=g&&(f.callback=g);var f=Math.floor((new Date).getTime()/1E3),h=
j+"\n"+i+"\naudit\n";e&&(h+="auth="+encodeURIComponent(e)+"&");d&&(h+="channel="+encodeURIComponent(d)+"&");var h=h+("pnsdk="+encodeURIComponent(N)+"&timestamp="+f),h=da(h,x),h=h.replace(/\+/g,"-"),h=h.replace(/\//g,"_"),f={signature:h,timestamp:f};d&&(f.channel=encodeURIComponent(d));e&&(f.auth=encodeURIComponent(e));z({a:g,data:f,c:function(a){b(a)},b:c,url:[I,"v1","auth","audit","sub-key",j]})},revoke:function(a,b){a.read=t;a.write=t;y.grant(a,b)},xdr:z,ready:qa,db:S,uuid:ja,map:T,each:P,"each-channel":F,
grep:na,offline:function(){d(1)},supplant:oa,now:G,unique:ga,updater:ma};M||(M=y.uuid());S.set(j+"uuid",M);setTimeout(u,E);setTimeout(e,s);b();g=y;g.css=xa;g.$=sa;g.create=Aa;g.bind=U;g.head=wa;g.search=ua;g.attr=V;g.events=Y;g.init=Ka;U("beforeunload",window,function(){g["each-channel"](function(a){g.LEAVE(a.name,0)});return!0});if(a.notest)return g;U("offline",window,g.offline);U("offline",document,g.offline);return g};"complete"===document.readyState?setTimeout(qa,0):U("load",window,function(){setTimeout(qa,
0)});var $=Z||{};PUBNUB=Ka({notest:1,publish_key:V($,"pub-key"),subscribe_key:V($,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==V($,"ssl"),origin:V($,"origin"),uuid:V($,"uuid")});window.jQuery&&(window.jQuery.PUBNUB=PUBNUB);"undefined"!==typeof module&&(module.exports=PUBNUB)&&qa();var Ha=sa("pubnubs")||0;if(Z){xa(Z,{position:"absolute",top:-E});if("opera"in window||V(Z,"flash"))Z.innerHTML="<object id=pubnubs data=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=movie value=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=allowscriptaccess value=always></object>";
PUBNUB.rdx=function(a,c){if(!c)return W[a].onerror();W[a].responseText=unescape(c);W[a].onload()};W.id=E}}
