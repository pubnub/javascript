...
r=b(j),f=c(f,j),j=JSON.stringify(e);return K.AES.encrypt(j,f,{iv:m,mode:r}).ciphertext.toString(K.enc.Base64)||e},decrypt:function(e,f,j){if(!f)return e;var j=a(j),m=d(j),r=b(j),f=c(f,j);try{var E=K.enc.Base64.parse(e),I=K.AES.decrypt({ciphertext:E},f,{iv:m,mode:r}).toString(K.enc.Utf8);return JSON.parse(I)}catch(u){}}}},Ga=function(a,c){return K.HmacSHA256(a,c).toString(K.enc.Base64)},Ha=function(a){return document.getElementById(a)},Ia=function(a){console.error(a)},Ja=function(a,c){var b=[];F(a.split(/\s+/),
...
c){for(var b in c)if(c.hasOwnProperty(b))try{a.style[b]=c[b]+(0<"|width|height|top|left|".indexOf(b)&&"number"==typeof c[b]?"px":"")}catch(d){}},Qa=function(a){return document.createElement(a)},Ta=function(){return Ra||Sa()?0:ea()},Va=function(a){function c(a,b){y||(y=1,u.onerror=v,clearTimeout(h),a||!b||g(b),setTimeout(function(){a&&i();var b=Ha(B),c=b&&b.parentNode;c&&c.removeChild(b)},G))}if(Ra||Sa()){a:{var b,d,e=function(){if(!m){m=1;clearTimeout(r);try{d=JSON.parse(b.responseText)}catch(a){return q(1)}f=
...
default:var a=b.responseText,c=b.status;try{d=JSON.parse(a),q(1,d)}catch(e){return q(1,{status:c,fb:v,message:a})}}};var E=la(a.url,x);b.open("GET",E,A);A&&(b.timeout=j);b.send()}catch(I){q(0);Ra=0;a=Va(a);break a}a=q}return a}var u=Qa("script"),e=a.e,B=ea(),y=0,h=setTimeout(function(){c(1,{message:"timeout"})},a.timeout||Ua),i=a.f||D(),j=a.data||{},g=a.g||D();window[e]=function(a){c(0,a)};a.Q||(u[Wa]=Wa);u.onerror=function(){c(1)};u.src=la(a.url,j);Ma(u,"id",B);La().appendChild(u);return c},Xa=function(){if(!("onLine"in
navigator))return 1;try{return navigator.onLine}catch(a){return p}},Ya=function(a){return!("sendBeacon"in navigator)?w:navigator.sendBeacon(a)},Sa=function(){if(!Za||!Za.get)return 0;var a={id:Sa.id++,send:D(),abort:function(){a.id={}},open:function(c,b){Sa[a.id]=a;Za.get(a.id,b)}};return a},da=1,Ba=w,Ca=[],$a="-pnpres",Ua=15E3,G=1E3,ja="/",ka="&",ra=/{([\w\-]+)}/g,ab,bb=Math.floor(20*Math.random());ab=function(a,c){return 0<a.indexOf("pubsub.")&&a.replace("pubsub","ps"+(c?ta().split("-")[0]:20>++bb?
bb:bb=1))||a};var Wa="async",cb=navigator.userAgent,Ra=-1==cb.indexOf("MSIE 6");window.console||(window.console=window.console||{});console.log||(console.log=console.error=(window.opera||{}).postError||D());var db,eb={},fb=w;try{fb=window.localStorage}catch(lb){}var mb=function(a){return-1==document.cookie.indexOf(a)?v:((document.cookie||"").match(RegExp(a+"=([^;]+)"))||[])[1]||v},nb=function(a,c){document.cookie=a+"="+c+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"},ob;try{nb("pnctest","1"),ob=
...
ia();b&&c(b)||H.time(c)}function d(a,b){gb&&gb(a,b);gb=v;clearTimeout(fa);clearTimeout(ba)}function e(){Kc&&H.time(function(a){b(D(),a);a||d(1,{error:"Heartbeat failed to connect to Pubnub Servers.Please check your network settings."});ba&&clearTimeout(ba);ba=setTimeout(e,Ub)})}function f(){Nc()||d(1,{error:"Offline. Please check your network settings. "});fa&&clearTimeout(fa);fa=setTimeout(f,G)}function m(a,b,c,d){var b=a.callback||b,e=a.error||t,f=S(),d=d||{};d.auth||(d.auth=a.auth_key||J);a=[U,
...
return}}b&&b(a)}function C(a){var b=0;F(za(L),function(c){if(c=L[c])b++,(a||D())(c)});return b}function x(a){var b=0;F(Aa(Y),function(c){if(c=Y[c])b++,(a||D())(c)})}function s(a){if(Oc){if(!ma.length)return}else{a&&(ma.ua=0);if(ma.ua||!ma.length)return;ma.ua=1}N(ma.shift())}function A(){!zb&&q()}function q(){clearTimeout(na);!V||500<=V||1>V||!za(L,p).length&&!Aa(Y,p).length?zb=w:(zb=p,H.presence_heartbeat({callback:function(){na=setTimeout(q,V*G)},error:function(a){t&&t("Presence Heartbeat unable to reach Pubnub servers."+
JSON.stringify(a));na=setTimeout(q,V*G)}}))}function E(a,b){return hb.decrypt(a,b||ga)||hb.decrypt(a,ga)||a}function I(a,b,c){var d=w;if("undefined"===typeof a)return b;if("number"===typeof a)d=5<a||0==a?w:p;else{if("boolean"===typeof a)return a?30:0;d=p}return d?(c&&c("Presence Heartbeat value invalid. Valid range ( x > 5 or x = 0). Current Value : "+(b||5)),b||5):a}function u(a){var b="",c=[];F(a,function(a){c.push(a)});var d=c.sort(),e;for(e in d){var f=d[e],b=b+(f+"="+wa(a[f]));e!=d.length-1&&
(b+="&")}return b}function B(a){a||(a={});F(bc,function(b,c){b in a||(a[b]=c)});return a}function y(a){return sb(a)}Ra=a.jsonp?0:-1==cb.indexOf("MSIE 6");var h=a.subscribe_key||"";a.uuid||db.get(h+"uuid");var i=a.leave_on_unload||0;a.xdr=Va;a.db=db;a.error=a.error||Ia;a._is_online=Xa;a.jsonp_cb=Ta;a.hmac_SHA256=Ga;a.crypto_obj=Fa();a.sendBeacon=Ya;a.params={pnsdk:"PubNub-JS-Web/3.7.19"};var g=+a.windowing||10,l=(+a.timeout||310)*G,Ub=(+a.keepalive||60)*G,Kc=a.timecheck||0,Vb=a.noleave||0,Z=a.publish_key,
z=a.subscribe_key,J=a.auth_key||"",ib=a.secret_key||"",cc=a.hmac_SHA256,oa=a.ssl?"s":"",Ea="http"+oa+"://"+(a.origin||"pubsub.pubnub.com"),U=ab(Ea),dc=ab(Ea),ma=[],Ab=p,yb=0,Bb=0,ec=0,gb=0,Pa=a.restore||0,xa=0,Cb=w,L={},Y={},ca={},na=v,$=I(a.heartbeat||a.pnexpires||0,a.error),V=a.heartbeat_interval||$/2-1,zb=w,Oc=a.no_wait_for_pending,fc=a["compatible_3.5"]||w,N=a.xdr,bc=a.params||{},t=a.error||D(),Nc=a._is_online||function(){return 1},S=a.jsonp_cb||function(){return 0},ya=a.db||{get:D(),set:D()},
ga=a.cipher_key,M=a.uuid||!a.unique_uuid&&ya&&ya.get(z+"uuid")||"",ha=a.instance_id||w,aa="",gc=a.shutdown,jb=("undefined"!=typeof a.use_send_beacon?a.use_send_beacon:1)?a.sendBeacon:v,fa,ba;2===$&&(V=1);var hb=a.crypto_obj||{encrypt:function(a){return a},decrypt:function(a){return a}},H={LEAVE:function(a,b,c,d,e){var c={uuid:M,auth:c||J},f=ab(Ea),d=d||D(),h=e||D(),e=S();if(0<a.indexOf($a))return p;if(fc&&(!oa||"0"==e)||Vb)return w;"0"!=e&&(c.callback=e);ha&&(c.instanceid=aa);a=[f,"v2","presence",
"sub_key",z,"channel",encodeURIComponent(a),"leave"];c=B(c);if(jb&&(url_string=la(a,c),jb(url_string)))return d&&d({status:200,action:"leave",message:"OK",service:"Presence"}),p;N({Q:b||oa,e:e,data:c,g:function(a){r(a,d,h)},f:function(a){j(a,h)},url:a});return p},LEAVE_GROUP:function(a,b,c,d,e){var c={uuid:M,auth:c||J},f=ab(Ea),d=d||D(),h=e||D(),e=S();if(0<a.indexOf($a))return p;if(fc&&(!oa||"0"==e)||Vb)return w;"0"!=e&&(c.callback=e);a&&0<a.length&&(c["channel-group"]=a);ha&&(c.instanceid=aa);a=
[f,"v2","presence","sub_key",z,"channel",encodeURIComponent(","),"leave"];c=B(c);if(jb&&(url_string=la(a,c),jb(url_string)))return d&&d({status:200,action:"leave",message:"OK",service:"Presence"}),p;N({Q:b||oa,e:e,data:c,g:function(a){r(a,d,h)},f:function(a){j(a,h)},url:a});return p},set_resumed:function(a){Cb=a},get_cipher_key:function(){return ga},set_cipher_key:function(a){ga=a},raw_encrypt:function(a,b){return hb.encrypt(a,b||ga)||a},raw_decrypt:function(a,b){return E(a,b)},get_heartbeat:function(){return $},
set_heartbeat:function(a,b){$=I(a,$,t);V=b||$/2-1;2==$&&(V=1);c();q()},get_heartbeat_interval:function(){return V},set_heartbeat_interval:function(a){V=a;q()},get_version:function(){return"3.7.19"},getGcmMessageObject:function(a){return{data:a}},getApnsMessageObject:function(a){var b={aps:{badge:1,alert:""}};for(k in a)k[b]=a[k];return b},newPnMessage:function(){var a={};gcm&&(a.pn_gcm=gcm);apns&&(a.pn_apns=apns);for(k in n)a[k]=n[k];return a},_add_param:function(a,b){bc[a]=b},channel_group:function(a,
...
"true");N({e:u,data:B(q),g:function(a){if("object"==typeof a&&a.error)e({message:a.message,payload:a.payload});else{for(var c=a[0],d=[],Oa=0;Oa<c.length;Oa++)if(r){var f=E(c[Oa].message,h),g=c[Oa].timetoken;try{d.push({message:JSON.parse(f),timetoken:g})}catch(j){d.push({message:f,timetoken:g})}}else{f=E(c[Oa],h);try{d.push(JSON.parse(f))}catch(i){d.push(f)}}b([d,a[1],a[2]])}},f:function(a){j(a,e)},url:[U,"v2","history","sub-key",z,"channel",encodeURIComponent(g)]})},replay:function(a,b){var b=b||
a.callback||D(),c=a.auth_key||J,d=a.source,e=a.destination,f=a.stop,h=a.start,g=a.end,j=a.reverse,i=a.limit,l=S(),m={};if(!d)return t("Missing Source Channel");if(!e)return t("Missing Destination Channel");if(!Z)return t("Missing Publish Key");if(!z)return t("Missing Subscribe Key");"0"!=l&&(m.callback=l);f&&(m.stop="all");j&&(m.reverse="true");h&&(m.start=h);g&&(m.end=g);i&&(m.count=i);m.auth=c;N({e:l,g:function(a){r(a,b,err)},f:function(){b([0,"Disconnected"])},url:[U,"v1","replay",Z,z,d,e],data:B(m)})},
auth:function(a){J=a;c()},time:function(a){var b=S(),c={uuid:M,auth:J};ha&&(c.instanceid=aa);N({e:b,data:B(c),url:[U,"time",b],g:function(b){a(b[0])},f:function(){a(0)}})},publish:function(a,b){var c=a.message;if(!c)return t("Missing Message");var b=b||a.callback||c.callback||a.success||D(),d=a.channel||c.channel,e=a.auth_key||J,f=a.cipher_key,h=a.error||c.error||D(),g=a.post||w,i="store_in_history"in a?a.store_in_history:p,l=S(),m="push";a.prepend&&(m="unshift");if(!d)return t("Missing Channel");
if(!Z)return t("Missing Publish Key");if(!z)return t("Missing Subscribe Key");c.getPubnubMessage&&(c=c.getPubnubMessage());c=JSON.stringify(hb.encrypt(c,f||ga)||c);c=[U,"publish",Z,z,0,encodeURIComponent(d),l,encodeURIComponent(c)];e={uuid:M,auth:e};i||(e.store="0");ha&&(e.instanceid=aa);ma[m]({e:l,url:c,data:B(e),f:function(a){j(a,h);s(1)},g:function(a){r(a,b,h);s(1)},mode:g?"POST":"GET"});s()},unsubscribe:function(a,b){var d=a.channel,e=a.channel_group,f=a.auth_key||J,b=b||a.callback||D(),h=a.error||
D();xa=0;Pa=1;if(!d&&!e)return t("Missing Channel or Channel Group");if(!Z)return t("Missing Publish Key");if(!z)return t("Missing Subscribe Key");if(d){var d=ua(d)?d:(""+d).split(","),g=[],i=[];F(d,function(a){L[a]&&g.push(a)});if(0==g.length){b({action:"leave"});return}F(g,function(a){a in L&&(L[a]=0);a in ca&&delete ca[a]});F(g,function(a){i.push(a+$a)});d=p;Ba&&(d=H.LEAVE(g.concat(i),0,f,b,h));d||b({action:"leave"})}if(e){var e=ua(e)?e:(""+e).split(","),j=[],l=[];F(e,function(a){Y[a]&&j.push(a)});
if(0==j.length){b({action:"leave"});return}F(j,function(a){a in Y&&(Y[a]=0);a in ca&&delete ca[a]});F(j,function(a){l.push(a+$a)});d=p;Ba&&(d=H.LEAVE_GROUP(j.concat(l),0,f,b,h));d||b({action:"leave"})}c()},subscribe:function(a,b){function e(a){a?setTimeout(c,fa):(U=ab(Ea,1),dc=ab(Ea,1),setTimeout(function(){H.time(e)},G));C(function(b){if(a&&b.i)return b.i=0,b.aa(b.name);!a&&!b.i&&(b.i=1,b.W(b.name))});x(function(b){if(a&&b.i)return b.i=0,b.aa(b.name);!a&&!b.i&&(b.i=1,b.W(b.name))})}function f(){var a=
S(),b=za(L).join(","),h=Aa(Y).join(",");if(b||h){b||(b=",");d();var g=B({uuid:M,auth:J});h&&(g["channel-group"]=h);2<JSON.stringify(ca).length&&(g.state=JSON.stringify(ca));$&&(g.heartbeat=$);ha&&(g.instanceid=aa);A();gb=N({timeout:ma,e:a,f:function(a){a&&a.error&&a.service?(j(a,s),e(1)):H.time(function(b){!b&&j(a,s);e(b)})},data:B(g),url:[dc,"subscribe",z,encodeURIComponent(b),a,xa],g:function(a){if(!a||"object"==typeof a&&"error"in a&&a.error)return s(a.error),setTimeout(c,G);u(a[1]);xa=!xa&&Pa&&
ya.get(z)||a[1];C(function(a){a.s||(a.s=1,a.T(a.name))});x(function(a){a.s||(a.s=1,a.T(a.name))});if(Cb&&!Pa)xa=0,Cb=w,ya.set(z,0);else{V&&(xa=1E4,V=0);ya.set(z,a[1]);var b,d="",e="";3<a.length?(d=a[3],e=a[2]):d=2<a.length?a[2]:va(za(L),function(b){return va(Array(a[0].length).join(",").split(","),function(){return b})}).join(",");var h=d.split(","),g=e?e.split(","):[];b=function(){var a=h.shift()||ec,b=g.shift(),c={};b?(a&&(0<=a.indexOf("-pnpres")&&0>b.indexOf("-pnpres"))&&(b+="-pnpres"),c=Y[b]||
L[b]||{callback:D()}):c=L[a];a=[c.e||Bb,a.split($a)[0]];b&&a.push(b.split($a)[0]);return a};var i=ia()-yb-+a[1]/1E4;F(a[0],function(c){var d=b(),c=E(c,L[d[1]]?L[d[1]].cipher_key:v);d[0]&&d[0](c,a,d[2]||d[1],i,d[1])})}setTimeout(f,fa)}})}}var h=a.channel,i=a.channel_group,b=(b=b||a.callback)||a.message,m=a.connect||D(),r=a.reconnect||D(),q=a.disconnect||D(),s=a.error||s||D(),u=a.idle||D(),y=a.presence||0,I=a.noheresync||0,V=a.backfill||0,Z=a.timetoken||0,ma=a.timeout||l,fa=a.windowing||g,ba=a.state,
ga=a.heartbeat||a.pnexpires,na=a.heartbeat_interval,oa=a.restore||Pa;J=a.auth_key||J;Pa=oa;xa=Z;if(!h&&!i)return t("Missing Channel");if(!b)return t("Missing Callback");if(!z)return t("Missing Subscribe Key");(ga||0===ga||na||0===na)&&H.set_heartbeat(ga,na);h&&F((h.join?h.join(","):""+h).split(","),function(c){var d=L[c]||{};L[ec=c]={name:c,s:d.s,i:d.i,o:1,e:Bb=b,cipher_key:a.cipher_key,T:m,W:q,aa:r};ba&&(ca[c]=c in ba?ba[c]:ba);y&&(H.subscribe({channel:c+$a,callback:y,restore:oa}),!d.o&&!I&&H.here_now({channel:c,
data:B({uuid:M,auth:J}),callback:function(a){F("uuids"in a?a.uuids:[],function(b){y({action:"join",uuid:b,timestamp:Math.floor(ia()/1E3),occupancy:a.occupancy||1},a,c)})}}))});i&&F((i.join?i.join(","):""+i).split(","),function(c){var d=Y[c]||{};Y[c]={name:c,s:d.s,i:d.i,o:1,e:Bb=b,cipher_key:a.cipher_key,T:m,W:q,aa:r};y&&(H.subscribe({channel_group:c+$a,callback:y,restore:oa,auth_key:J}),!d.o&&!I&&H.here_now({channel_group:c,data:B({uuid:M,auth:J}),callback:function(a){F("uuids"in a?a.uuids:[],function(b){y({action:"join",
uuid:b,timestamp:Math.floor(ia()/1E3),occupancy:a.occupancy||1},a,c)})}}))});c=function(){d();setTimeout(f,fa)};if(!Ba)return Ca.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.debug,d=a.error||D(),e=a.auth_key||J,f=a.channel,h=a.channel_group,g=S(),i=a.state,e={uuid:M,auth:e};if(!("uuids"in a?a.uuids:1))e.disable_uuids=1;i&&(e.state=1);if(!b)return t("Missing Callback");if(!z)return t("Missing Subscribe Key");i=[U,"v2","presence","sub_key",z];f&&i.push("channel")&&i.push(encodeURIComponent(f));
"0"!=g&&(e.callback=g);h&&(e["channel-group"]=h,!f&&i.push("channel")&&i.push(","));ha&&(e.instanceid=aa);N({e:g,data:B(e),g:function(a){r(a,b,d)},f:function(a){j(a,d)},debug:c,url:i})},where_now:function(a,b){var b=a.callback||b,c=a.error||D(),d=a.auth_key||J,e=S(),f=a.uuid||M,d={auth:d};if(!b)return t("Missing Callback");if(!z)return t("Missing Subscribe Key");"0"!=e&&(d.callback=e);ha&&(d.instanceid=aa);N({e:e,data:B(d),g:function(a){r(a,b,c)},f:function(a){j(a,c)},url:[U,"v2","presence","sub_key",
z,"uuid",encodeURIComponent(f)]})},state:function(a,b){var b=a.callback||b||D(),c=a.error||D(),d=a.auth_key||J,e=S(),f=a.state,h=a.uuid||M,g=a.channel,i=a.channel_group,d=B({auth:d});if(!z)return t("Missing Subscribe Key");if(!h)return t("Missing UUID");if(!g&&!i)return t("Missing Channel");"0"!=e&&(d.callback=e);"undefined"!=typeof g&&L[g]&&L[g].o&&f&&(ca[g]=f);"undefined"!=typeof i&&(Y[i]&&Y[i].o)&&(f&&(ca[i]=f),d["channel-group"]=i,g||(g=","));d.state=JSON.stringify(f);ha&&(d.instanceid=aa);f=
f?[U,"v2","presence","sub-key",z,"channel",g,"uuid",h,"data"]:[U,"v2","presence","sub-key",z,"channel",g,"uuid",encodeURIComponent(h)];N({e:e,data:B(d),g:function(a){r(a,b,c)},f:function(a){j(a,c)},url:f})},grant:function(a,b){var b=a.callback||b,c=a.error||D(),d=a.channel||a.channels,e=a.channel_group,f=S(),h=a.ttl,g=a.read?"1":"0",i=a.write?"1":"0",l=a.manage?"1":"0",m=a.auth_key||a.auth_keys;if(!b)return t("Missing Callback");if(!z)return t("Missing Subscribe Key");if(!Z)return t("Missing Publish Key");
if(!ib)return t("Missing Secret Key");var q=z+"\n"+Z+"\ngrant\n",g={w:i,r:g,timestamp:Math.floor((new Date).getTime()/1E3)};a.manage&&(g.m=l);ua(d)&&(d=d.join(","));ua(m)&&(m=m.join(","));"undefined"!=typeof d&&(d!=v&&0<d.length)&&(g.channel=d);"undefined"!=typeof e&&(e!=v&&0<e.length)&&(g["channel-group"]=e);"0"!=f&&(g.callback=f);if(h||0===h)g.ttl=h;m&&(g.auth=m);g=B(g);m||delete g.auth;q+=u(g);d=cc(q,ib);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");g.signature=d;N({e:f,data:g,g:function(a){r(a,
b,c)},f:function(a){j(a,c)},url:[U,"v1","auth","grant","sub-key",z]})},mobile_gw_provision:function(a){var b=a.callback||D(),c=a.auth_key||J,d=a.error||D(),e=S(),f=a.channel,g=a.op,h=a.gw_type,a=a.device_id;if(!a)return t("Missing Device ID (device_id)");if(!h)return t("Missing GW Type (gw_type: gcm or apns)");if(!g)return t("Missing GW Operation (op: add or remove)");if(!f)return t("Missing gw destination Channel (channel)");if(!Z)return t("Missing Publish Key");if(!z)return t("Missing Subscribe Key");
a=[U,"v1/push/sub-key",z,"devices",a];c={uuid:M,auth:c,type:h};"add"==g?c.add=f:"remove"==g&&(c.remove=f);ha&&(data.instanceid=aa);N({e:e,data:c,g:function(a){r(a,b,d)},f:function(a){j(a,d)},url:a})},audit:function(a,b){var b=a.callback||b,c=a.error||D(),d=a.channel,e=a.channel_group,f=a.auth_key,g=S();if(!b)return t("Missing Callback");if(!z)return t("Missing Subscribe Key");if(!Z)return t("Missing Publish Key");if(!ib)return t("Missing Secret Key");var h=z+"\n"+Z+"\naudit\n",i={timestamp:Math.floor((new Date).getTime()/
1E3)};"0"!=g&&(i.callback=g);"undefined"!=typeof d&&(d!=v&&0<d.length)&&(i.channel=d);"undefined"!=typeof e&&(e!=v&&0<e.length)&&(i["channel-group"]=e);f&&(i.auth=f);i=B(i);f||delete i.auth;h+=u(i);d=cc(h,ib);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");i.signature=d;N({e:g,data:i,g:function(a){r(a,b,c)},f:function(a){j(a,c)},url:[U,"v1","auth","audit","sub-key",z]})},revoke:function(a,b){a.read=w;a.write=w;H.grant(a,b)},set_uuid:function(a){M=a;c()},get_uuid:function(){return M},isArray:function(a){return ua(a)},
get_subscribed_channels:function(){return za(L,p)},presence_heartbeat:function(a){var b=a.callback||D(),c=a.error||D(),a=S(),d={uuid:M,auth:J};2<JSON.stringify(ca).length&&(d.state=JSON.stringify(ca));0<$&&320>$&&(d.heartbeat=$);"0"!=a&&(d.callback=a);var e;e=za(L,p).join(",");e=encodeURIComponent(e);var f=Aa(Y,p).join(",");e||(e=",");f&&(d["channel-group"]=f);ha&&(d.instanceid=aa);N({e:a,data:B(d),url:[U,"v2","presence","sub-key",z,"channel",e,"heartbeat"],g:function(a){r(a,b,c)},f:function(a){j(a,
c)}})},stop_timers:function(){clearTimeout(fa);clearTimeout(ba);clearTimeout(na)},shutdown:function(){H.stop_timers();gc&&gc()},xdr:N,ready:Da,db:ya,uuid:ta,map:va,each:F,"each-channel":C,grep:qa,offline:function(){d(1,{message:"Offline. Please check your network settings."})},supplant:sa,now:ia,unique:ea,updater:pa};M||(M=H.uuid());aa||(aa=H.uuid());ya.set(z+"uuid",M);fa=setTimeout(f,G);ba=setTimeout(e,Ub);na=setTimeout(A,(V-3)*G);b();var h=H,kb;for(kb in h)h.hasOwnProperty(kb)&&(y[kb]=h[kb]);y.css=
Na;y.$=Ha;y.create=Qa;y.bind=Ka;y.head=La;y.search=Ja;y.attr=Ma;y.events=qb;y.init=y;y.secure=y;y.crypto_obj=Fa();Ka("beforeunload",window,function(){if(i)y["each-channel"](function(a){y.LEAVE(a.name,0)});return p});if(a.notest)return y;Ka("offline",window,y.offline);Ka("offline",document,y.offline);return y};sb.init=sb;sb.secure=sb;sb.crypto_obj=Fa();"complete"===document.readyState?setTimeout(Da,0):Ka("load",window,function(){setTimeout(Da,0)});var tb=rb||{};PUBNUB=sb({notest:1,publish_key:Ma(tb,
"pub-key"),subscribe_key:Ma(tb,"sub-key"),ssl:!document.location.href.indexOf("https")||"on"==Ma(tb,"ssl"),origin:Ma(tb,"origin"),uuid:Ma(tb,"uuid")});window.jQuery&&(window.jQuery.PUBNUB=sb);"undefined"!==typeof module&&(module.exports=PUBNUB)&&Da();var Za=Ha("pubnubs")||0;if(rb){Na(rb,{position:"absolute",top:-G});if("opera"in window||Ma(rb,"flash"))rb.innerHTML="<object id=pubnubs data=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=movie value=https://pubnub.a.ssl.fastly.net/pubnub.swf><param name=allowscriptaccess value=always></object>";
PUBNUB.rdx=function(a,c){if(!c)return Sa[a].onerror();Sa[a].responseText=unescape(c);Sa[a].onload()};Sa.id=G}}
...
jc=jc.ga=lc.extend({F:function(){this.k=new kc.b([1732584193,4023233417,2562383102,271733878])},O:function(a,c){for(var b=0;16>b;b++){var d=c+b,e=a[d];a[d]=(e<<8|e>>>24)&16711935|(e<<24|e>>>8)&4278255360}var b=this.k.c,d=a[c+0],e=a[c+1],f=a[c+2],m=a[c+3],j=a[c+4],r=a[c+5],C=a[c+6],x=a[c+7],s=a[c+8],A=a[c+9],q=a[c+10],E=a[c+11],I=a[c+12],u=a[c+13],B=a[c+14],y=a[c+15],h=b[0],i=b[1],g=b[2],l=b[3],h=O(h,i,g,l,d,7,T[0]),l=O(l,h,i,g,e,12,T[1]),g=O(g,l,h,i,f,17,T[2]),i=O(i,g,l,h,m,22,T[3]),h=O(h,i,g,l,j,
7,T[4]),l=O(l,h,i,g,r,12,T[5]),g=O(g,l,h,i,C,17,T[6]),i=O(i,g,l,h,x,22,T[7]),h=O(h,i,g,l,s,7,T[8]),l=O(l,h,i,g,A,12,T[9]),g=O(g,l,h,i,q,17,T[10]),i=O(i,g,l,h,E,22,T[11]),h=O(h,i,g,l,I,7,T[12]),l=O(l,h,i,g,u,12,T[13]),g=O(g,l,h,i,B,17,T[14]),i=O(i,g,l,h,y,22,T[15]),h=P(h,i,g,l,e,5,T[16]),l=P(l,h,i,g,C,9,T[17]),g=P(g,l,h,i,E,14,T[18]),i=P(i,g,l,h,d,20,T[19]),h=P(h,i,g,l,r,5,T[20]),l=P(l,h,i,g,q,9,T[21]),g=P(g,l,h,i,y,14,T[22]),i=P(i,g,l,h,j,20,T[23]),h=P(h,i,g,l,A,5,T[24]),l=P(l,h,i,g,B,9,T[25]),g=
P(g,l,h,i,m,14,T[26]),i=P(i,g,l,h,s,20,T[27]),h=P(h,i,g,l,u,5,T[28]),l=P(l,h,i,g,f,9,T[29]),g=P(g,l,h,i,x,14,T[30]),i=P(i,g,l,h,I,20,T[31]),h=Q(h,i,g,l,r,4,T[32]),l=Q(l,h,i,g,s,11,T[33]),g=Q(g,l,h,i,E,16,T[34]),i=Q(i,g,l,h,B,23,T[35]),h=Q(h,i,g,l,e,4,T[36]),l=Q(l,h,i,g,j,11,T[37]),g=Q(g,l,h,i,x,16,T[38]),i=Q(i,g,l,h,q,23,T[39]),h=Q(h,i,g,l,u,4,T[40]),l=Q(l,h,i,g,d,11,T[41]),g=Q(g,l,h,i,m,16,T[42]),i=Q(i,g,l,h,C,23,T[43]),h=Q(h,i,g,l,A,4,T[44]),l=Q(l,h,i,g,I,11,T[45]),g=Q(g,l,h,i,y,16,T[46]),i=Q(i,
g,l,h,f,23,T[47]),h=R(h,i,g,l,d,6,T[48]),l=R(l,h,i,g,x,10,T[49]),g=R(g,l,h,i,B,15,T[50]),i=R(i,g,l,h,r,21,T[51]),h=R(h,i,g,l,I,6,T[52]),l=R(l,h,i,g,m,10,T[53]),g=R(g,l,h,i,q,15,T[54]),i=R(i,g,l,h,e,21,T[55]),h=R(h,i,g,l,s,6,T[56]),l=R(l,h,i,g,y,10,T[57]),g=R(g,l,h,i,C,15,T[58]),i=R(i,g,l,h,u,21,T[59]),h=R(h,i,g,l,j,6,T[60]),l=R(l,h,i,g,E,10,T[61]),g=R(g,l,h,i,f,15,T[62]),i=R(i,g,l,h,A,21,T[63]);b[0]=b[0]+h|0;b[1]=b[1]+i|0;b[2]=b[2]+g|0;b[3]=b[3]+l|0},A:function(){var a=this.p,c=a.c,b=8*this.G,d=8*
...
ra:function(a,c){this.ia(a,c,this.La,Ic,Jc,Lc,Mc,W)},qa:function(a,c){var b=a[c+1];a[c+1]=a[c+3];a[c+3]=b;this.ia(a,c,this.Ja,Pc,Qc,Rc,Sc,Hc);b=a[c+1];a[c+1]=a[c+3];a[c+3]=b},ia:function(a,c,b,d,e,f,m,j){for(var r=this.Na,C=a[c]^b[0],x=a[c+1]^b[1],s=a[c+2]^b[2],A=a[c+3]^b[3],q=4,E=1;E<r;E++)var I=d[C>>>24]^e[x>>>16&255]^f[s>>>8&255]^m[A&255]^b[q++],u=d[x>>>24]^e[s>>>16&255]^f[A>>>8&255]^m[C&255]^b[q++],B=d[s>>>24]^e[A>>>16&255]^f[C>>>8&255]^m[x&255]^b[q++],A=d[A>>>24]^e[C>>>16&255]^f[x>>>8&255]^m[s&
255]^b[q++],C=I,x=u,s=B;I=(j[C>>>24]<<24|j[x>>>16&255]<<16|j[s>>>8&255]<<8|j[A&255])^b[q++];u=(j[x>>>24]<<24|j[s>>>16&255]<<16|j[A>>>8&255]<<8|j[C&255])^b[q++];B=(j[s>>>24]<<24|j[A>>>16&255]<<16|j[C>>>8&255]<<8|j[x&255])^b[q++];A=(j[A>>>24]<<24|j[C>>>16&255]<<16|j[x>>>8&255]<<8|j[s&255])^b[q++];a[c]=I;a[c+1]=u;a[c+2]=B;a[c+3]=A},v:8});K.xa=Fc.D(Gc);var bd=K.mode,cd=K.n.Aa.extend();cd.da=cd.extend({K:function(a,c){this.C.ra(a,c)}});cd.ca=cd.extend({K:function(a,c){this.C.qa(a,c)}});bd.Va=cd;
})();
