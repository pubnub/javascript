...
b){Z=H(a,Z,t);V=b||Z/2-1;2==Z&&(V=1);c();q()},get_heartbeat_interval:function(){return V},set_heartbeat_interval:function(a){V=a;q()},get_version:function(){return"3.7.17"},getGcmMessageObject:function(a){return{data:a}},getApnsMessageObject:function(a){var b={aps:{badge:1,alert:""}};for(k in a)k[b]=a[k];return b},newPnMessage:function(){var a={};gcm&&(a.pn_gcm=gcm);apns&&(a.pn_apns=apns);for(k in n)a[k]=n[k];return a},_add_param:function(a,b){bc[a]=b},channel_group:function(a,b){var c=a.channel_group,
