...
import { AccessPermission, ResourceType } from '../../../contract/shared/enums.js';
...
Given(
  'the {string} {resource_type} resource access permissions',
  function (resourceName: string, resourceType: ResourceType) {
...
Given(
  'the {string} {resource_type} pattern access permissions',
  function (resourceName: string, resourceType: ResourceType) {
    this.resourceName = resourceName;
    this.resourceType = resourceType;
...
Given('grant resource permission {access_permission}', function (accessPermission: AccessPermission) {
  this.grantPayload.resources[this.resourceType][this.resourceName][accessPermission] = true;
});

Given('deny resource permission {access_permission}', function (accessPermission: AccessPermission) {
  this.grantPayload.resources[this.resourceType][this.resourceName][accessPermission] = false;
});

Given('grant pattern permission {access_permission}', function (accessPermission: AccessPermission) {
  this.grantPayload.patterns[this.resourceType][this.resourceName][accessPermission] = true;
});

Given('deny pattern permission {access_permission}', function (accessPermission: AccessPermission) {
...
Then(
  'the token has {string} {resource_type} resource access permissions',
  function (resourceName: string, resourceType: ResourceType) {
    this.resourceName = resourceName;
    this.resourceType = resourceType;
...
Then(
  'the token has {string} {resource_type} pattern access permissions',
  function (resourceName: string, resourceType: ResourceType) {
    this.resourceName = resourceName;
    this.resourceType = resourceType;
...
Then('token resource permission {access_permission}', function (accessPermission: AccessPermission) {
  expect(this.parsedToken.resources[this.resourceType][this.resourceName][accessPermission]).to.be.true;
});

Then('token pattern permission {access_permission}', function (accessPermission: AccessPermission) {
