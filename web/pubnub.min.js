...
function ha(a,c){var b=a.join(da),d=[];if(!c)return b;K(c,function(a,b){d.push(b+"="+L(a))});return b+="?"+d.join(ea)}function ia(a,c){function b(){e+c>C()?(clearTimeout(d),d=setTimeout(b,c)):(e=C(),a())}var d,e=0;return b}function ja(a,c){var b=[];K(a||[],function(a){c(a)&&b.push(a)});return b}function ka(a,c){return a.replace(fa,function(a,d){return c[d]||a})}
...
function L(a){return O(encodeURIComponent(a).split(""),function(a){return 0>"-_.!~*'()".indexOf(a)?a:"%"+a.charCodeAt(0).toString(16).toUpperCase()}).join("")}function la(a){var c=[];K(a,function(a,d){d.g&&c.push(a)});return c.sort()}function P(){setTimeout(function(){v||(v=1,K(ba,function(a){a()}))},y)}
...
{id:W.id++,send:s(),abort:function(){a.id={}},open:function(c,b){W[a.id]=a;xa.get(a.id,b)}};return a},va="async",ta="PubNub-JS-Web/3.4.6",U=-1==navigator.userAgent.indexOf("MSIE 6");window.console||(window.console=window.console||{});console.log||(console.log=console.error=(window.opera||{}).postError||s());var ya,X=window.localStorage;ya={get:function(a){try{return X?X.getItem(a):-1==document.cookie.indexOf(a)?m:((document.cookie||"").match(RegExp(a+"=([^;]+)"))||[])[1]||m}catch(c){}},set:function(a,
...
z[b])&&a(b)})}function p(a){a&&(t.i=0);!t.i&&t.length&&(t.i=1,A(t.shift()))}a.jsonp&&(U=0);var u=a.subscribe_key||"";a.uuid||ya.get(u+"uuid");a.xdr=ua;a.db=ya;a.error=ma;a._is_online=wa;a.jsonp_cb=sa;var f,R=+a.windowing||10,F=(+a.timeout||310)*y,i=(+a.keepalive||60)*y,k=a.publish_key||"",j=a.subscribe_key||"",l=a.ssl?"s":"",h="http"+l+"://"+(a.origin||"pubsub.pubnub.com"),r=E(h),g=E(h),t=[],M=0,V=0,w=[],N=0,H=0,z={},A=a.xdr,n=a.error||s(),ca=a._is_online||function(){return 1},D=a.jsonp_cb||function(){return 0},
I=a.db||{get:s(),set:s()},J=a.uuid||I&&I.get(j+"uuid")||"",x={LEAVE:function(a,b){var c={uuid:J},d=E(h),e=D();0<a.indexOf("-pnpres")||("0"!=e&&(c.callback=e),A({h:b||l,timeout:2E3,a:e,data:c,url:[d,"v2","presence","sub_key",j,"channel",L(a),"leave"]}))},history:function(a,b){var b=a.callback||b,c=a.count||a.limit||100,d=a.reverse||"false",e=a.error||s(),f=a.channel,g=a.start,k=a.end,h={},i=D();if(!f)return n("Missing Channel");if(!b)return n("Missing Callback");if(!j)return n("Missing Subscribe Key");
...
0,b.m(b.name);!a&&!b.d&&(b.d=1,b.l(b.name))})}var f=a.channel,b=(b=b||a.callback)||a.message,i=a.connect||s(),k=a.reconnect||s(),l=a.disconnect||s(),p=a.presence||0,t=a.noheresync||0,u=a.backfill||0,ca=a.timeout||F,pa=a.windowing||R;N=a.restore;H=0;if(!f)return n("Missing Channel");if(!b)return n("Missing Callback");if(!j)return n("Missing Subscribe Key");K((f.join?f.join(","):""+f).split(","),function(a){var c=z[a]||{};z[V=a]={name:a,f:c.f,d:c.d,g:1,a:M=b,k:i,l:l,m:k};p&&(x.subscribe({channel:a+
"-pnpres",callback:p}),!c.g&&!t&&x.here_now({channel:a,callback:function(b){K("uuids"in b?b.uuids:[],function(c){p({action:"join",uuid:c,timestamp:C(),occupancy:b.occupancy||1},b,a)})}}))});c=function(){for(;w.length;)w.shift()();var a=D(),b=la(z).join(",");b&&w.push(A({timeout:ca,a:a,b:function(){x.time(d)},data:{uuid:J},url:[g,"subscribe",j,L(b),a,H],c:function(a){if(!a)return setTimeout(c,pa);e(function(a){a.f||(a.f=1,a.k(a.name))});H=!H&&N&&I.get(j)||a[1];u&&(H=1E4,u=0);I.set(j,a[1]);var b,d=
(2<a.length?a[2]:"").split(",");b=function(){var a=d.shift()||"";return[(z[a]||{}).a||M,(a||V).split("-pnpres")[0]]};K(a[0],function(c){var d=b();if(z[d[1]].g)d[0](c,a,d[1])});setTimeout(c,pa)}}))};if(!v)return ba.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.error||s(),d=a.channel,e=D(),f=m;if(!d)return n("Missing Channel");if(!b)return n("Missing Callback");if(!j)return n("Missing Subscribe Key");"0"!=e&&(f={},f.callback=e);A({a:e,data:f,c:function(a){b(a)},b:c,url:[r,"v2","presence",
"sub_key",j,"channel",L(d)]})},xdr:A,ready:P,db:I,uuid:ga,map:O,each:K,"each-channel":e,grep:ja,supplant:ka,now:C,unique:B,updater:ia};J||(J=x.uuid());I.set(j+"uuid",J);setTimeout(d,y);setTimeout(b,i);x.time(s());f=x;f.css=qa;f.$=Q;f.create=ra;f.bind=S;f.head=oa;f.search=na;f.attr=T;f.events=Y;f.init=za;S("beforeunload",window,function(){f["each-channel"](function(a){f.LEAVE(a.name,1)});return!0});if(a.notest)return f;S("offline",window,f._reset_offline);S("offline",document,f._reset_offline);return f};
...
PUBNUB.rdx=function(a,c){if(!c)return W[a].onerror();W[a].responseText=unescape(c);W[a].onload()};W.id=y}}
