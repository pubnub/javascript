...
function M(a){return L(encodeURIComponent(a).split(""),function(a){return 0>"-_.!~*'()".indexOf(a)?a:"%"+a.charCodeAt(0).toString(16).toUpperCase()}).join("")}function N(a){var c=[];K(a,function(a,d){d.g&&c.push(a)});return c.sort()}function ga(){setTimeout(function(){p||(p=1,K(v,function(a){a()}))},y)}
...
function T(a){function c(){}function b(){i.time(function(a){if(!a)for(;w.length;)w.shift()();setTimeout(b,B)})}function d(){if(!oa())for(;w.length;)w.shift()();setTimeout(d,y)}function f(a){K(N(m),function(b){(b=m[b])&&a(b)})}function s(a){a&&(t.h=0);!t.h&&t.length&&(t.h=1,u(t.shift()))}a.db=U;a.xdr=Q;a.error=ia;var e,H=+a.windowing||10,O=(+a.timeout||310)*y,B=(+a.keepalive||60)*y,q=a.publish_key||"",g=a.subscribe_key||"",r=a.ssl?"s":"",C="http"+r+"://"+(a.origin||"pubsub.pubnub.com"),A=G(C),W=G(C),
t=[],Y=0,Z=0,w=[],P=0,D=0,m={},u=a.xdr,h=a.error||k(),oa=a._is_online||function(){return 1},x=a.jsonp_cb||function(){return 0},E=a.db||{get:k(),set:k()},F=a.uuid||E&&E.get(g+"uuid")||"",i={LEAVE:function(a,b){var c={uuid:F},d=G(C),e=x();0<a.indexOf("-pnpres")||("0"!=e&&(c.callback=e),u({j:b||r,timeout:2E3,a:e,data:c,url:[d,"v2","presence","sub_key",g,"channel",M(a),"leave"]}))},history:function(a,b){var b=a.callback||b,c=a.count||a.limit||100,d=a.reverse||"false",e=a.error||k(),f=a.channel,i=a.start,
m=a.end,n={},l=x();if(!f)return h("Missing Channel");if(!b)return h("Missing Callback");if(!g)return h("Missing Subscribe Key");n.stringtoken="true";n.count=c;n.reverse=d;l&&(n.callback=l);i&&(n.start=i);m&&(n.end=m);u({a:l,data:n,c:function(a){b(a)},b:e,url:[A,"v2","history","sub-key",g,"channel",M(f)]})},replay:function(a){var b=b||a.callback||k(),c=a.source,d=a.destination,e=a.stop,f=a.start,i=a.end,m=a.reverse,a=a.limit,n=x(),l={};if(!c)return h("Missing Source Channel");if(!d)return h("Missing Destination Channel");
