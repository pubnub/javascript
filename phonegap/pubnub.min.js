...
function xa(){setTimeout(function(){ha||(ha=1,R(ia,function(a){a()}))},J)}var S,W=14,X=8,ya=y;function za(a,d){var b="",c,f;if(d){c=a[15];if(16<c)throw"Decryption error: Maybe bad key";if(16==c)return"";for(f=0;f<16-c;f++)b+=String.fromCharCode(a[f])}else for(f=0;16>f;f++)b+=String.fromCharCode(a[f]);return b}function Aa(a,d){var b=[],c;if(!d)try{a=unescape(encodeURIComponent(a))}catch(f){throw"Error on UTF-8 encode";}for(c=0;c<a.length;c++)b[c]=a.charCodeAt(c);return b}
...
c,ib,y);return JSON.parse(e)}catch(f){}}};a.params={pnsdk:wb};SELF=function(a){return Z(a)};var $,Bb=+a.windowing||10,Cb=(+a.timeout||310)*J,jb=(+a.keepalive||60)*J,Kb=a.timecheck||0,ob=a.noleave||0,O=a.publish_key||"demo",u=a.subscribe_key||"demo",G=a.auth_key||"",Ea=a.secret_key||"",pb=a.hmac_SHA256,U=a.ssl?"s":"",ma="http"+U+"://"+(a.origin||"pubsub.pubnub.com"),K=na(ma),qb=na(ma),T=[],Pa=v,Na=0,Qa=0,rb=0,Ca=0,Fa=a.restore||0,fa=0,Ra=y,C={},N={},Q={},ca=x,V=h(a.heartbeat||a.pnexpires||0,a.error),
L=a.heartbeat_interval||V-3,Oa=y,Mb=a.no_wait_for_pending,sb=a["compatible_3.5"]||y,E=a.xdr,P=a.params||{},t=a.error||z(),Lb=a._is_online||function(){return 1},F=a.jsonp_cb||function(){return 0},ga=a.db||{get:z(),set:z()},Y=a.cipher_key,H=a.uuid||!a.unique_uuid&&ga&&ga.get(u+"uuid")||"",aa,ba,Da=a.crypto_obj||{encrypt:function(a){return a},decrypt:function(a){return a}},A={LEAVE:function(a,b,c,d,e){var c={uuid:H,auth:c||G},f=na(ma),d=d||z(),h=e||z(),e=F();if(0<a.indexOf(I))return v;if(sb&&(!U||"0"==
e)||ob)return y;"0"!=e&&(c.callback=e);E({k:b||U,timeout:2E3,a:e,data:D(c),c:function(a){s(a,d,h)},b:function(a){j(a,h)},url:[f,"v2","presence","sub_key",u,"channel",encodeURIComponent(a),"leave"]});return v},LEAVE_GROUP:function(a,b,c,d,e){var c={uuid:H,auth:c||G},f=na(ma),d=d||z(),h=e||z(),e=F();if(0<a.indexOf(I))return v;if(sb&&(!U||"0"==e)||ob)return y;"0"!=e&&(c.callback=e);a&&0<a.length&&(c["channel-group"]=a);E({k:b||U,timeout:5E3,a:e,data:D(c),c:function(a){s(a,d,h)},b:function(a){j(a,h)},
url:[f,"v2","presence","sub_key",u,"channel",encodeURIComponent(","),"leave"]});return v},set_resumed:function(a){Ra=a},get_cipher_key:function(){return Y},set_cipher_key:function(a){Y=a},raw_encrypt:function(a,b){return Da.encrypt(a,b||Y)||a},raw_decrypt:function(a,b){return l(a,b)},get_heartbeat:function(){return V},set_heartbeat:function(a){V=h(a,L,t);L=1<=V-3?V-3:1;d();g()},get_heartbeat_interval:function(){return L},set_heartbeat_interval:function(a){L=a;g()},get_version:function(){return"3.7.8"},
getGcmMessageObject:function(a){return{data:a}},getApnsMessageObject:function(a){var b={aps:{badge:1,alert:""}};for(k in a)k[b]=a[k];return b},newPnMessage:function(){var a={};gcm&&(a.pn_gcm=gcm);apns&&(a.pn_apns=apns);for(k in n)a[k]=n[k];return a},_add_param:function(a,b){P[a]=b},channel_group:function(a,b){var c=a.channel_group,d=a.channels||a.channel,e=a.cloak,f,j,h=[],g={},l=a.mode||"add";c&&(c=c.split(":"),1<c.length?(f="*"===c[0]?x:c[0],j=c[1]):j=c[0]);f&&h.push("namespace")&&h.push(encodeURIComponent(f));
h.push("channel-group");j&&"*"!==j&&h.push(j);d?(ta(d)&&(d=d.join(",")),g[l]=d,g.cloak=Pa?"true":"false"):"remove"===l&&h.push("remove");"undefined"!=typeof e&&(g.cloak=e?"true":"false");q(a,b,h,g)},channel_group_list_groups:function(a,b){var c;(c=a.namespace||a.ns||a.channel_group||x)&&(a.channel_group=c+":*");A.channel_group(a,b)},channel_group_list_channels:function(a,b){if(!a.channel_group)return t("Missing Channel Group");A.channel_group(a,b)},channel_group_remove_channel:function(a,b){if(!a.channel_group)return t("Missing Channel Group");
...
b,err)},b:function(){b([0,"Disconnected"])},url:[K,"v1","replay",O,u,d,e],data:D(p)})},auth:function(a){G=a;d()},time:function(a){var b=F();E({a:b,data:D({uuid:H,auth:G}),timeout:5*J,url:[K,"time",b],c:function(b){a(b[0])},b:function(){a(0)}})},publish:function(a,b){var c=a.message;if(!c)return t("Missing Message");var b=b||a.callback||c.callback||z(),d=a.channel||c.channel,e=a.auth_key||G,f=a.cipher_key,h=a.error||c.error||z(),g=a.post||y,l="store_in_history"in a?a.store_in_history:v,m=F(),p="push";
a.prepend&&(p="unshift");if(!d)return t("Missing Channel");if(!O)return t("Missing Publish Key");if(!u)return t("Missing Subscribe Key");c.getPubnubMessage&&(c=c.getPubnubMessage());c=JSON.stringify(Da.encrypt(c,f||Y)||c);c=[K,"publish",O,u,0,encodeURIComponent(d),m,encodeURIComponent(c)];P={uuid:H,auth:e};l||(P.store="0");T[p]({a:m,timeout:5*J,url:c,data:D(P),b:function(a){j(a,h);r(1)},c:function(a){s(a,b,h);r(1)},mode:g?"POST":"GET"});r()},unsubscribe:function(a,b){var c=a.channel,e=a.channel_group,
f=a.auth_key||G,b=b||a.callback||z(),j=a.error||z();fa=0;c&&(c=ua((c.join?c.join(","):""+c).split(","),function(a){if(C[a])return a+","+a+I}).join(","),R(c.split(","),function(a){var c=v;a&&(C[a]=0,a in Q&&delete Q[a],ha&&(c=A.LEAVE(a,0,f,b,j)),c||b({action:"leave"}))}));e&&(e=ua((e.join?e.join(","):""+e).split(","),function(a){if(N[a])return a+","+a+I}).join(","),R(e.split(","),function(a){var c=v;a&&(N[a]=0,a in Q&&delete Q[a],ha&&(c=A.LEAVE_GROUP(a,0,f,b,j)),c||b({action:"leave"}))}));d()},subscribe:function(a,
b){function f(a){a?setTimeout(d,J):(K=na(ma,1),qb=na(ma,1),setTimeout(function(){A.time(f)},J));B(function(b){if(a&&b.d)return b.d=0,b.j(b.name);!a&&!b.d&&(b.d=1,b.i(b.name))});w(function(b){if(a&&b.d)return b.d=0,b.j(b.name);!a&&!b.d&&(b.d=1,b.i(b.name))})}function h(){var a=F(),b=va(C).join(","),g=wa(N).join(",");if(b||g){b||(b=",");c();var m=D({uuid:H,auth:p});g&&(m["channel-group"]=g);2<JSON.stringify(Q).length&&(m.state=JSON.stringify(Q));V&&(m.heartbeat=V);e();Ca=E({timeout:ba,a:a,b:function(a){a.error&&
a.service?(j(a,L),f(1)):A.time(function(b){!b&&j(a,L);f(b)})},data:D(m),url:[qb,"subscribe",u,encodeURIComponent(b),a,fa],c:function(a){if(!a||"object"==typeof a&&"error"in a&&a.error)return L(a.error),setTimeout(d,J);P(a[1]);fa=!fa&&Fa&&ga.get(u)||a[1];B(function(a){a.f||(a.f=1,a.h(a.name))});w(function(a){a.f||(a.f=1,a.h(a.name))});if(Ra&&!Fa)fa=0,Ra=y,ga.set(u,0);else{T&&(fa=1E4,T=0);ga.set(u,a[1]);var b,c="",e="";3<a.length?(c=a[3],e=a[2]):c=2<a.length?a[2]:ua(va(C),function(b){return ua(Array(a[0].length).join(",").split(","),
function(){return b})}).join(",");var f=c.split(","),j=e?e.split(","):[];b=function(){var a=f.shift()||rb,b=j.shift(),c={};b?(a&&(0<=a.indexOf("-pnpres")&&0>b.indexOf("-pnpres"))&&(b+="-pnpres"),c=N[b]||C[b]||{callback:z()}):c=C[a];a=[c.a||Qa,a.split(I)[0]];b&&a.push(b.split(I)[0]);return a};var g=M()-Na-+a[1]/1E4;R(a[0],function(c){var d=b(),c=l(c,C[d[1]]?C[d[1]].cipher_key:x);d[0]&&d[0](c,a,d[2]||d[1],g,d[1])})}setTimeout(h,Y)}})}}var g=a.channel,m=a.channel_group,b=(b=b||a.callback)||a.message,
p=a.auth_key||G,q=a.connect||z(),s=a.reconnect||z(),r=a.disconnect||z(),L=a.error||z(),P=a.idle||z(),la=a.presence||0,O=a.noheresync||0,T=a.backfill||0,aa=a.timetoken||0,ba=a.timeout||Cb,Y=a.windowing||Bb,U=a.state,$=a.heartbeat||a.pnexpires,ca=a.restore||Fa;Fa=ca;fa=aa;if(!g&&!m)return t("Missing Channel");if(!b)return t("Missing Callback");if(!u)return t("Missing Subscribe Key");($||0===$)&&A.set_heartbeat($);g&&R((g.join?g.join(","):""+g).split(","),function(c){var d=C[c]||{};C[rb=c]={name:c,f:d.f,
d:d.d,e:1,a:Qa=b,cipher_key:a.cipher_key,h:q,i:r,j:s};U&&(Q[c]=c in U?U[c]:U);la&&(A.subscribe({channel:c+I,callback:la,restore:ca}),!d.e&&!O&&A.here_now({channel:c,callback:function(a){R("uuids"in a?a.uuids:[],function(b){la({action:"join",uuid:b,timestamp:Math.floor(M()/1E3),occupancy:a.occupancy||1},a,c)})}}))});m&&R((m.join?m.join(","):""+m).split(","),function(c){var d=N[c]||{};N[c]={name:c,f:d.f,d:d.d,e:1,a:Qa=b,cipher_key:a.cipher_key,h:q,i:r,j:s};la&&(A.subscribe({channel_group:c+I,callback:la,
restore:ca}),!d.e&&!O&&A.here_now({channel_group:c,callback:function(a){R("uuids"in a?a.uuids:[],function(b){la({action:"join",uuid:b,timestamp:Math.floor(M()/1E3),occupancy:a.occupancy||1},a,c)})}}))});d=function(){c();setTimeout(h,Y)};if(!ha)return ia.push(d);d()},here_now:function(a,b){var b=a.callback||b,c=a.error||z(),d=a.auth_key||G,e=a.channel,f=a.channel_group,h=F(),g=a.state,d={uuid:H,auth:d};if(!("uuids"in a?a.uuids:1))d.disable_uuids=1;g&&(d.state=1);if(!b)return t("Missing Callback");
if(!u)return t("Missing Subscribe Key");g=[K,"v2","presence","sub_key",u];e&&g.push("channel")&&g.push(encodeURIComponent(e));"0"!=h&&(d.callback=h);f&&(d["channel-group"]=f,!e&&g.push("channel")&&g.push(","));E({a:h,data:D(d),c:function(a){s(a,b,c)},b:function(a){j(a,c)},url:g})},where_now:function(a,b){var b=a.callback||b,c=a.error||z(),d=a.auth_key||G,e=F(),f=a.uuid||H,d={auth:d};if(!b)return t("Missing Callback");if(!u)return t("Missing Subscribe Key");"0"!=e&&(d.callback=e);E({a:e,data:D(d),
c:function(a){s(a,b,c)},b:function(a){j(a,c)},url:[K,"v2","presence","sub_key",u,"uuid",encodeURIComponent(f)]})},state:function(a,b){var b=a.callback||b||z(),c=a.error||z(),d=a.auth_key||G,e=F(),f=a.state,g=a.uuid||H,h=a.channel,m=a.channel_group,d=D({auth:d});if(!u)return t("Missing Subscribe Key");if(!g)return t("Missing UUID");if(!h&&!m)return t("Missing Channel");"0"!=e&&(d.callback=e);"undefined"!=typeof h&&C[h]&&C[h].e&&f&&(Q[h]=f);"undefined"!=typeof m&&(N[m]&&N[m].e)&&(f&&(Q[m]=f),d["channel-group"]=
m,h||(h=","));d.state=JSON.stringify(f);f=f?[K,"v2","presence","sub-key",u,"channel",h,"uuid",g,"data"]:[K,"v2","presence","sub-key",u,"channel",h,"uuid",encodeURIComponent(g)];E({a:e,data:D(d),c:function(a){s(a,b,c)},b:function(a){j(a,c)},url:f})},grant:function(a,b){var b=a.callback||b,c=a.error||z(),d=a.channel,e=a.channel_group,f=F(),h=a.ttl,g=a.read?"1":"0",l=a.write?"1":"0",p=a.manage?"1":"0",q=a.auth_key;if(!b)return t("Missing Callback");if(!u)return t("Missing Subscribe Key");if(!O)return t("Missing Publish Key");
if(!Ea)return t("Missing Secret Key");var r=u+"\n"+O+"\ngrant\n",g={w:l,r:g,timestamp:Math.floor((new Date).getTime()/1E3)};a.manage&&(g.m=p);"undefined"!=typeof d&&(d!=x&&0<d.length)&&(g.channel=d);"undefined"!=typeof e&&(e!=x&&0<e.length)&&(g["channel-group"]=e);"0"!=f&&(g.callback=f);if(h||0===h)g.ttl=h;q&&(g.auth=q);g=D(g);q||delete g.auth;r+=m(g);d=pb(r,Ea);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");g.signature=d;E({a:f,data:g,c:function(a){s(a,b,c)},b:function(a){j(a,c)},url:[K,"v1","auth",
...
{uuid:H,auth:c,type:h};"add"==g?P.add=f:"remove"==g&&(P.remove=f);E({a:e,data:P,c:function(a){s(a,b,d)},b:function(a){j(a,d)},url:a})},audit:function(a,b){var b=a.callback||b,c=a.error||z(),d=a.channel,e=a.channel_group,f=a.auth_key,g=F();if(!b)return t("Missing Callback");if(!u)return t("Missing Subscribe Key");if(!O)return t("Missing Publish Key");if(!Ea)return t("Missing Secret Key");var h=u+"\n"+O+"\naudit\n",l={timestamp:Math.floor((new Date).getTime()/1E3)};"0"!=g&&(l.callback=g);"undefined"!=
typeof d&&(d!=x&&0<d.length)&&(l.channel=d);"undefined"!=typeof e&&(e!=x&&0<e.length)&&(l["channel-group"]=e);f&&(l.auth=f);l=D(l);f||delete l.auth;h+=m(l);d=pb(h,Ea);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");l.signature=d;E({a:g,data:l,c:function(a){s(a,b,c)},b:function(a){j(a,c)},url:[K,"v1","auth","audit","sub-key",u]})},revoke:function(a,b){a.read=y;a.write=y;A.grant(a,b)},set_uuid:function(a){H=a;d()},get_uuid:function(){return H},isArray:function(a){return ta(a)},get_subscibed_channels:function(){return va(C,
v)},presence_heartbeat:function(a){var b=a.callback||z(),c=a.error||z(),a=F(),d={uuid:H,auth:G};2<JSON.stringify(Q).length&&(d.state=JSON.stringify(Q));0<V&&320>V&&(d.heartbeat=V);"0"!=a&&(d.callback=a);var e;e=va(C,v).join(",");e=encodeURIComponent(e);var f=wa(N,v).join(",");e||(e=",");f&&(d["channel-group"]=f);E({a:a,data:D(d),timeout:5*J,url:[K,"v2","presence","sub-key",u,"channel",e,"heartbeat"],c:function(a){s(a,b,c)},b:function(a){j(a,c)}})},stop_timers:function(){clearTimeout(aa);clearTimeout(ba)},
xdr:E,ready:xa,db:ga,uuid:pa,map:ua,each:R,"each-channel":B,grep:ra,offline:function(){c(1,{message:"Offline. Please check your network settings."})},supplant:sa,now:M,unique:ka,updater:qa};H||(H=A.uuid());ga.set(u+"uuid",H);aa=setTimeout(p,J);ba=setTimeout(f,jb);ca=setTimeout(e,(L-3)*J);b();$=A;for(var Sa in $)$.hasOwnProperty(Sa)&&(SELF[Sa]=$[Sa]);SELF.init=SELF;SELF.$=Ab;SELF.attr=zb;SELF.search=Db;SELF.bind=xb;SELF.css=Eb;SELF.create=Fb;"undefined"!==typeof window&&xb("beforeunload",window,function(){SELF["each-channel"](function(a){SELF.LEAVE(a.name,
1)});return v});if(a.notest)return SELF;"undefined"!==typeof window&&xb("offline",window,SELF._reset_offline);"undefined"!==typeof document&&xb("offline",document,SELF._reset_offline);SELF.ready();return SELF}var wb="PubNub-JS-Phonegap/3.7.8",vb=31E4,Hb,Ib="undefined"!=typeof localStorage&&localStorage;
