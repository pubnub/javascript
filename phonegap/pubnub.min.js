...
g);v(1)},c:function(a){j(a,b,g);v(1)},mode:k?"POST":"GET"});v()},unsubscribe:function(a,b){var c=a.channel,b=b||a.callback||A(),e=a.error||A();Y=0;xa=1;c=oa((c.join?c.join(","):""+c).split(","),function(a){if(y[a])return a+","+a+fa}).join(",");M(c.split(","),function(a){var c=w;a&&(ba&&(c=F.LEAVE(a,0,b,e)),c||b({action:"leave"}),y[a]=0,a in U&&delete U[a])});d()},subscribe:function(a,b){function e(a){a?setTimeout(d,B):(H=L(ha,1),db=L(ha,1),setTimeout(function(){F.time(e)},B));r(function(b){if(a&&
b.d)return b.d=0,b.p(b.name);!a&&!b.d&&(b.d=1,b.o(b.name))})}function j(){var a=I(),b=pa(y).join(",");if(b){c();var g=h({uuid:D,auth:k});2<JSON.stringify(U).length&&(g.state=JSON.stringify(U));N&&(g.heartbeat=N);u();wa=C({timeout:da,a:a,b:function(a){F.time(function(b){!b&&n(a,v);e(b)})},data:h(g),url:[db,"subscribe",q,encodeURIComponent(b),a,Y],c:function(a){if(!a||"object"==typeof a&&"error"in a&&a.error)return v(a.error),setTimeout(d,B);G(a[1]);Y=!Y&&xa&&Z.get(q)||a[1];r(function(a){a.g||(a.g=
1,a.n(a.name))});if(Ga&&!xa)Y=0,Ga=z,Z.set(q,0);else{R&&(Y=1E4,R=0);Z.set(q,a[1]);var b,c=(2<a.length?a[2]:oa(pa(y),function(b){return oa(Array(a[0].length).join(",").split(","),function(){return b})}).join(",")).split(",");b=function(){var a=c.shift()||fb;return[(y[a]||{}).a||eb,a.split(fa)[0]]};var e=K()-Ea-+a[1]/1E4;M(a[0],function(c){var d=b(),c=f(c,y[d[1]]?y[d[1]].cipher_key:x);d[0](c,a,d[1],e)})}setTimeout(j,W)}})}}var g=a.channel,b=(b=b||a.callback)||a.message,k=a.auth_key||J,l=a.connect||
A(),m=a.reconnect||A(),p=a.disconnect||A(),v=a.error||A(),G=a.idle||A(),E=a.presence||0,P=a.noheresync||0,R=a.backfill||0,X=a.timetoken||0,da=a.timeout||pb,W=a.windowing||ob,Q=a.state,T=a.heartbeat||a.pnexpires,ea=a.restore;xa=ea;Y=X;if(!g)return s("Missing Channel");if(!b)return s("Missing Callback");if(!q)return s("Missing Subscribe Key");(T||0===T)&&F.set_heartbeat(T);M((g.join?g.join(","):""+g).split(","),function(c){var d=y[c]||{};y[fb=c]={name:c,g:d.g,d:d.d,f:1,a:eb=b,cipher_key:a.cipher_key,
n:l,o:p,p:m};Q&&(U[c]=c in Q?Q[c]:Q);E&&(F.subscribe({channel:c+fa,callback:E,restore:ea}),!d.f&&!P&&F.here_now({channel:c,callback:function(a){M("uuids"in a?a.uuids:[],function(b){E({action:"join",uuid:b,timestamp:K(),occupancy:a.occupancy||1},a,c)})}}))});d=function(){c();setTimeout(j,W)};if(!ba)return ca.push(d);d()},here_now:function(a,b){var b=a.callback||b,c=a.error||A(),d=a.auth_key||J,e=a.channel,f=I(),g=a.state,d={uuid:D,auth:d};if(!("uuids"in a?a.uuids:1))d.disable_uuids=1;g&&(d.state=1);
if(!b)return s("Missing Callback");if(!q)return s("Missing Subscribe Key");g=[H,"v2","presence","sub_key",q];e&&g.push("channel")&&g.push(encodeURIComponent(e));"0"!=f&&(d.callback=f);C({a:f,data:h(d),c:function(a){j(a,b,c)},b:function(a){n(a,c)},url:g})},where_now:function(a,b){var b=a.callback||b,c=a.error||A(),d=a.auth_key||J,e=I(),f=a.uuid||D,d={auth:d};if(!b)return s("Missing Callback");if(!q)return s("Missing Subscribe Key");"0"!=e&&(d.callback=e);C({a:e,data:h(d),c:function(a){j(a,b,c)},b:function(a){n(a,
c)},url:[H,"v2","presence","sub_key",q,"uuid",encodeURIComponent(f)]})},state:function(a,b){var b=a.callback||b||A(),c=a.error||A(),d=a.auth_key||J,e=I(),f=a.state,g=a.uuid||D,k=a.channel,d=h({auth:d});if(!q)return s("Missing Subscribe Key");if(!g)return s("Missing UUID");if(!k)return s("Missing Channel");"0"!=e&&(d.callback=e);y[k]&&(y[k].f&&f)&&(U[k]=f);d.state=JSON.stringify(f);f=f?[H,"v2","presence","sub-key",q,"channel",encodeURIComponent(k),"uuid",g,"data"]:[H,"v2","presence","sub-key",q,"channel",
encodeURIComponent(k),"uuid",encodeURIComponent(g)];C({a:e,data:h(d),c:function(a){j(a,b,c)},b:function(a){n(a,c)},url:f})},grant:function(a,b){var b=a.callback||b,c=a.error||A(),d=a.channel,e=I(),f=a.ttl,g=a.read?"1":"0",l=a.write?"1":"0",m=a.auth_key;if(!b)return s("Missing Callback");if(!q)return s("Missing Subscribe Key");if(!E)return s("Missing Publish Key");if(!T)return s("Missing Secret Key");var p=q+"\n"+E+"\ngrant\n",g={w:l,r:g,timestamp:Math.floor((new Date).getTime()/1E3)};"undefined"!=
d&&(d!=x&&0<d.length)&&(g.channel=d);"0"!=e&&(g.callback=e);if(f||0===f)g.ttl=f;m&&(g.auth=m);g=h(g);m||delete g.auth;p+=k(g);d=cb(p,T);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");g.signature=d;C({a:e,data:g,c:function(a){j(a,b,c)},b:function(a){n(a,c)},url:[H,"v1","auth","grant","sub-key",q]})},audit:function(a,b){var b=a.callback||b,c=a.error||A(),d=a.channel,e=a.auth_key,f=I();if(!b)return s("Missing Callback");if(!q)return s("Missing Subscribe Key");if(!E)return s("Missing Publish Key");if(!T)return s("Missing Secret Key");
