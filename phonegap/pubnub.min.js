...
function O(a,d,b){if(a&&d){var c=Object.prototype.toString.call(a);if("[object Array]"===c||("[object NodeList]"===c||"[object ScriptBridgingArrayProxyObject]"===c)||b&&"undefined"!=typeof a[0])for(var e=0,b=a.length;e<b;)d.call(a[e],a[e],e++);else for(e in a)a.hasOwnProperty&&a.hasOwnProperty(e)&&d.call(a[e],e,a[e])}}function na(a,d){var b=[];O(a||[],function(a,e){b.push(d(a,e))});return b}
function oa(a,d){var b=[];O(a,function(a,e){d?0>a.search("-pnpres")&&e.f&&b.push(a):e.f&&b.push(a)});return b.sort()}function pa(){setTimeout(function(){ba||(ba=1,O(da,function(a){a()}))},C)}var Q,T=14,U=8,Z=y;function qa(a,d){var b="",c,e;if(d){c=a[15];if(16<c)throw"Decryption error: Maybe bad key";if(16==c)return"";for(e=0;e<16-c;e++)b+=String.fromCharCode(a[e])}else for(e=0;16>e;e++)b+=String.fromCharCode(a[e]);return b}
function ra(a,d){var b=[],c;if(!d)try{a=unescape(encodeURIComponent(a))}catch(e){throw"Error on UTF-8 encode";}for(c=0;c<a.length;c++)b[c]=a.charCodeAt(c);return b}function sa(a,d){var b=12<=T?3:2,c=[],e=[],c=[],e=[],m=a.concat(d),n;c[0]=GibberishAES.k.l(m);e=c[0];for(n=1;n<b;n++)c[n]=GibberishAES.k.l(c[n-1].concat(m)),e=e.concat(c[n]);c=e.slice(0,4*U);e=e.slice(4*U,4*U+16);return{key:c,h:e}}
...
function j(a,b,c){if("object"==typeof a){if(a.error&&a.message&&a.payload){c({message:a.message,payload:a.payload});return}if(a.payload){b(a.payload);return}}b(a)}function s(a){var b=0;O(oa(z),function(c){if(c=z[c])b++,(a||B())(c)});return b}function v(a){if(xb){if(!M.length)return}else{a&&(M.i=0);if(M.i||!M.length)return;M.i=1}D(M.shift())}function u(){!V&&p()}function p(){clearTimeout(ca);!A||500<=A||1>A||!oa(z,w).length?V=y:(V=w,F.presence_heartbeat({callback:function(){ca=setTimeout(p,A*C)},error:function(a){r&&
...
f||R)||c);M[k]({a:h,timeout:5*C,url:[G,"publish",L,q,0,encodeURIComponent(d),h,encodeURIComponent(c)],data:{uuid:E,auth:e},b:function(a){n(a,g);v(1)},c:function(a){j(a,b,g);v(1)}});v()},unsubscribe:function(a,b){var c=a.channel,b=b||a.callback||B(),e=a.error||B();X=0;va=1;c=na((c.join?c.join(","):""+c).split(","),function(a){if(z[a])return a+","+a+ea}).join(",");O(c.split(","),function(a){var c=w;a&&(ba&&(c=F.LEAVE(a,0,b,e)),c||b({action:"leave"}),z[a]=0,a in S&&delete S[a])});d()},subscribe:function(a,
b){function e(a){a?setTimeout(d,C):(G=K(fa,1),bb=K(fa,1),setTimeout(function(){F.time(e)},C));s(function(b){if(a&&b.d)return b.d=0,b.p(b.name);!a&&!b.d&&(b.d=1,b.o(b.name))})}function g(){var a=H(),b=oa(z).join(",");if(b){c();var j={uuid:E,auth:h};2<JSON.stringify(S).length&&(j.state=JSON.stringify(S));N&&(j.heartbeat=N);u();ua=D({timeout:ca,a:a,b:function(a){n(a,p);F.time(e)},data:j,url:[bb,"subscribe",q,encodeURIComponent(b),a,X],c:function(a){if(!a||"object"==typeof a&&"error"in a&&a.error)return p(a.error),
setTimeout(d,C);v(a[1]);X=!X&&va&&Y.get(q)||a[1];s(function(a){a.g||(a.g=1,a.n(a.name))});if(Ea&&!va)X=0,Ea=y,Y.set(q,0);else{M&&(X=1E4,M=0);Y.set(q,a[1]);var b,c=(2<a.length?a[2]:na(oa(z),function(b){return na(Array(a[0].length).join(",").split(","),function(){return b})}).join(",")).split(",");b=function(){var a=c.shift()||db;return[(z[a]||{}).a||cb,a.split(ea)[0]]};var e=J()-Ca-+a[1]/1E4;O(a[0],function(c){var d=b(),c=f(c,z[d[1]].cipher_key);d[0](c,a,d[1],e)})}setTimeout(g,W)}})}}var j=a.channel,
b=(b=b||a.callback)||a.message,h=a.auth_key||I,k=a.connect||B(),l=a.reconnect||B(),m=a.disconnect||B(),p=a.error||B(),v=a.idle||B(),A=a.presence||0,L=a.noheresync||0,M=a.backfill||0,R=a.timetoken||0,ca=a.timeout||nb,W=a.windowing||mb,P=a.state,V=a.heartbeat||a.pnexpires;va=a.restore;X=R;if(!j)return r("Missing Channel");if(!b)return r("Missing Callback");if(!q)return r("Missing Subscribe Key");(V||0===V)&&F.set_heartbeat(V);O((j.join?j.join(","):""+j).split(","),function(c){var d=z[c]||{};z[db=c]=
{name:c,g:d.g,d:d.d,f:1,a:cb=b,cipher_key:a.cipher_key,n:k,o:m,p:l};P&&(S[c]=c in P?P[c]:P);A&&(F.subscribe({channel:c+ea,callback:A}),!d.f&&!L&&F.here_now({channel:c,callback:function(a){O("uuids"in a?a.uuids:[],function(b){A({action:"join",uuid:b,timestamp:J(),occupancy:a.occupancy||1},a,c)})}}))});d=function(){c();setTimeout(g,W)};if(!ba)return da.push(d);d()},here_now:function(a,b){var b=a.callback||b,c=a.error||B(),d=a.auth_key||I,e=a.channel,f=H(),g=a.state,d={uuid:E,auth:d};if(!("uuids"in a?
a.uuids:1))d.disable_uuids=1;g&&(d.state=1);if(!b)return r("Missing Callback");if(!q)return r("Missing Subscribe Key");g=[G,"v2","presence","sub_key",q];e&&g.push("channel")&&g.push(encodeURIComponent(e));"0"!=f&&(d.callback=f);D({a:f,data:d,c:function(a){j(a,b,c)},b:function(a){n(a,c)},url:g})},where_now:function(a,b){var b=a.callback||b,c=a.error||B(),d=a.auth_key||I,e=H(),f=a.uuid||E,d={auth:d};if(!b)return r("Missing Callback");if(!q)return r("Missing Subscribe Key");"0"!=e&&(d.callback=e);D({a:e,
data:d,c:function(a){j(a,b,c)},b:function(a){n(a,c)},url:[G,"v2","presence","sub_key",q,"uuid",encodeURIComponent(f)]})},state:function(a,b){var b=a.callback||b||B(),c=a.error||B(),d=a.auth_key||I,e=H(),f=a.state,g=a.uuid||E,h=a.channel,d={auth:d};if(!q)return r("Missing Subscribe Key");if(!g)return r("Missing UUID");if(!h)return r("Missing Channel");"0"!=e&&(d.callback=e);z[h]&&z[h].f&&(S[h]=f);d.state=JSON.stringify(f);D({a:e,data:d,c:function(a){j(a,b,c)},b:function(a){n(a,c)},url:f?[G,"v2","presence",
