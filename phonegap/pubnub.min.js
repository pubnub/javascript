...
var t=void 0,w=!0,x=null,y=!1;function z(){return function(){}}var aa=1,ba=y,ca=[],fa="-pnpres",B=1E3,ga=/{([\w\-]+)}/g;function ia(){return"x"+ ++aa+""+ +new Date}function K(){return+new Date}var L,ja=Math.floor(20*Math.random());L=function(a,d){return 0<a.indexOf("pubsub.")&&a.replace("pubsub","ps"+(d?ka().split("-")[0]:20>++ja?ja:ja=1))||a};function la(a,d){function b(){e+d>K()?(clearTimeout(c),c=setTimeout(b,d)):(e=K(),a())}var c,e=0;return b}
function ma(a,d){var b=[];N(a||[],function(a){d(a)&&b.push(a)});return b}function na(a,d){return a.replace(ga,function(a,c){return d[c]||a})}function ka(a){var d="xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var c=16*Math.random()|0;return("x"==a?c:c&3|8).toString(16)});a&&a(d);return d}
function N(a,d){if(a&&d)if(a&&(Array.isArray&&Array.isArray(a)||"number"===typeof a.length))for(var b=0,c=a.length;b<c;)d.call(a[b],a[b],b++);else for(b in a)a.hasOwnProperty&&a.hasOwnProperty(b)&&d.call(a[b],b,a[b])}function oa(a,d){var b=[];N(a||[],function(a,e){b.push(d(a,e))});return b}function pa(a,d){var b=[];N(a,function(a,e){d?0>a.search("-pnpres")&&e.f&&b.push(a):e.f&&b.push(a)});return b.sort()}function qa(){setTimeout(function(){ba||(ba=1,N(ca,function(a){a()}))},B)}var O,S=14,V=8,ra=y;
...
function $(a){function d(){}function b(a,b){function c(b){b&&(Ea=K()-(b/1E4+(K()-d)/2),a&&a(Ea))}var d=K();b&&c(b)||F.time(c)}function c(a,b){wa&&wa(a,b);wa=x}function e(){F.time(function(a){b(z(),a);a||c(1,{error:"Heartbeat failed to connect to Pubnub Servers.Please check your network settings."});setTimeout(e,Ya)})}function m(){yb()||c(1,{error:"Offline. Please check your network settings. "});setTimeout(m,B)}function n(a,b){"object"==typeof a&&a.error&&a.message&&a.payload?b({message:a.message,
payload:a.payload}):b(a)}function j(a,b,c){if("object"==typeof a){if(a.error&&a.message&&a.payload){c({message:a.message,payload:a.payload});return}if(a.payload){b(a.payload);return}}b(a)}function r(a){var b=0;N(pa(A),function(c){if(c=A[c])b++,(a||z())(c)});return b}function v(a){if(zb){if(!P.length)return}else{a&&(P.i=0);if(P.i||!P.length)return;P.i=1}C(P.shift())}function u(){!ea&&p()}function p(){clearTimeout(W);!G||500<=G||1>G||!pa(A,w).length?ea=y:(ea=w,F.presence_heartbeat({callback:function(){W=
setTimeout(p,G*B)},error:function(a){s&&s("Presence Heartbeat unable to reach Pubnub servers."+JSON.stringify(a));W=setTimeout(p,G*B)}}))}function f(a,b){return Q.decrypt(a,b||R)||Q.decrypt(a,R)||a}function g(a,b,c){var d=y;if("number"===typeof a)d=5<a||0==a?y:w;else{if("boolean"===typeof a)return a?30:0;d=w}return d?(c&&c("Presence Heartbeat value invalid. Valid range ( x > 5 or x = 0). Current Value : "+(b||5)),b||5):a}function k(a){var b="",c=[];N(a,function(a){c.push(a)});var d=c.sort(),f;for(f in d){var e=
d[f],b=b+(e+"="+encodeURIComponent(a[e]));f!=d.length-1&&(b+="&")}return b}function h(a){a||(a={});N(X,function(b,c){b in a||(a[b]=c)});return a}function l(a){function b(a,c){var d=(a&65535)+(c&65535);return(a>>16)+(c>>16)+(d>>16)<<16|d&65535}function c(a,b){return a>>>b|a<<32-b}var d;d=a.replace(/\r\n/g,"\n");for(var a="",f=0;f<d.length;f++){var e=d.charCodeAt(f);128>e?a+=String.fromCharCode(e):(127<e&&2048>e?a+=String.fromCharCode(e>>6|192):(a+=String.fromCharCode(e>>12|224),a+=String.fromCharCode(e>>
...
2]>>8*(3-f%4)+4&15)+"0123456789abcdef".charAt(a[f>>2]>>8*(3-f%4)&15);return d}a.db=vb;a.xdr=hb;a.error=a.error||lb;a.hmac_SHA256=ub;O.size(256);var Xa=O.s2a("0123456789012345");a.crypto_obj={encrypt:function(a,b){if(!b)return a;var c=O.s2a(l(b).slice(0,32)),d=O.s2a(JSON.stringify(a)),c=O.rawEncrypt(d,c,Xa);return O.Base64.encode(c)||a},decrypt:function(a,b){if(!b)return a;var c=O.s2a(l(b).slice(0,32));try{var d=O.Base64.decode(a),e=O.rawDecrypt(d,c,Xa,y);return JSON.parse(e)}catch(f){}}};a.params=
{pnsdk:jb};SELF=function(a){return $(a)};var da,ob=+a.windowing||10,pb=(+a.timeout||310)*B,Ya=(+a.keepalive||60)*B,qb=a.noleave||0,E=a.publish_key||"demo",q=a.subscribe_key||"demo",J=a.auth_key||"",T=a.secret_key||"",cb=a.hmac_SHA256,Fa=a.ssl?"s":"",ha="http"+Fa+"://"+(a.origin||"pubsub.pubnub.com"),H=L(ha),db=L(ha),P=[],Ea=0,eb=0,fb=0,wa=0,xa=0,Y=0,Ga=y,A={},U={},W=x,M=g(a.heartbeat||a.pnexpires||0,a.error),G=a.heartbeat_interval||M-3,ea=y,zb=a.no_wait_for_pending,Ab=a["compatible_3.5"]||y,C=a.xdr,
X=a.params||{},s=a.error||z(),yb=a._is_online||function(){return 1},I=a.jsonp_cb||function(){return 0},Z=a.db||{get:z(),set:z()},R=a.cipher_key,D=a.uuid||Z&&Z.get(q+"uuid")||"",Q=a.crypto_obj||{encrypt:function(a){return a},decrypt:function(a){return a}},F={LEAVE:function(a,b,c,d){var e={uuid:D,auth:J},f=L(ha),c=c||z(),g=d||z(),d=I();if(0<a.indexOf(fa))return w;if(Ab&&(!Fa||"0"==d)||qb)return y;"0"!=d&&(e.callback=d);C({m:b||Fa,timeout:2E3,a:d,data:h(e),c:function(a){j(a,c,g)},b:function(a){n(a,g)},
url:[f,"v2","presence","sub_key",q,"channel",encodeURIComponent(a),"leave"]});return w},set_resumed:function(a){Ga=a},get_cipher_key:function(){return R},set_cipher_key:function(a){R=a},raw_encrypt:function(a,b){return Q.encrypt(a,b||R)||a},raw_decrypt:function(a,b){return f(a,b)},get_heartbeat:function(){return M},set_heartbeat:function(a){M=g(a,G,s);G=1<=M-3?M-3:1;d();p()},get_heartbeat_interval:function(){return G},set_heartbeat_interval:function(a){G=a;p()},get_version:function(){return"3.6.5"},
_add_param:function(a,b){X[a]=b},history:function(a,b){var b=a.callback||b,c=a.count||a.limit||100,d=a.reverse||"false",e=a.error||z(),j=a.auth_key||J,g=a.cipher_key,k=a.channel,l=a.start,m=a.end,p=a.include_token,r={},u=I();if(!k)return s("Missing Channel");if(!b)return s("Missing Callback");if(!q)return s("Missing Subscribe Key");r.stringtoken="true";r.count=c;r.reverse=d;r.auth=j;u&&(r.callback=u);l&&(r.start=l);m&&(r.end=m);p&&(r.include_token="true");C({a:u,data:h(r),c:function(a){if("object"==
typeof a&&a.error)e({message:a.message,payload:a.payload});else{for(var c=a[0],d=[],h=0;h<c.length;h++){var j=f(c[h],g);try{d.push(JSON.parse(j))}catch(k){d.push(j)}}b([d,a[1],a[2]])}},b:function(a){n(a,e)},url:[H,"v2","history","sub-key",q,"channel",encodeURIComponent(k)]})},replay:function(a,b){var b=b||a.callback||z(),c=a.auth_key||J,d=a.source,e=a.destination,f=a.stop,g=a.start,k=a.end,l=a.reverse,m=a.limit,n=I(),p={};if(!d)return s("Missing Source Channel");if(!e)return s("Missing Destination Channel");
...
z(),c=a.message,d=a.channel,e=a.auth_key||J,f=a.cipher_key,g=a.error||z(),k=a.post||y,l="store_in_history"in a?a.store_in_history:w,m=I(),p="push";a.prepend&&(p="unshift");if(!c)return s("Missing Message");if(!d)return s("Missing Channel");if(!E)return s("Missing Publish Key");if(!q)return s("Missing Subscribe Key");c=JSON.stringify(Q.encrypt(c,f||R)||c);c=[H,"publish",E,q,0,encodeURIComponent(d),m,encodeURIComponent(c)];X={uuid:D,auth:e};l||(X.store="0");P[p]({a:m,timeout:5*B,url:c,data:h(X),b:function(a){n(a,
g);v(1)},c:function(a){j(a,b,g);v(1)},mode:k?"POST":"GET"});v()},unsubscribe:function(a,b){var c=a.channel,b=b||a.callback||z(),e=a.error||z();Y=0;xa=1;c=oa((c.join?c.join(","):""+c).split(","),function(a){if(A[a])return a+","+a+fa}).join(",");N(c.split(","),function(a){var c=w;a&&(ba&&(c=F.LEAVE(a,0,b,e)),c||b({action:"leave"}),A[a]=0,a in U&&delete U[a])});d()},subscribe:function(a,b){function e(a){a?setTimeout(d,B):(H=L(ha,1),db=L(ha,1),setTimeout(function(){F.time(e)},B));r(function(b){if(a&&
b.d)return b.d=0,b.p(b.name);!a&&!b.d&&(b.d=1,b.o(b.name))})}function j(){var a=I(),b=pa(A).join(",");if(b){c();var g=h({uuid:D,auth:k});2<JSON.stringify(U).length&&(g.state=JSON.stringify(U));M&&(g.heartbeat=M);u();wa=C({timeout:da,a:a,b:function(a){n(a,v);F.time(e)},data:h(g),url:[db,"subscribe",q,encodeURIComponent(b),a,Y],c:function(a){if(!a||"object"==typeof a&&"error"in a&&a.error)return v(a.error),setTimeout(d,B);G(a[1]);Y=!Y&&xa&&Z.get(q)||a[1];r(function(a){a.g||(a.g=1,a.n(a.name))});if(Ga&&
!xa)Y=0,Ga=y,Z.set(q,0);else{R&&(Y=1E4,R=0);Z.set(q,a[1]);var b,c=(2<a.length?a[2]:oa(pa(A),function(b){return oa(Array(a[0].length).join(",").split(","),function(){return b})}).join(",")).split(",");b=function(){var a=c.shift()||fb;return[(A[a]||{}).a||eb,a.split(fa)[0]]};var e=K()-Ea-+a[1]/1E4;N(a[0],function(c){var d=b(),c=f(c,A[d[1]].cipher_key);d[0](c,a,d[1],e)})}setTimeout(j,W)}})}}var g=a.channel,b=(b=b||a.callback)||a.message,k=a.auth_key||J,l=a.connect||z(),m=a.reconnect||z(),p=a.disconnect||
z(),v=a.error||z(),G=a.idle||z(),E=a.presence||0,P=a.noheresync||0,R=a.backfill||0,X=a.timetoken||0,da=a.timeout||pb,W=a.windowing||ob,Q=a.state,T=a.heartbeat||a.pnexpires,ea=a.restore;xa=ea;Y=X;if(!g)return s("Missing Channel");if(!b)return s("Missing Callback");if(!q)return s("Missing Subscribe Key");(T||0===T)&&F.set_heartbeat(T);N((g.join?g.join(","):""+g).split(","),function(c){var d=A[c]||{};A[fb=c]={name:c,g:d.g,d:d.d,f:1,a:eb=b,cipher_key:a.cipher_key,n:l,o:p,p:m};Q&&(U[c]=c in Q?Q[c]:Q);
E&&(F.subscribe({channel:c+fa,callback:E,restore:ea}),!d.f&&!P&&F.here_now({channel:c,callback:function(a){N("uuids"in a?a.uuids:[],function(b){E({action:"join",uuid:b,timestamp:K(),occupancy:a.occupancy||1},a,c)})}}))});d=function(){c();setTimeout(j,W)};if(!ba)return ca.push(d);d()},here_now:function(a,b){var b=a.callback||b,c=a.error||z(),d=a.auth_key||J,e=a.channel,f=I(),g=a.state,d={uuid:D,auth:d};if(!("uuids"in a?a.uuids:1))d.disable_uuids=1;g&&(d.state=1);if(!b)return s("Missing Callback");
if(!q)return s("Missing Subscribe Key");g=[H,"v2","presence","sub_key",q];e&&g.push("channel")&&g.push(encodeURIComponent(e));"0"!=f&&(d.callback=f);C({a:f,data:h(d),c:function(a){j(a,b,c)},b:function(a){n(a,c)},url:g})},where_now:function(a,b){var b=a.callback||b,c=a.error||z(),d=a.auth_key||J,e=I(),f=a.uuid||D,d={auth:d};if(!b)return s("Missing Callback");if(!q)return s("Missing Subscribe Key");"0"!=e&&(d.callback=e);C({a:e,data:h(d),c:function(a){j(a,b,c)},b:function(a){n(a,c)},url:[H,"v2","presence",
"sub_key",q,"uuid",encodeURIComponent(f)]})},state:function(a,b){var b=a.callback||b||z(),c=a.error||z(),d=a.auth_key||J,e=I(),f=a.state,g=a.uuid||D,k=a.channel,d=h({auth:d});if(!q)return s("Missing Subscribe Key");if(!g)return s("Missing UUID");if(!k)return s("Missing Channel");"0"!=e&&(d.callback=e);A[k]&&(A[k].f&&f)&&(U[k]=f);d.state=JSON.stringify(f);f=f?[H,"v2","presence","sub-key",q,"channel",encodeURIComponent(k),"uuid",g,"data"]:[H,"v2","presence","sub-key",q,"channel",encodeURIComponent(k),
"uuid",encodeURIComponent(g)];C({a:e,data:h(d),c:function(a){j(a,b,c)},b:function(a){n(a,c)},url:f})},grant:function(a,b){var b=a.callback||b,c=a.error||z(),d=a.channel,e=I(),f=a.ttl,g=a.read?"1":"0",l=a.write?"1":"0",m=a.auth_key;if(!b)return s("Missing Callback");if(!q)return s("Missing Subscribe Key");if(!E)return s("Missing Publish Key");if(!T)return s("Missing Secret Key");var p=q+"\n"+E+"\ngrant\n",g={w:l,r:g,timestamp:Math.floor((new Date).getTime()/1E3)};"undefined"!=d&&(d!=x&&0<d.length)&&
(g.channel=d);"0"!=e&&(g.callback=e);if(f||0===f)g.ttl=f;m&&(g.auth=m);g=h(g);m||delete g.auth;p+=k(g);d=cb(p,T);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");g.signature=d;C({a:e,data:g,c:function(a){j(a,b,c)},b:function(a){n(a,c)},url:[H,"v1","auth","grant","sub-key",q]})},audit:function(a,b){var b=a.callback||b,c=a.error||z(),d=a.channel,e=a.auth_key,f=I();if(!b)return s("Missing Callback");if(!q)return s("Missing Subscribe Key");if(!E)return s("Missing Publish Key");if(!T)return s("Missing Secret Key");
var g=q+"\n"+E+"\naudit\n",l={timestamp:Math.floor((new Date).getTime()/1E3)};"0"!=f&&(l.callback=f);"undefined"!=d&&(d!=x&&0<d.length)&&(l.channel=d);e&&(l.auth=e);l=h(l);e||delete l.auth;g+=k(l);d=cb(g,T);d=d.replace(/\+/g,"-");d=d.replace(/\//g,"_");l.signature=d;C({a:f,data:l,c:function(a){j(a,b,c)},b:function(a){n(a,c)},url:[H,"v1","auth","audit","sub-key",q]})},revoke:function(a,b){a.read=y;a.write=y;F.grant(a,b)},set_uuid:function(a){D=a;d()},get_uuid:function(){return D},presence_heartbeat:function(a){var b=
a.callback||z(),c=a.error||z(),a=I(),d={uuid:D,auth:J};2<JSON.stringify(U).length&&(d.state=JSON.stringify(U));0<M&&320>M&&(d.heartbeat=M);var e=C,d=h(d),f=5*B,g=H,k=q,l=pa(A,w).join(",");e({a:a,data:d,timeout:f,url:[g,"v2","presence","sub-key",k,"channel",encodeURIComponent(l),"heartbeat"],c:function(a){j(a,b,c)},b:function(a){n(a,c)}})},xdr:C,ready:qa,db:Z,uuid:ka,map:oa,each:N,"each-channel":r,grep:ma,offline:function(){c(1,{message:"Offline. Please check your network settings."})},supplant:na,
now:K,unique:ia,updater:la};D||(D=F.uuid());Z.set(q+"uuid",D);setTimeout(m,B);setTimeout(e,Ya);W=setTimeout(u,(G-3)*B);b();da=F;for(var Ha in da)da.hasOwnProperty(Ha)&&(SELF[Ha]=da[Ha]);SELF.init=SELF;SELF.$=nb;SELF.attr=mb;SELF.search=rb;SELF.bind=kb;SELF.css=sb;SELF.create=tb;"undefined"!==typeof window&&kb("beforeunload",window,function(){SELF["each-channel"](function(a){SELF.LEAVE(a.name,1)});return w});if(a.notest)return SELF;"undefined"!==typeof window&&kb("offline",window,SELF._reset_offline);
"undefined"!==typeof document&&kb("offline",document,SELF._reset_offline);SELF.ready();return SELF}var jb="PubNub-JS-Phonegap/3.6.5",ib=31E4,vb,wb="undefined"!=typeof localStorage&&localStorage;vb={get:function(a){try{return wb?wb.getItem(a):-1==document.cookie.indexOf(a)?x:((document.cookie||"").match(RegExp(a+"=([^;]+)"))||[])[1]||x}catch(d){}},set:function(a,d){try{if(wb)return wb.setItem(a,d)&&0;document.cookie=a+"="+d+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}catch(b){}}};$.init=$;
