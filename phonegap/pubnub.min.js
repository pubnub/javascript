...
b.d)return b.d=0,b.p(b.name);!a&&!b.d&&(b.d=1,b.o(b.name))})}function j(){var a=I(),b=pa(y).join(",");if(b){c();var g=h({uuid:D,auth:k});2<JSON.stringify(U).length&&(g.state=JSON.stringify(U));N&&(g.heartbeat=N);u();wa=C({timeout:da,a:a,b:function(a){F.time(function(b){!b&&(n(a,v)||e())})},data:h(g),url:[db,"subscribe",q,encodeURIComponent(b),a,Y],c:function(a){if(!a||"object"==typeof a&&"error"in a&&a.error)return v(a.error),setTimeout(d,B);G(a[1]);Y=!Y&&xa&&Z.get(q)||a[1];r(function(a){a.g||(a.g=
