 ...
 * @internal
 */
export class UpdateUserRequest<Response extends DataSync.UpdateUserResponse> extends AbstractRequest<
  Response,
  Response
> {
  ...
  operation(): RequestOperation {
    return RequestOperation.PNUpdateDataSyncUserOperation;
  }
