 ...
 */
type RequestParameters = DataSync.SetUserParameters & {
  /**
 ...
 * @internal
 */
export class SetUserRequest<Response extends DataSync.SetUserResponse> extends AbstractRequest<Response, Response> {
  constructor(private readonly parameters: RequestParameters) {
    super({ method: TransportMethod.PUT });
  }

  operation(): RequestOperation {
    return RequestOperation.PNSetDataSyncUserOperation;
  }
