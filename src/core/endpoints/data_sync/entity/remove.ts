 ...
 */
type RequestParameters = DataSync.RemoveEntityParameters & {
  /**
 ...
 * @internal
 */
export class RemoveEntityRequest<Response extends DataSync.RemoveEntityResponse> extends AbstractRequest<
  Response,
  Response
> {
