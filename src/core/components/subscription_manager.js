...
export default class {
  ...
  adaptSubscribeChange(args: SubscribeArgs) {
    ...
    channels.forEach((channel: string) => {
      ...
      if (withHeartbeats || this._config.heartbeatInterval) this._heartbeatChannels[channel] = {};
    ...
    channelGroups.forEach((channelGroup: string) => {
      ...
      if (withHeartbeats || this._config.heartbeatInterval) this._heartbeatChannelGroups[channelGroup] = {};
