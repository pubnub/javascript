...
import { ReconnectingStateContext } from './states/receive_reconnecting';
...
export const reconnect = createManagedEffect('RECONNECT', (context: ReconnectingStateContext) => context);
