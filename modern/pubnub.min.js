...
if(D){var g=[],i=i+"?",u;for(u in D)g.push(u+"="+O(D[u]));i+=g.join("&")}url=i;d.open("GET",url,!0);d.send()}catch(E){return c(0),S(a)}return c}function U(a,c,b){M(a.split(","),function(a){function f(a){a||(a=window.event);b(a)||(a.cancelBubble=!0,a.returnValue=k,a.preventDefault&&a.preventDefault(),a.stopPropagation&&a.stopPropagation())}c.addEventListener?c.addEventListener(a,f,k):c.attachEvent?c.attachEvent("on"+a,f):c["on"+a]=f})}function la(a){console.error(a)}
...
function V(a){function c(){}function b(){m.time(function(a){a||y&&y(1);setTimeout(b,C)})}function d(){ra()||y&&y(1);setTimeout(d,B)}function f(a){L(P(t),function(b){(b=t[b])&&a(b)})}function r(a){a&&(u.h=0);!u.h&&u.length&&(u.h=1,v(u.shift()))}a.db=W;a.xdr=S;a.error=la;var e,D=+a.windowing||10,Q=(+a.timeout||310)*B,C=(+a.keepalive||60)*B,q=a.publish_key||"",g=a.subscribe_key||"",s=a.ssl?"s":"",i="http"+s+"://"+(a.origin||"pubsub.pubnub.com"),x=I(i),X=I(i),u=[],$=0,aa=0,y=0,R=0,ba=0,H=0,t={},v=a.xdr,
h=a.error||l(),ra=a._is_online||function(){return 1},z=a.jsonp_cb||function(){return 0},E=a.db||{get:l(),set:l()},F=a.uuid||E&&E.get(g+"uuid")||"",m={LEAVE:function(a,b){var c={uuid:F},d=I(i),e=z();0<a.indexOf(A)||("0"!=e&&(c.callback=e),v({j:b||s,timeout:2E3,a:e,data:c,url:[d,"v2","presence","sub_key",g,"channel",O(a),"leave"]}))},history:function(a,b){var b=a.callback||b,c=a.count||a.limit||100,d=a.reverse||"false",e=a.error||l(),f=a.channel,i=a.start,m=a.end,j={},n=z();if(!f)return h("Missing Channel");
if(!b)return h("Missing Callback");if(!g)return h("Missing Subscribe Key");j.stringtoken="true";j.count=c;j.reverse=d;n&&(j.callback=n);i&&(j.start=i);m&&(j.end=m);v({a:n,data:j,c:function(a){b(a)},b:e,url:[x,"v2","history","sub-key",g,"channel",O(f)]})},replay:function(a){var b=b||a.callback||l(),c=a.source,d=a.destination,e=a.stop,f=a.start,i=a.end,m=a.reverse,a=a.limit,j=z(),n={};if(!c)return h("Missing Source Channel");if(!d)return h("Missing Destination Channel");if(!q)return h("Missing Publish Key");
if(!g)return h("Missing Subscribe Key");"0"!=j&&(n.callback=j);e&&(n.stop="all");m&&(n.reverse="true");f&&(n.start=f);i&&(n.end=i);a&&(n.count=a);v({a:j,c:function(a){b(a)},b:function(){b([0,"Disconnected"])},url:[x,"v1","replay",q,g,c,d],data:n})},time:function(a){var b=z();v({a:b,timeout:5*B,url:[x,"time",b],c:function(b){a(b[0])},b:function(){a(0)}})},publish:function(a,b){var b=b||a.callback||l(),c=a.message,d=a.channel,e=z();if(!c)return h("Missing Message");if(!d)return h("Missing Channel");
if(!q)return h("Missing Publish Key");if(!g)return h("Missing Subscribe Key");c=JSON.stringify(c);d=[x,"publish",q,g,0,O(d),e,O(c)];u.push({a:e,timeout:5*B,url:d,data:{uuid:F},c:function(a){b(a);r(1)},b:function(){b([0,"Failed",c]);r(1)}});r()},unsubscribe:function(a){a=a.channel;H=0;R=1;a=N((a.join?a.join(","):""+a).split(","),function(a){return a+","+a+A}).join(",");L(a.split(","),function(a){p&&m.LEAVE(a,0);t[a]=0});p&&c()},subscribe:function(a,b){function d(a){a?setTimeout(e,B):(x=I(i,1),X=I(i,
1),setTimeout(function(){m.time(d)},B));f(function(b){if(a&&b.d)return b.d=0,b.m(b.name);!a&&!b.d&&(b.d=1,b.l(b.name))})}function e(){var a=z(),b=P(t).join(",");b&&(y=v({timeout:C,a:a,b:function(){m.time(d)},data:{uuid:F},url:[X,"subscribe",g,O(b),a,H],c:function(a){if(!a)return setTimeout(e,ca);f(function(a){a.f||(a.f=1,a.k(a.name))});H=!H&&R&&E.get(g)||a[1];s&&(Timetoken=1E4,s=0);E.set(g,a[1]);var b,c=(2<a.length?a[2]:"").split(",");b=function(){var a=c.shift()||"";return[(t[a]||{}).a||$,(a||aa).split(A)[0]]};
L(a[0],function(c){var d=b();if(t[d[1]].g)d[0](c,a,d[1])});setTimeout(e,ca)}}))}var M=a.channel,b=(b=b||a.callback)||a.message,q=a.connect||l(),r=a.reconnect||l(),u=a.disconnect||l(),j=a.presence||0,n=a.noheresync||0,s=a.backfill||0,C=a.timeout||Q,ca=a.windowing||D;a.restore&&(R=1);H=0;if(!M)return h("Missing Channel");if(!b)return h("Missing Callback");if(!g)return h("Missing Subscribe Key");L((M.join?M.join(","):""+M).split(","),function(a){var c=t[a]||{};t[aa=a]={name:a,f:c.f,d:c.d,g:1,a:$=b,k:q,
l:u,m:r};j&&(m.subscribe({channel:a+A,callback:j}),!c.g&&!n&&m.here_now({channel:a,callback:function(b){L("uuids"in b?b.uuids:[],function(c){j({action:"join",uuid:c,timestamp:G(),occupancy:b.occupancy||1},b,a)})}}))});c=function(){y&&y(1);clearTimeout(ba);ba=setTimeout(e,100)};if(!p)return w.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.error||l(),d=a.channel,e=z(),f=null;if(!d)return h("Missing Channel");if(!b)return h("Missing Callback");if(!g)return h("Missing Subscribe Key");"0"!=
e&&(f={},f.callback=e);v({a:e,data:f,c:function(a){b(a)},b:c,url:[x,"v2","presence","sub_key",g,"channel",O(d)]})},xdr:v,ready:ja,db:E,uuid:K,map:N,each:L,"each-channel":f,grep:ha,supplant:ia,now:G,unique:fa,updater:ga};F||(F=m.uuid());E.set(g+"uuid",F);setTimeout(d,B);setTimeout(b,C);e=m;e.init=V;e.$=na;e.attr=ma;e.search=oa;e.bind=U;e.css=pa;e.create=qa;if(a.notest)return e;U("beforeunload",window,function(){e["each-channel"](function(a){e.LEAVE(a.name,1)});return!0});U("offline",window,e._reset_offline);
U("offline",document,e._reset_offline);e.ready();return e}var ka="PubNub-JS-Modern/3.4.4",T=31E4,W,Y="undefined"!=typeof localStorage&&localStorage;W={get:function(a){try{return Y?Y.getItem(a):-1==document.cookie.indexOf(a)?null:((document.cookie||"").match(RegExp(a+"=([^;]+)"))||[])[1]||null}catch(c){}},set:function(a,c){try{if(Y)return Y.setItem(a,c)&&0;document.cookie=a+"="+c+"; expires=Thu, 1 Aug 2030 20:00:00 UTC; path=/"}catch(b){}}};
