...
pb;SELF.bind=ib;SELF.css=qb;SELF.create=rb;ib("beforeunload",window,function(){SELF["each-channel"](function(a){SELF.LEAVE(a.name,1)});return w});if(a.notest)return SELF;ib("offline",window,SELF._reset_offline);ib("offline",document,SELF._reset_offline);SELF.ready();return SELF}var hb="PubNub-JS-Webos/3.6.1",gb=31E4,tb,ub="undefined"!=typeof localStorage&&localStorage;
